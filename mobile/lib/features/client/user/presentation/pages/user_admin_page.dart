...
import 'package:reservatior/shared/providers/user_provider.dart';
import 'package:reservatior/shared/providers/auth_provider.dart';
import 'package:reservatior/shared/models/models.dart';
import 'package:reservatior/core/theme/app_theme.dart';
import 'package:reservatior/features/client/user/presentation/widgets/user_list_widget.dart';
import 'package:reservatior/features/client/user/presentation/widgets/user_form_widget.dart';
...
class UserAdminPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final itemsAsync = ref.watch(userListProvider);

    return Scaffold(
      backgroundColor: AppColors.darkBg,
      appBar: AppBar(
        title: Text('mobile.auto.feature_user_title'.tr()),
        ...
        data: (data) {
          ...
          return RefreshIndicator(
            ...
            child: SingleChildScrollView(
              ...
              child: UserListWidget(items: filteredData as List<User>),
            ),
          );
        },
    ...
    showModalBottomSheet(
      ...
      builder: (ctx) => Padding(
        ...
        child: UserFormWidget(
          ...
          onSubmit: (val) {
            if (item == null)
              ref.read(userCreateProvider.notifier).state = val;
            else
              ref.read(userUpdateProvider.notifier).state = {
                'id': item.id,
                'data': val,
              };
            Navigator.pop(ctx);
