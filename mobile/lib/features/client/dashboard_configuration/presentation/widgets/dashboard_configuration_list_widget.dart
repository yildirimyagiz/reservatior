...
class DashboardConfigurationListWidget extends StatelessWidget {
  ...
  const DashboardConfigurationListWidget({super.key, required this.items});
  ...
  Widget build(BuildContext context) {
    if (items.isEmpty)
      return Center(
        child: Padding(
          ...
          child: Text('mobile.auto.no_dashboard_configuration_items_found'.tr(),
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, i) {
        final item = items[i];
        final heroTag = 'hero_dashboard_configuration_${item.id}';
        String title = 'Item';
        try {
