...
class AuditLogFormWidget extends ConsumerStatefulWidget {
  final AuditLog? item;
  final Function(AuditLog) onSubmit;
  const AuditLogFormWidget({super.key, this.item, required this.onSubmit});
  @override
  ConsumerState<AuditLogFormWidget> createState() => _AuditLogFormWidgetState();
}

class _AuditLogFormWidgetState extends ConsumerState<AuditLogFormWidget> {
  String? _userId;
  String? _action;
  String? _entityType;
  String? _entityId;
    ...
    return Container(
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            Text(
              widget.item == null ? "${'mobile.auto.new'.tr()} ${'mobile.modules.auditlog'.tr()}" : "${'mobile.auto.edit'.tr()} ${'mobile.modules.auditlog'.tr()}",
            ...
            ElevatedButton(
              onPressed: () {
                ...
                try {
                  ...
                  widget.onSubmit(AuditLog.fromJson(json));
                } catch (e) {
