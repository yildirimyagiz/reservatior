...
import 'package:reservatior/features/client/audit_log/presentation/widgets/audit_log_list_widget.dart';
import 'package:reservatior/features/client/audit_log/presentation/widgets/audit_log_form_widget.dart';
...
class AuditLogAdminPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final itemsAsync = ref.watch(auditLogListProvider);

    return Scaffold(
      backgroundColor: AppColors.darkBg,
      appBar: AppBar(
        title: Text('mobile.auto.feature_auditlog_title'.tr()),
        ...
        data: (data) {
          ...
          return RefreshIndicator(
            ...
            child: SingleChildScrollView(
              ...
              child: AuditLogListWidget(items: filteredData as List<AuditLog>),
            ),
          );
        },
        ...
        error: (e, s) => Center(
          child: Column(
            ...
            children: [
              ...
              TextButton(
                onPressed: () => ref.refresh(auditLogListProvider),
    ...
    showModalBottomSheet(
      ...
      builder: (ctx) => Padding(
        ...
        child: AuditLogFormWidget(
          ...
          onSubmit: (val) {
            if (item == null)
              ref.read(auditLogCreateProvider.notifier).state = val;
            else
              ref.read(auditLogUpdateProvider.notifier).state = {
                'id': item.id,
                'data': val,
              };
            Navigator.pop(ctx);
