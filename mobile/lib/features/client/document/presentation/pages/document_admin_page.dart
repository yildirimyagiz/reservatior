...
import 'package:reservatior/features/client/document/presentation/widgets/document_list_widget.dart';
import 'package:reservatior/features/client/document/presentation/widgets/document_form_widget.dart';
...
class DocumentAdminPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final itemsAsync = ref.watch(documentListProvider);

    return Scaffold(
      backgroundColor: AppColors.darkBg,
      appBar: AppBar(
        title: Text('mobile.auto.feature_document_title'.tr()),
        ...
        data: (data) {
          ...
          return RefreshIndicator(
            ...
            child: SingleChildScrollView(
              ...
              child: DocumentListWidget(items: filteredData as List<Document>),
            ),
          );
        },
        ...
        error: (e, s) => Center(
          child: Column(
            ...
            children: [
              ...
              TextButton(
                onPressed: () => ref.refresh(documentListProvider),
    ...
    showModalBottomSheet(
      ...
      builder: (ctx) => Padding(
        ...
        child: DocumentFormWidget(
          ...
          onSubmit: (val) {
            if (item == null)
              ref.read(documentCreateProvider.notifier).state = val;
            else
              ref.read(documentUpdateProvider.notifier).state = {
                'id': item.id,
                'data': val,
              };
            Navigator.pop(ctx);
