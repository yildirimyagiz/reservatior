...
class MlsSyncJobFormWidget extends ConsumerStatefulWidget {
  final MlsSyncJob? item;
  final Function(MlsSyncJob) onSubmit;
  const MlsSyncJobFormWidget({super.key, this.item, required this.onSubmit});
  @override
  ConsumerState<MlsSyncJobFormWidget> createState() =>
      _MlsSyncJobFormWidgetState();
}

class _MlsSyncJobFormWidgetState extends ConsumerState<MlsSyncJobFormWidget> {
    ...
    return Container(
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            Text(
              widget.item == null ? "${'mobile.auto.new'.tr()} ${'mobile.modules.mlssyncjob'.tr()}" : "${'mobile.auto.edit'.tr()} ${'mobile.modules.mlssyncjob'.tr()}",
            ...
            ElevatedButton(
              onPressed: () {
                ...
                try {
                  ...
                  widget.onSubmit(MlsSyncJob.fromJson(json));
                } catch (e) {
