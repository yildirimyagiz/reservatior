...
class AiChatMessageListWidget extends StatelessWidget {
  ...
  const AiChatMessageListWidget({super.key, required this.items});
  ...
  Widget build(BuildContext context) {
    if (items.isEmpty)
      return Center(
        child: Padding(
          ...
          child: Text('mobile.auto.no_ai_chat_message_items_found'.tr(),
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, i) {
        final item = items[i];
        final heroTag = 'hero_ai_chat_message_${item.id}';
        String title = 'Item';
        try {
