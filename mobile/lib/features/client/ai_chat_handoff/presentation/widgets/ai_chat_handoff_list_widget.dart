...
class AiChatHandoffListWidget extends StatelessWidget {
  ...
  const AiChatHandoffListWidget({super.key, required this.items});
  ...
  Widget build(BuildContext context) {
    if (items.isEmpty)
      return Center(
        child: Padding(
          ...
          child: Text('mobile.auto.no_ai_chat_handoff_items_found'.tr(),
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, i) {
        final item = items[i];
        final heroTag = 'hero_ai_chat_handoff_${item.id}';
        String title = 'Item';
        try {
