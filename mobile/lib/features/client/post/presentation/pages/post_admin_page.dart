...
import 'package:reservatior/shared/providers/post_provider.dart';
import 'package:reservatior/shared/providers/auth_provider.dart';
import 'package:reservatior/shared/models/models.dart';
import 'package:reservatior/core/theme/app_theme.dart';
import 'package:reservatior/features/client/post/presentation/widgets/post_list_widget.dart';
import 'package:reservatior/features/client/post/presentation/widgets/post_form_widget.dart';
...
class PostAdminPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final itemsAsync = ref.watch(postListProvider);

    return Scaffold(
      backgroundColor: AppColors.darkBg,
      appBar: AppBar(
        title: Text('mobile.auto.feature_post_title'.tr()),
        ...
        data: (data) {
          ...
          return RefreshIndicator(
            ...
            child: SingleChildScrollView(
              ...
              child: PostListWidget(items: filteredData as List<Post>),
            ),
          );
        },
    ...
    showModalBottomSheet(
      ...
      builder: (ctx) => Padding(
        ...
        child: PostFormWidget(
          ...
          onSubmit: (val) {
            if (item == null)
              ref.read(postCreateProvider.notifier).state = val;
            else
              ref.read(postUpdateProvider.notifier).state = {
                'id': item.id,
                'data': val,
              };
            Navigator.pop(ctx);
