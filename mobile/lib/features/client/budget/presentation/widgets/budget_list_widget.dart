...
class BudgetListWidget extends StatelessWidget {
  ...
  const BudgetListWidget({super.key, required this.items});
  ...
  Widget build(BuildContext context) {
    if (items.isEmpty)
      return Center(
        child: Padding(
          ...
          child: Text('mobile.auto.no_budget_items_found'.tr(),
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, i) {
        final item = items[i];
        final heroTag = 'hero_budget_${item.id}';
        String title = 'Item';
        try {
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(height: 4),
                              Text('mobile.auto.id'.tr().split('').first +
