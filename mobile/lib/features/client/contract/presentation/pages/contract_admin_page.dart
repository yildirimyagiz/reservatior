...
import 'package:reservatior/features/client/contract/presentation/widgets/contract_list_widget.dart';
import 'package:reservatior/features/client/contract/presentation/widgets/contract_form_widget.dart';
...
class ContractAdminPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('mobile.legal.contractTitle'.tr()),
      ...
      body: itemsAsync.when(
        data: (data) {
          ...
          return RefreshIndicator(
            onRefresh: () async => ref.refresh(contractListProvider),
            child: SingleChildScrollView(
              padding: const EdgeInsets.symmetric(vertical: 16),
              child: ContractListWidget(items: filteredData as List<Contract>),
            ),
          );
        },
        ...
        error: (e, s) => Center(
          child: Column(
            ...
            children: [
              ...
              TextButton(
                onPressed: () => ref.refresh(contractListProvider),
    ...
    showModalBottomSheet(
      ...
      builder: (ctx) => Padding(
        ...
        child: ContractFormWidget(
          ...
          onSubmit: (val) {
            if (item == null)
              ref.read(contractCreateProvider.notifier).state = val;
            else
              ref.read(contractUpdateProvider.notifier).state = {
                'id': item.id,
                'data': val,
              };
            Navigator.pop(ctx);
