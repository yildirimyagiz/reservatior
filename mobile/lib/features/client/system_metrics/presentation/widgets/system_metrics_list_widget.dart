...
class SystemMetricsListWidget extends StatelessWidget {
  ...
  const SystemMetricsListWidget({super.key, required this.items});
  ...
  Widget build(BuildContext context) {
    if (items.isEmpty)
      return Center(
        child: Padding(
          ...
          child: Text('mobile.auto.no_system_metrics_items_found'.tr(),
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, i) {
        final item = items[i];
        final heroTag = 'hero_system_metrics_${item.id}';
        String title = 'Item';
        try {
