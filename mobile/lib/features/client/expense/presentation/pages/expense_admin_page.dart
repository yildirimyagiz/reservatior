...
import 'package:reservatior/features/client/expense/presentation/widgets/expense_list_widget.dart';
import 'package:reservatior/features/client/expense/presentation/widgets/expense_form_widget.dart';
    ...
    return Scaffold(
            ...
            slivers: [
              SliverAppBar(
                ...
                flexibleSpace: FlexibleSpaceBar(
                  centerTitle: true,
                  title: Text('mobile.auto.expense_center'.tr(),
                    ...
                    sliver: SliverToBoxAdapter(
                      child: RefreshIndicator(
                        ...
                        child: ExpenseListWidget(
                          items: filteredData as List<Expense>,
                        ),
                      ),
                    ),
                  );
      ...
      floatingActionButton: Container(
        ...
        child: FloatingActionButton.extended(
          ...
          label: Text('mobile.auto.new_expense'.tr(),
            style: GoogleFonts.outfit(
    ...
    showModalBottomSheet(
      ...
      builder: (ctx) => Padding(
        ...
        child: ExpenseFormWidget(
          ...
          onSubmit: (val) {
            if (item == null)
              ref.read(expenseCreateProvider.notifier).state = val;
            else
              ref.read(expenseUpdateProvider.notifier).state = {
                'id': item.id,
                'data': val,
              };
            Navigator.pop(ctx);
