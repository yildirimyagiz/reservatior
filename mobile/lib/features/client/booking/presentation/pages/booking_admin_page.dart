...
import 'package:reservatior/features/client/booking/presentation/widgets/booking_form_widget.dart';
...
class BookingAdminPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('mobile.auto.feature_booking_title'.tr()),
        ...
        data: (data) {
          ...
          return RefreshIndicator(
            ...
            child: SingleChildScrollView(
              ...
              child: BookingListWidget(items: filteredData as List<Booking>),
            ),
          );
        },
    ...
    showModalBottomSheet(
      ...
      builder: (ctx) => Padding(
        ...
        child: BookingFormWidget(
          ...
          onSubmit: (val) {
            if (item == null)
              ref.read(bookingCreateProvider.notifier).state = val;
            else
              ref.read(bookingUpdateProvider.notifier).state = {
                'id': item.id,
                'data': val,
              };
            Navigator.pop(ctx);
