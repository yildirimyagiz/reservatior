...
class CurrencyListWidget extends StatelessWidget {
  ...
  final void Function(Currency)? onEdit;
  final void Function(Currency)? onDelete;
  const CurrencyListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
