...
// ── AIImageAnalysis List Widget

class AIImageAnalysisListWidget extends StatelessWidget {
  final List<AIImageAnalysis> items;
  final void Function(AIImageAnalysis)? onTap;
  final void Function(AIImageAnalysis)? onEdit;
  final void Function(AIImageAnalysis)? onDelete;
  const AIImageAnalysisListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
