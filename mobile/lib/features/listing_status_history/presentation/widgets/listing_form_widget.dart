...
// ── Listing Form Widget ──
// Fields: propertyId, type, status, willBeAvailableAt, strategy, title, description, price, priceCurrency, locationId
          ...
          children: [
              ...
              InkWell(
                ...
                child: InputDecorator(
                  ...
                  child: Text(_willBeAvailableAt != null ? _fmt(_willBeAvailableAt) : 'Tap to select'),
                ),
              ),
              const SizedBox(height: 12),
              TextFormField(
