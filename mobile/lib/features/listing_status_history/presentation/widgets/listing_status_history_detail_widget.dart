...
// ── ListingStatusHistory Detail Widget  |  10 fields

class ListingStatusHistoryDetailWidget extends StatelessWidget {
  final ListingStatusHistory item;
  const ListingStatusHistoryDetailWidget({super.key, required this.item});
