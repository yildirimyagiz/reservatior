...
// ── VacationRentalPlatform Detail Widget  |  10 fields

class VacationRentalPlatformDetailWidget extends StatelessWidget {
  final VacationRentalPlatform item;
  const VacationRentalPlatformDetailWidget({super.key, required this.item});
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      if (item.status != null)
        ...
        _row('Rental Id', item.rentalId?.toString() ?? 'N/A', Icons.link),
        ...
        _row('Sync Enabled', (item.syncEnabled == true ? 'Yes' : 'No'), Icons.toggle_on),
