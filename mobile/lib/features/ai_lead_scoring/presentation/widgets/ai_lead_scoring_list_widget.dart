...
// ── AILeadScoring List Widget

class AILeadScoringListWidget extends StatelessWidget {
  final List<AILeadScoring> items;
  final void Function(AILeadScoring)? onTap;
  final void Function(AILeadScoring)? onEdit;
  final void Function(AILeadScoring)? onDelete;
  const AILeadScoringListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
