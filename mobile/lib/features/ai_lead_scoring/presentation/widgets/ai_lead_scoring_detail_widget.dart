...
// ── AILeadScoring Detail Widget  |  11 fields

class AILeadScoringDetailWidget extends StatelessWidget {
  final AILeadScoring item;
  const AILeadScoringDetailWidget({super.key, required this.item});
