...
// ── OfflineSyncQueue Detail Widget  |  12 fields

class OfflineSyncQueueDetailWidget extends StatelessWidget {
  final OfflineSyncQueue item;
  const OfflineSyncQueueDetailWidget({super.key, required this.item});
      ...
      if (item.syncStatus != null)
        Padding(
          ...
          child: Chip(
            ...
            label: Text(item.syncStatus!.toString(), style: const TextStyle(fontWeight: FontWeight.w600)),
            backgroundColor: _stColor(item.syncStatus).withOpacity(0.15),
          ),
        ),
