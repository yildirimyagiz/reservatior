...
// ── PricingRule List Widget

class PricingRuleListWidget extends StatelessWidget {
  final List<PricingRule> items;
  final void Function(PricingRule)? onTap;
  final void Function(PricingRule)? onEdit;
  final void Function(PricingRule)? onDelete;
  const PricingRuleListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
