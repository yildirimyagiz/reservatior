...
// ── ExternalRentalListing List Widget

class ExternalRentalListingListWidget extends StatelessWidget {
  final List<ExternalRentalListing> items;
  final void Function(ExternalRentalListing)? onTap;
  final void Function(ExternalRentalListing)? onEdit;
  final void Function(ExternalRentalListing)? onDelete;
  const ExternalRentalListingListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
