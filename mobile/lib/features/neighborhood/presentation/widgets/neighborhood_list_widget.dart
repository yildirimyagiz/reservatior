...
class NeighborhoodListWidget extends StatelessWidget {
  final List<Neighborhood> items;
  final void Function(Neighborhood)? onTap;
  final void Function(Neighborhood)? onEdit;
  final void Function(Neighborhood)? onDelete;
  const NeighborhoodListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
