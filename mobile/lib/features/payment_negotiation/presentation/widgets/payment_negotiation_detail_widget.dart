...
// ── PaymentNegotiation Detail Widget  |  17 fields

class PaymentNegotiationDetailWidget extends StatelessWidget {
  final PaymentNegotiation item;
  const PaymentNegotiationDetailWidget({super.key, required this.item});
