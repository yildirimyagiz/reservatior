...
// ── AIPriceOptimization List Widget

class AIPriceOptimizationListWidget extends StatelessWidget {
  final List<AIPriceOptimization> items;
  final void Function(AIPriceOptimization)? onTap;
  final void Function(AIPriceOptimization)? onEdit;
  final void Function(AIPriceOptimization)? onDelete;
  const AIPriceOptimizationListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
