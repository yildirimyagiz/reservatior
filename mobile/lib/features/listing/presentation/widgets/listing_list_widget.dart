...
class ListingListWidget extends StatelessWidget {
  ...
  final void Function(Listing)? onEdit;
  final void Function(Listing)? onDelete;
  const ListingListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
