...
// ── LoyaltyAccount List Widget

class LoyaltyAccountListWidget extends StatelessWidget {
  final List<LoyaltyAccount> items;
  final void Function(LoyaltyAccount)? onTap;
  final void Function(LoyaltyAccount)? onEdit;
  final void Function(LoyaltyAccount)? onDelete;
  const LoyaltyAccountListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
