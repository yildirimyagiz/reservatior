...
// ── AgentPerformance List Widget

class AgentPerformanceListWidget extends StatelessWidget {
  final List<AgentPerformance> items;
  final void Function(AgentPerformance)? onTap;
  final void Function(AgentPerformance)? onEdit;
  final void Function(AgentPerformance)? onDelete;
  const AgentPerformanceListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
