...
// ── FloorPlan List Widget

class FloorPlanListWidget extends StatelessWidget {
  final List<FloorPlan> items;
  final void Function(FloorPlan)? onTap;
  final void Function(FloorPlan)? onEdit;
  final void Function(FloorPlan)? onDelete;
  const FloorPlanListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
