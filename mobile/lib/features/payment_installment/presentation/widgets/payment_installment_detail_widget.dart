...
// ── PaymentInstallment Detail Widget  |  14 fields

class PaymentInstallmentDetailWidget extends StatelessWidget {
  final PaymentInstallment item;
  const PaymentInstallmentDetailWidget({super.key, required this.item});
