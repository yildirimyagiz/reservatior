...
// ── PaymentInstallment List Widget

class PaymentInstallmentListWidget extends StatelessWidget {
  final List<PaymentInstallment> items;
  final void Function(PaymentInstallment)? onTap;
  final void Function(PaymentInstallment)? onEdit;
  final void Function(PaymentInstallment)? onDelete;
  const PaymentInstallmentListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
