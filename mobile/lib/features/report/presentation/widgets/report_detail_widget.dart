...
// ── Report Detail Widget  |  13 fields

class ReportDetailWidget extends StatelessWidget {
  final Report item;
  const ReportDetailWidget({super.key, required this.item});
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        _row('Recipients', item.recipients?.toString() ?? 'N/A', Icons.text_fields),
        _row('Last Run At', _fmt(item.lastRunAt), Icons.calendar_today),
