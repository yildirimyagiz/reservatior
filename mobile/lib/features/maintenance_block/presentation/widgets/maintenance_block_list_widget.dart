...
// ── MaintenanceBlock List Widget

class MaintenanceBlockListWidget extends StatelessWidget {
  final List<MaintenanceBlock> items;
  final void Function(MaintenanceBlock)? onTap;
  final void Function(MaintenanceBlock)? onEdit;
  final void Function(MaintenanceBlock)? onDelete;
  const MaintenanceBlockListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
