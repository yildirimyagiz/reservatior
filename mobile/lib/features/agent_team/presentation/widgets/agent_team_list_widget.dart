...
// ── AgentTeam List Widget

class AgentTeamListWidget extends StatelessWidget {
  final List<AgentTeam> items;
  final void Function(AgentTeam)? onTap;
  final void Function(AgentTeam)? onEdit;
  final void Function(AgentTeam)? onDelete;
  const AgentTeamListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
