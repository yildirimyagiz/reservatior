...
// ── IncludedService List Widget

class IncludedServiceListWidget extends StatelessWidget {
  final List<IncludedService> items;
  final void Function(IncludedService)? onTap;
  final void Function(IncludedService)? onEdit;
  final void Function(IncludedService)? onDelete;
  const IncludedServiceListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
