...
// ── PropertyDisclosure Client Page

class PropertyDisclosureClientPage extends ConsumerStatefulWidget {
  const PropertyDisclosureClientPage({super.key});
  @override ConsumerState<PropertyDisclosureClientPage> createState() => _PropertyDisclosureClientPageState();
}

class _PropertyDisclosureClientPageState extends ConsumerState<PropertyDisclosureClientPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('My Property Disclosures'),
        backgroundColor: Colors.teal[700], foregroundColor: Colors.white,
        actions: [
          IconButton(icon: const Icon(Icons.refresh), onPressed: () => ref.invalidate(propertyDisclosureListProvider)),
        ],
      ),
          ...
          data: (items) {
            ...
            if (list.isEmpty) {
              return Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                ...
                Text('No Property Disclosures', style: TextStyle(color: Colors.grey[500])),
              ]));
            }
            return RefreshIndicator(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (ctx, i) {
                  final item = list[i];
                  final _title = item.packStatus?.toString() ?? 'Unknown';
                  return Card(
      ...
      floatingActionButton: FloatingActionButton.extended(
        heroTag: 'PropertyDisclosureClientFAB',
      ...
      builder: (ctx) => DraggableScrollableSheet(
        ...
        builder: (ctx2, sc) => Column(children: [
          ...
          Padding(padding: const EdgeInsets.symmetric(horizontal: 16),
            child: Row(children: [
              const Text('Property Disclosure Details', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
              const Spacer(),
  ...
  void _showForm(BuildContext context, {PropertyDisclosure? item}) {
    showModalBottomSheet(
      context: context, isScrollControlled: true,
      shape: const RoundedRectangleBorder(borderRadius: BorderRadius.vertical(top: Radius.circular(20))),
      builder: (ctx) => Padding(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          Padding(padding: const EdgeInsets.symmetric(horizontal: 16),
            child: Align(alignment: Alignment.centerLeft,
              child: Text(item != null ? 'Edit Property Disclosure' : 'New Property Disclosure',
