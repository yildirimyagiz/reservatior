...
// ── DocumentAnalysis List Widget

class DocumentAnalysisListWidget extends StatelessWidget {
  final List<DocumentAnalysis> items;
  final void Function(DocumentAnalysis)? onTap;
  final void Function(DocumentAnalysis)? onEdit;
  final void Function(DocumentAnalysis)? onDelete;
  const DocumentAnalysisListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
