...
// ── MLConfiguration List Widget

class MLConfigurationListWidget extends StatelessWidget {
  final List<MLConfiguration> items;
  final void Function(MLConfiguration)? onTap;
  final void Function(MLConfiguration)? onEdit;
  final void Function(MLConfiguration)? onDelete;
  const MLConfigurationListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
