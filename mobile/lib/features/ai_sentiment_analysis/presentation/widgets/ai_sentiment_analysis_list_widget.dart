...
// ── AISentimentAnalysis List Widget

class AISentimentAnalysisListWidget extends StatelessWidget {
  final List<AISentimentAnalysis> items;
  final void Function(AISentimentAnalysis)? onTap;
  final void Function(AISentimentAnalysis)? onEdit;
  final void Function(AISentimentAnalysis)? onDelete;
  const AISentimentAnalysisListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
