...
// ── CommunicationLog List Widget

class CommunicationLogListWidget extends StatelessWidget {
  final List<CommunicationLog> items;
  final void Function(CommunicationLog)? onTap;
  final void Function(CommunicationLog)? onEdit;
  final void Function(CommunicationLog)? onDelete;
  const CommunicationLogListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
