...
// ── CommunicationLog Detail Widget  |  26 fields

class CommunicationLogDetailWidget extends StatelessWidget {
  final CommunicationLog item;
  const CommunicationLogDetailWidget({super.key, required this.item});
