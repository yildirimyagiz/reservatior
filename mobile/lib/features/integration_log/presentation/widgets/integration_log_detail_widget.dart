...
// ── IntegrationLog Detail Widget  |  13 fields

class IntegrationLogDetailWidget extends StatelessWidget {
  final IntegrationLog item;
  const IntegrationLogDetailWidget({super.key, required this.item});
