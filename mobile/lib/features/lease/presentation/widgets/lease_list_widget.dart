...
class LeaseListWidget extends StatelessWidget {
  ...
  final void Function(Lease)? onTap;
  final void Function(Lease)? onEdit;
  final void Function(Lease)? onDelete;
  const LeaseListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
