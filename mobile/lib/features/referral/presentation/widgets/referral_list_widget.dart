...
class ReferralListWidget extends StatelessWidget {
  ...
  final void Function(Referral)? onEdit;
  final void Function(Referral)? onDelete;
  const ReferralListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
