...
class DocumentListWidget extends StatelessWidget {
  ...
  final void Function(Document)? onEdit;
  final void Function(Document)? onDelete;
  const DocumentListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
