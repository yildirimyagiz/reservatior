...
// ── AmbassadorCampaign List Widget

class AmbassadorCampaignListWidget extends StatelessWidget {
  final List<AmbassadorCampaign> items;
  final void Function(AmbassadorCampaign)? onTap;
  final void Function(AmbassadorCampaign)? onEdit;
  final void Function(AmbassadorCampaign)? onDelete;
  const AmbassadorCampaignListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
