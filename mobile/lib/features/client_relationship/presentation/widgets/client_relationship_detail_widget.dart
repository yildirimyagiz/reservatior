...
// ── ClientRelationship Detail Widget  |  8 fields

class ClientRelationshipDetailWidget extends StatelessWidget {
  final ClientRelationship item;
  const ClientRelationshipDetailWidget({super.key, required this.item});
