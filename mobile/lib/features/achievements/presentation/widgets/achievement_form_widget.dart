...
// ── Achievement Form Widget ──
// Fields: userId, goalType, goalValue, currentValue, isCompleted, completedAt, pointsReward, bonusReward, organizationId
...
class AchievementFormWidget extends StatefulWidget {
  ...
  @override
  State<AchievementFormWidget> createState() => _AchievementFormWidgetState();
}
...
class _AchievementFormWidgetState extends State<AchievementFormWidget> {
  ...
  void dispose() {
    ...
    _cGoalType.dispose();
    _cGoalValue.dispose();
    _cCurrentValue.dispose();
    _cPointsReward.dispose();
    _cBonusReward.dispose();
  ...
  void _submit() {
    ...
    final data = <String, dynamic>{
        ...
        if (_goalType != null) 'goalType': _goalType,
          ...
          children: [
              ...
              InkWell(
                ...
                child: InputDecorator(
                  ...
                  child: Text(_completedAt != null ? _fmt(_completedAt) : 'Tap to select'),
                ),
              ),
              const SizedBox(height: 12),
              TextFormField(
