...
// ── UserFinancialProfile List Widget

class UserFinancialProfileListWidget extends StatelessWidget {
  final List<UserFinancialProfile> items;
  final void Function(UserFinancialProfile)? onTap;
  final void Function(UserFinancialProfile)? onEdit;
  final void Function(UserFinancialProfile)? onDelete;
  const UserFinancialProfileListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
