...
class LanguageListWidget extends StatelessWidget {
  ...
  final void Function(Language)? onTap;
  final void Function(Language)? onEdit;
  final void Function(Language)? onDelete;
  const LanguageListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
