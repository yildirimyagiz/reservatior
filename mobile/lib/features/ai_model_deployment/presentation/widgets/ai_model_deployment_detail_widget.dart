...
// ── AIModelDeployment Detail Widget  |  12 fields

class AIModelDeploymentDetailWidget extends StatelessWidget {
  final AIModelDeployment item;
  const AIModelDeploymentDetailWidget({super.key, required this.item});
