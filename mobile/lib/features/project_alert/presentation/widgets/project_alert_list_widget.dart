...
// ── ProjectAlert List Widget

class ProjectAlertListWidget extends StatelessWidget {
  final List<ProjectAlert> items;
  final void Function(ProjectAlert)? onTap;
  final void Function(ProjectAlert)? onEdit;
  final void Function(ProjectAlert)? onDelete;
  const ProjectAlertListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
