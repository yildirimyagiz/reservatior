...
// ── ContractVersion List Widget

class ContractVersionListWidget extends StatelessWidget {
  final List<ContractVersion> items;
  final void Function(ContractVersion)? onTap;
  final void Function(ContractVersion)? onEdit;
  final void Function(ContractVersion)? onDelete;
  const ContractVersionListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
