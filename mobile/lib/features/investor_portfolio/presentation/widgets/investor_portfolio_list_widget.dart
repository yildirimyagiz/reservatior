...
// ── InvestorPortfolio List Widget

class InvestorPortfolioListWidget extends StatelessWidget {
  final List<InvestorPortfolio> items;
  final void Function(InvestorPortfolio)? onTap;
  final void Function(InvestorPortfolio)? onEdit;
  final void Function(InvestorPortfolio)? onDelete;
  const InvestorPortfolioListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
