...
// ── RentSchedule List Widget

class RentScheduleListWidget extends StatelessWidget {
  final List<RentSchedule> items;
  final void Function(RentSchedule)? onTap;
  final void Function(RentSchedule)? onEdit;
  final void Function(RentSchedule)? onDelete;
  const RentScheduleListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
