...
// ── GovernmentIntegration List Widget

class GovernmentIntegrationListWidget extends StatelessWidget {
  final List<GovernmentIntegration> items;
  final void Function(GovernmentIntegration)? onTap;
  final void Function(GovernmentIntegration)? onEdit;
  final void Function(GovernmentIntegration)? onDelete;
  const GovernmentIntegrationListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
