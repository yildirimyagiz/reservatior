...
// ── AmbassadorContract List Widget

class AmbassadorContractListWidget extends StatelessWidget {
  final List<AmbassadorContract> items;
  final void Function(AmbassadorContract)? onTap;
  final void Function(AmbassadorContract)? onEdit;
  final void Function(AmbassadorContract)? onDelete;
  const AmbassadorContractListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
