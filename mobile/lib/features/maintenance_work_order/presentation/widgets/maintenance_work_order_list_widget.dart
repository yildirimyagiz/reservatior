...
// ── MaintenanceWorkOrder List Widget ──

class MaintenanceWorkOrderListWidget extends StatelessWidget {
  final List<MaintenanceWorkOrder> items;
  final void Function(MaintenanceWorkOrder)? onTap;
  final void Function(MaintenanceWorkOrder)? onEdit;
  final void Function(MaintenanceWorkOrder)? onDelete;

  const MaintenanceWorkOrderListWidget({
    super.key,
    required this.items,
    this.onTap,
    this.onEdit,
