...
class DiscountListWidget extends StatelessWidget {
  ...
  final void Function(Discount)? onTap;
  final void Function(Discount)? onEdit;
  final void Function(Discount)? onDelete;
  const DiscountListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
