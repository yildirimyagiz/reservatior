...
class RouteListWidget extends StatelessWidget {
  ...
  final void Function(Route)? onTap;
  final void Function(Route)? onEdit;
  final void Function(Route)? onDelete;
  const RouteListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
