...
// ── SignatureSigner List Widget

class SignatureSignerListWidget extends StatelessWidget {
  final List<SignatureSigner> items;
  final void Function(SignatureSigner)? onTap;
  final void Function(SignatureSigner)? onEdit;
  final void Function(SignatureSigner)? onDelete;
  const SignatureSignerListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
