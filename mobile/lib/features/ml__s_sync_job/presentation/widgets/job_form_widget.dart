...
// ── Job Form Widget ──
// Fields: type, payload, status, runAt, attempts, lastError, lockedAt, lockedBy
          ...
          children: [
              ...
              InkWell(
                ...
                child: InputDecorator(
                  ...
                  child: Text(_runAt != null ? _fmt(_runAt) : 'Tap to select'),
                ),
              ),
              const SizedBox(height: 12),
              TextFormField(
              ...
              InkWell(
                ...
                child: InputDecorator(
                  ...
                  child: Text(_lockedAt != null ? _fmt(_lockedAt) : 'Tap to select'),
                ),
              ),
              const SizedBox(height: 12),
              TextFormField(
