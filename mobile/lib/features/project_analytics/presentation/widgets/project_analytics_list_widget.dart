...
// ── ProjectAnalytics List Widget

class ProjectAnalyticsListWidget extends StatelessWidget {
  final List<ProjectAnalytics> items;
  final void Function(ProjectAnalytics)? onTap;
  final void Function(ProjectAnalytics)? onEdit;
  final void Function(ProjectAnalytics)? onDelete;
  const ProjectAnalyticsListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
