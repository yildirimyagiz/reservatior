...
// ── MlsDataMapping List Widget

class MlsDataMappingListWidget extends StatelessWidget {
  final List<MlsDataMapping> items;
  final void Function(MlsDataMapping)? onTap;
  final void Function(MlsDataMapping)? onEdit;
  final void Function(MlsDataMapping)? onDelete;
  const MlsDataMappingListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
