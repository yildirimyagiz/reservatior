...
// ── MortgageOffer Detail Widget  |  18 fields

class MortgageOfferDetailWidget extends StatelessWidget {
  final MortgageOffer item;
  const MortgageOfferDetailWidget({super.key, required this.item});
