...
class AmenityListWidget extends StatelessWidget {
  final List<Amenity> items;
  final void Function(Amenity)? onTap;
  final void Function(Amenity)? onEdit;
  final void Function(Amenity)? onDelete;
  const AmenityListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
