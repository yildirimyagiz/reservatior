...
// ── EscrowAccount List Widget

class EscrowAccountListWidget extends StatelessWidget {
  final List<EscrowAccount> items;
  final void Function(EscrowAccount)? onTap;
  final void Function(EscrowAccount)? onEdit;
  final void Function(EscrowAccount)? onDelete;
  const EscrowAccountListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
