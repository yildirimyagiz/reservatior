...
// ── EscrowAccount Detail Widget  |  11 fields

class EscrowAccountDetailWidget extends StatelessWidget {
  final EscrowAccount item;
  const EscrowAccountDetailWidget({super.key, required this.item});
