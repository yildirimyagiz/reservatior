...
// ── PropertyPromotion List Widget

class PropertyPromotionListWidget extends StatelessWidget {
  final List<PropertyPromotion> items;
  final void Function(PropertyPromotion)? onTap;
  final void Function(PropertyPromotion)? onEdit;
  final void Function(PropertyPromotion)? onDelete;
  const PropertyPromotionListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
