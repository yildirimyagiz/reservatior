...
class HashtagListWidget extends StatelessWidget {
  ...
  final void Function(Hashtag)? onTap;
  final void Function(Hashtag)? onEdit;
  final void Function(Hashtag)? onDelete;
  const HashtagListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
