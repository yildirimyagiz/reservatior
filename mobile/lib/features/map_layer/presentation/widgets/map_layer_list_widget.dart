...
// ── MapLayer List Widget

class MapLayerListWidget extends StatelessWidget {
  final List<MapLayer> items;
  final void Function(MapLayer)? onTap;
  final void Function(MapLayer)? onEdit;
  final void Function(MapLayer)? onDelete;
  const MapLayerListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
