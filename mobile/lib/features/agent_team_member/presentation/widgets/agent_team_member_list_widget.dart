...
// ── AgentTeamMember List Widget

class AgentTeamMemberListWidget extends StatelessWidget {
  final List<AgentTeamMember> items;
  final void Function(AgentTeamMember)? onTap;
  final void Function(AgentTeamMember)? onEdit;
  final void Function(AgentTeamMember)? onDelete;
  const AgentTeamMemberListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
      ...
      itemBuilder: (ctx, i) {
        ...
        return Card(
          ...
          child: ListTile(
            ...
            subtitle: Text('Team Id: ${item.teamId?.toString() ?? "N/A"}'),
