...
class AgencyListWidget extends StatelessWidget {
  ...
  final void Function(Agency)? onTap;
  final void Function(Agency)? onEdit;
  final void Function(Agency)? onDelete;
  const AgencyListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
