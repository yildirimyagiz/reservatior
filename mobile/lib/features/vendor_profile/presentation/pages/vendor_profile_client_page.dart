...
// ── VendorProfile Client Page

class VendorProfileClientPage extends ConsumerStatefulWidget {
  const VendorProfileClientPage({super.key});
  @override ConsumerState<VendorProfileClientPage> createState() => _VendorProfileClientPageState();
}

class _VendorProfileClientPageState extends ConsumerState<VendorProfileClientPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('My Vendor Profiles'),
        backgroundColor: Colors.teal[700], foregroundColor: Colors.white,
        actions: [
          IconButton(icon: const Icon(Icons.refresh), onPressed: () => ref.invalidate(vendorProfileListProvider)),
        ],
      ),
          ...
          data: (items) {
            ...
            if (list.isEmpty) {
              return Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                ...
                Text('No Vendor Profiles', style: TextStyle(color: Colors.grey[500])),
              ]));
            }
            return RefreshIndicator(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (ctx, i) {
                  final item = list[i];
                  final _title = item.legalName?.toString() ?? 'Unknown';
                  return Card(
      ...
      floatingActionButton: FloatingActionButton.extended(
        heroTag: 'VendorProfileClientFAB',
      ...
      builder: (ctx) => DraggableScrollableSheet(
        ...
        builder: (ctx2, sc) => Column(children: [
          ...
          Padding(padding: const EdgeInsets.symmetric(horizontal: 16),
            child: Row(children: [
              const Text('Vendor Profile Details', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
              const Spacer(),
  ...
  void _showForm(BuildContext context, {VendorProfile? item}) {
    showModalBottomSheet(
      context: context, isScrollControlled: true,
      shape: const RoundedRectangleBorder(borderRadius: BorderRadius.vertical(top: Radius.circular(20))),
      builder: (ctx) => Padding(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          Padding(padding: const EdgeInsets.symmetric(horizontal: 16),
            child: Align(alignment: Alignment.centerLeft,
              child: Text(item != null ? 'Edit Vendor Profile' : 'New Vendor Profile',
