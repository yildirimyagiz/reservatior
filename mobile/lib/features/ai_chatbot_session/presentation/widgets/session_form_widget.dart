...
// ── Session Form Widget ──
// Fields: userId, tokenHash, expiresAt, ip, userAgent
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
              ...
              TextFormField(
                decoration: InputDecoration(labelText: 'Token Hash', prefixIcon: Icon(Icons.text_fields), border: OutlineInputBorder()),
                maxLines: 1,
              ...
              InkWell(
                ...
                child: InputDecorator(
                  ...
                  child: Text(_expiresAt != null ? _fmt(_expiresAt) : 'Tap to select'),
                ),
              ),
              const SizedBox(height: 12),
              TextFormField(
                decoration: InputDecoration(labelText: 'Ip', prefixIcon: Icon(Icons.text_fields), border: OutlineInputBorder()),
                maxLines: 1,
                onSaved: (v) => _ip = v?.isEmpty == true ? null : v,
              ),
              const SizedBox(height: 12),
              TextFormField(
                decoration: InputDecoration(labelText: 'User Agent', prefixIcon: Icon(Icons.text_fields), border: OutlineInputBorder()),
                maxLines: 1,
