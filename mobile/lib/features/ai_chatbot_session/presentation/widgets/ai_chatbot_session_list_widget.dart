...
// ── AIChatbotSession List Widget

class AIChatbotSessionListWidget extends StatelessWidget {
  final List<AIChatbotSession> items;
  final void Function(AIChatbotSession)? onTap;
  final void Function(AIChatbotSession)? onEdit;
  final void Function(AIChatbotSession)? onDelete;
  const AIChatbotSessionListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
