...
class MessageClientPage extends ConsumerStatefulWidget {
  const MessageClientPage({super.key});
  @override ConsumerState<MessageClientPage> createState() => _MessageClientPageState();
}

class _MessageClientPageState extends ConsumerState<MessageClientPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(icon: const Icon(Icons.refresh), onPressed: () => ref.invalidate(messageListProvider)),
        ],
      ),
                ...
                itemBuilder: (ctx, i) {
                  ...
                  return Card(
                    ...
                    child: ListTile(
                      ...
                      leading: CircleAvatar(backgroundColor: _stColor(item.readStatus), foregroundColor: Colors.white, child: Text(item.subject != null && item.subject!.toString().isNotEmpty ? item.subject!.toString()[0].toUpperCase() : '?'),),
      ...
      builder: (ctx) => DraggableScrollableSheet(
        ...
        builder: (ctx2, sc) => Column(children: [
          ...
          Padding(padding: const EdgeInsets.symmetric(horizontal: 16),
            child: Row(children: [
              const Text('Message Details', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
              const Spacer(),
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          const Padding(padding: EdgeInsets.symmetric(horizontal: 16),
            child: Align(alignment: Alignment.centerLeft,
              child: Text('New Message', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)))),
          const Divider(),
          ConstrainedBox(
            ...
            child: SingleChildScrollView(
              ...
              child: MessageFormWidget(
                onSubmit: (newItem) {
                  ref.read(messageCreateStateProvider.notifier).state = newItem;
                  Navigator.pop(ctx);
                },
              ),
            ),
