...
// ── PropertyOffer List Widget

class PropertyOfferListWidget extends StatelessWidget {
  final List<PropertyOffer> items;
  final void Function(PropertyOffer)? onTap;
  final void Function(PropertyOffer)? onEdit;
  final void Function(PropertyOffer)? onDelete;
  const PropertyOfferListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
