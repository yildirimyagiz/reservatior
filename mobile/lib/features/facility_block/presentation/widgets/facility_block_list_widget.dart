...
// ── FacilityBlock List Widget

class FacilityBlockListWidget extends StatelessWidget {
  final List<FacilityBlock> items;
  final void Function(FacilityBlock)? onTap;
  final void Function(FacilityBlock)? onEdit;
  final void Function(FacilityBlock)? onDelete;
  const FacilityBlockListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
