...
// ── FacilityBlock Detail Widget  |  10 fields

class FacilityBlockDetailWidget extends StatelessWidget {
  final FacilityBlock item;
  const FacilityBlockDetailWidget({super.key, required this.item});
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        _row('Features', item.features?.join(', ') ?? 'N/A', Icons.list),
        _row('Images', item.images?.join(', ') ?? 'N/A', Icons.image),
      ],
    );
  }
}
