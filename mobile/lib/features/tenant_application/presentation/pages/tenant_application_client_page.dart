...
// ── TenantApplication Client Page

class TenantApplicationClientPage extends ConsumerStatefulWidget {
  const TenantApplicationClientPage({super.key});
  @override ConsumerState<TenantApplicationClientPage> createState() => _TenantApplicationClientPageState();
}

class _TenantApplicationClientPageState extends ConsumerState<TenantApplicationClientPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('My Tenant Applications'),
        backgroundColor: Colors.teal[700], foregroundColor: Colors.white,
        actions: [
          IconButton(icon: const Icon(Icons.refresh), onPressed: () => ref.invalidate(tenantApplicationListProvider)),
        ],
      ),
          ...
          data: (items) {
            ...
            if (list.isEmpty) {
              return Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                ...
                Text('No Tenant Applications', style: TextStyle(color: Colors.grey[500])),
              ]));
            }
            return RefreshIndicator(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (ctx, i) {
                  final item = list[i];
                  final _title = item.reviewedBy?.toString() ?? 'Unknown';
                  return Card(
      ...
      floatingActionButton: FloatingActionButton.extended(
        heroTag: 'TenantApplicationClientFAB',
      ...
      builder: (ctx) => DraggableScrollableSheet(
        ...
        builder: (ctx2, sc) => Column(children: [
          ...
          Padding(padding: const EdgeInsets.symmetric(horizontal: 16),
            child: Row(children: [
              const Text('Tenant Application Details', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
              const Spacer(),
  ...
  void _showForm(BuildContext context, {TenantApplication? item}) {
    showModalBottomSheet(
      context: context, isScrollControlled: true,
      shape: const RoundedRectangleBorder(borderRadius: BorderRadius.vertical(top: Radius.circular(20))),
      builder: (ctx) => Padding(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          Padding(padding: const EdgeInsets.symmetric(horizontal: 16),
            child: Align(alignment: Alignment.centerLeft,
              child: Text(item != null ? 'Edit Tenant Application' : 'New Tenant Application',
