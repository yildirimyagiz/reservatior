...
// ── CommissionRule List Widget

class CommissionRuleListWidget extends StatelessWidget {
  final List<CommissionRule> items;
  final void Function(CommissionRule)? onTap;
  final void Function(CommissionRule)? onEdit;
  final void Function(CommissionRule)? onDelete;
  const CommissionRuleListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
