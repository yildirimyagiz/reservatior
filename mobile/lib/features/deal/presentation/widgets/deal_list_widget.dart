        ...
        return Card(
          ...
          child: ListTile(
            ...
            leading: CircleAvatar(
              child: Text(item.listingId != null && item.listingId!.toString().isNotEmpty
                  ? item.listingId!.toString()[0].toUpperCase() : '?'),
            ),
            title: Text(item.listingId?.toString() ?? 'Unknown',
                style: const TextStyle(fontWeight: FontWeight.w600)),
            subtitle: Text('${item.listingId}'),
