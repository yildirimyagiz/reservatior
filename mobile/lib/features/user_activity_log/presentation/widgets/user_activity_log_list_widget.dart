...
// ── UserActivityLog List Widget

class UserActivityLogListWidget extends StatelessWidget {
  final List<UserActivityLog> items;
  final void Function(UserActivityLog)? onTap;
  final void Function(UserActivityLog)? onEdit;
  final void Function(UserActivityLog)? onDelete;
  const UserActivityLogListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
