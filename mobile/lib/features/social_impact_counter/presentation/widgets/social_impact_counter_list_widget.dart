...
// ── SocialImpactCounter List Widget

class SocialImpactCounterListWidget extends StatelessWidget {
  final List<SocialImpactCounter> items;
  final void Function(SocialImpactCounter)? onTap;
  final void Function(SocialImpactCounter)? onEdit;
  final void Function(SocialImpactCounter)? onDelete;
  const SocialImpactCounterListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
