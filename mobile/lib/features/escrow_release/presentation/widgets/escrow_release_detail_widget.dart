...
// ── EscrowRelease Detail Widget  |  18 fields

class EscrowReleaseDetailWidget extends StatelessWidget {
  final EscrowRelease item;
  const EscrowReleaseDetailWidget({super.key, required this.item});
