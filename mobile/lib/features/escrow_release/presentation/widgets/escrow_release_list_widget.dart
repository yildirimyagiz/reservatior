...
// ── EscrowRelease List Widget

class EscrowReleaseListWidget extends StatelessWidget {
  final List<EscrowRelease> items;
  final void Function(EscrowRelease)? onTap;
  final void Function(EscrowRelease)? onEdit;
  final void Function(EscrowRelease)? onDelete;
  const EscrowReleaseListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
