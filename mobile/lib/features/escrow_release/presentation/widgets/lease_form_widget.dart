...
// ── Lease Form Widget ──
// Fields: listingId, tenantId, status, startDate, endDate, rent, currency, deposit, rentDueDay, notes, isActive
...
class LeaseFormWidget extends StatefulWidget {
  ...
  @override
  State<LeaseFormWidget> createState() => _LeaseFormWidgetState();
}
