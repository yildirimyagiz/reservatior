...
// ── AIPredictiveMaintenance List Widget

class AIPredictiveMaintenanceListWidget extends StatelessWidget {
  final List<AIPredictiveMaintenance> items;
  final void Function(AIPredictiveMaintenance)? onTap;
  final void Function(AIPredictiveMaintenance)? onEdit;
  final void Function(AIPredictiveMaintenance)? onDelete;
  const AIPredictiveMaintenanceListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
