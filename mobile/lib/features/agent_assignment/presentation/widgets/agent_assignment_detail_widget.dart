...
// ── AgentAssignment Detail Widget  |  8 fields

class AgentAssignmentDetailWidget extends StatelessWidget {
  final AgentAssignment item;
  const AgentAssignmentDetailWidget({super.key, required this.item});
