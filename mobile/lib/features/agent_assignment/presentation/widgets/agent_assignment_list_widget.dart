...
// ── AgentAssignment List Widget

class AgentAssignmentListWidget extends StatelessWidget {
  final List<AgentAssignment> items;
  final void Function(AgentAssignment)? onTap;
  final void Function(AgentAssignment)? onEdit;
  final void Function(AgentAssignment)? onDelete;
  const AgentAssignmentListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
