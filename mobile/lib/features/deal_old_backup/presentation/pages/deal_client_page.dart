                ...
                itemBuilder: (ctx, i) {
                  ...
                  return Card(
                    ...
                    child: ListTile(
                      ...
                      leading: CircleAvatar(backgroundColor: _stColor(item.dealStatus), foregroundColor: Colors.white, child: Text(item.dealType != null && item.dealType!.toString().isNotEmpty ? item.dealType!.toString()[0].toUpperCase() : '?'),),
