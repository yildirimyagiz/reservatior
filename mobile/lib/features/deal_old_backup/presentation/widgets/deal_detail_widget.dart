      ...
      if (item.dealStatus != null)
        Padding(
          ...
          child: Chip(
            ...
            label: Text(item.dealStatus!.toString(), style: const TextStyle(fontWeight: FontWeight.w600)),
            backgroundColor: _stColor(item.dealStatus).withOpacity(0.15),
          ),
        ),
