...
// ── SharedAmenity List Widget

class SharedAmenityListWidget extends StatelessWidget {
  final List<SharedAmenity> items;
  final void Function(SharedAmenity)? onTap;
  final void Function(SharedAmenity)? onEdit;
  final void Function(SharedAmenity)? onDelete;
  const SharedAmenityListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
