...
// ── PredictiveModel List Widget

class PredictiveModelListWidget extends StatelessWidget {
  final List<PredictiveModel> items;
  final void Function(PredictiveModel)? onTap;
  final void Function(PredictiveModel)? onEdit;
  final void Function(PredictiveModel)? onDelete;
  const PredictiveModelListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
