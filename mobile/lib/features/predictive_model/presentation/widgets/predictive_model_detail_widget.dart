...
// ── PredictiveModel Detail Widget  |  7 fields

class PredictiveModelDetailWidget extends StatelessWidget {
  final PredictiveModel item;
  const PredictiveModelDetailWidget({super.key, required this.item});
