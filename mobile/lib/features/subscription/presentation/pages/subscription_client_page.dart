...
// ── Subscription Client Page

class SubscriptionClientPage extends ConsumerStatefulWidget {
  const SubscriptionClientPage({super.key});
  @override ConsumerState<SubscriptionClientPage> createState() => _SubscriptionClientPageState();
}

class _SubscriptionClientPageState extends ConsumerState<SubscriptionClientPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(icon: const Icon(Icons.refresh), onPressed: () => ref.invalidate(subscriptionListProvider)),
        ],
      ),
          ...
          data: (items) {
            ...
            if (list.isEmpty) {
              return Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                ...
                Text('No Subscriptions', style: TextStyle(color: Colors.grey[500])),
              ]));
            }
  ...
  void _showForm(BuildContext context, {Subscription? item}) {
    showModalBottomSheet(
      context: context, isScrollControlled: true,
      shape: const RoundedRectangleBorder(borderRadius: BorderRadius.vertical(top: Radius.circular(20))),
      builder: (ctx) => Padding(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          Padding(padding: const EdgeInsets.symmetric(horizontal: 16),
            child: Align(alignment: Alignment.centerLeft,
              child: Text(item != null ? 'Edit Subscription' : 'New Subscription',
