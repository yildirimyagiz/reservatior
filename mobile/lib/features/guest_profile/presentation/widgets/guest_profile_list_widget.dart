...
// ── GuestProfile List Widget

class GuestProfileListWidget extends StatelessWidget {
  final List<GuestProfile> items;
  final void Function(GuestProfile)? onTap;
  final void Function(GuestProfile)? onEdit;
  final void Function(GuestProfile)? onDelete;
  const GuestProfileListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
