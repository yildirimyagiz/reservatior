...
class PayoutClientPage extends ConsumerStatefulWidget {
  const PayoutClientPage({super.key});
  @override ConsumerState<PayoutClientPage> createState() => _PayoutClientPageState();
}

class _PayoutClientPageState extends ConsumerState<PayoutClientPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(icon: const Icon(Icons.refresh), onPressed: () => ref.invalidate(payoutListProvider)),
        ],
      ),
          ...
          data: (items) {
            ...
            if (list.isEmpty) {
              return Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                ...
                Text('No Payouts', style: TextStyle(color: Colors.grey[500])),
              ]));
            }
                ...
                itemBuilder: (ctx, i) {
                  ...
                  return Card(
                    ...
                    child: ListTile(
                      ...
                      leading: CircleAvatar(backgroundColor: _stColor(item.payoutStatus), foregroundColor: Colors.white, child: Text(item.referenceNumber != null && item.referenceNumber!.toString().isNotEmpty ? item.referenceNumber!.toString()[0].toUpperCase() : '?'),),
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          const Padding(padding: EdgeInsets.symmetric(horizontal: 16),
            child: Align(alignment: Alignment.centerLeft,
              child: Text('New Payout', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)))),
          const Divider(),
          ConstrainedBox(
            ...
            child: SingleChildScrollView(
              ...
              child: PayoutFormWidget(
                onSubmit: (newItem) {
                  ref.read(payoutCreateStateProvider.notifier).state = newItem;
                  Navigator.pop(ctx);
                },
              ),
            ),
