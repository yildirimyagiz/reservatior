...
class PayoutListWidget extends StatelessWidget {
  ...
  final void Function(Payout)? onTap;
  final void Function(Payout)? onEdit;
  final void Function(Payout)? onDelete;
  const PayoutListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
