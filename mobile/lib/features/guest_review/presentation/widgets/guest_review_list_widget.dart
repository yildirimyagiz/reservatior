...
// ── GuestReview List Widget

class GuestReviewListWidget extends StatelessWidget {
  final List<GuestReview> items;
  final void Function(GuestReview)? onTap;
  final void Function(GuestReview)? onEdit;
  final void Function(GuestReview)? onDelete;
  const GuestReviewListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
