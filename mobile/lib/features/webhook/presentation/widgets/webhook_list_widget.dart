...
class WebhookListWidget extends StatelessWidget {
  final List<Webhook> items;
  final void Function(Webhook)? onTap;
  final void Function(Webhook)? onEdit;
  final void Function(Webhook)? onDelete;
  const WebhookListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
