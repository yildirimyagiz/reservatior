...
// ── EscrowDispute Detail Widget  |  20 fields

class EscrowDisputeDetailWidget extends StatelessWidget {
  final EscrowDispute item;
  const EscrowDisputeDetailWidget({super.key, required this.item});
