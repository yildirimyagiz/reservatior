...
// ── FinancialRecord Detail Widget  |  23 fields

class FinancialRecordDetailWidget extends StatelessWidget {
  final FinancialRecord item;
  const FinancialRecordDetailWidget({super.key, required this.item});
