...
// ── PropertyDocument List Widget

class PropertyDocumentListWidget extends StatelessWidget {
  final List<PropertyDocument> items;
  final void Function(PropertyDocument)? onTap;
  final void Function(PropertyDocument)? onEdit;
  final void Function(PropertyDocument)? onDelete;
  const PropertyDocumentListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
