...
// ── NegotiationOffer List Widget

class NegotiationOfferListWidget extends StatelessWidget {
  final List<NegotiationOffer> items;
  final void Function(NegotiationOffer)? onTap;
  final void Function(NegotiationOffer)? onEdit;
  final void Function(NegotiationOffer)? onDelete;
  const NegotiationOfferListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
