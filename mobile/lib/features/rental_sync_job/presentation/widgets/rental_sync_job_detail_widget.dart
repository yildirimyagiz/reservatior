...
// ── RentalSyncJob Detail Widget  |  14 fields

class RentalSyncJobDetailWidget extends StatelessWidget {
  final RentalSyncJob item;
  const RentalSyncJobDetailWidget({super.key, required this.item});
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      if (item.status != null)
        ...
        _row('Job Type', item.jobType?.toString() ?? 'N/A', Icons.text_fields),
        _row('Direction', item.direction?.toString() ?? 'N/A', Icons.text_fields),
