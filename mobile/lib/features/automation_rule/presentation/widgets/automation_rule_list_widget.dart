...
// ── AutomationRule List Widget

class AutomationRuleListWidget extends StatelessWidget {
  final List<AutomationRule> items;
  final void Function(AutomationRule)? onTap;
  final void Function(AutomationRule)? onEdit;
  final void Function(AutomationRule)? onDelete;
  const AutomationRuleListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
