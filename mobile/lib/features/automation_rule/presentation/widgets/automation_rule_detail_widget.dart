...
// ── AutomationRule Detail Widget  |  14 fields

class AutomationRuleDetailWidget extends StatelessWidget {
  final AutomationRule item;
  const AutomationRuleDetailWidget({super.key, required this.item});
