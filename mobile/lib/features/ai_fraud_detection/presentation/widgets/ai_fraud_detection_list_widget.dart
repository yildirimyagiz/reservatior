...
// ── AIFraudDetection List Widget

class AIFraudDetectionListWidget extends StatelessWidget {
  final List<AIFraudDetection> items;
  final void Function(AIFraudDetection)? onTap;
  final void Function(AIFraudDetection)? onEdit;
  final void Function(AIFraudDetection)? onDelete;
  const AIFraudDetectionListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
