...
// ── AIPropertyDescription List Widget

class AIPropertyDescriptionListWidget extends StatelessWidget {
  final List<AIPropertyDescription> items;
  final void Function(AIPropertyDescription)? onTap;
  final void Function(AIPropertyDescription)? onEdit;
  final void Function(AIPropertyDescription)? onDelete;
  const AIPropertyDescriptionListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
