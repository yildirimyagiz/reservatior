...
// ── VacationRental Client Page

class VacationRentalClientPage extends ConsumerStatefulWidget {
  const VacationRentalClientPage({super.key});
  @override ConsumerState<VacationRentalClientPage> createState() => _VacationRentalClientPageState();
}

class _VacationRentalClientPageState extends ConsumerState<VacationRentalClientPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('My Vacation Rentals'),
        backgroundColor: Colors.teal[700], foregroundColor: Colors.white,
        actions: [
          IconButton(icon: const Icon(Icons.refresh), onPressed: () => ref.invalidate(vacationRentalListProvider)),
        ],
      ),
          ...
          data: (items) {
            ...
            if (list.isEmpty) {
              return Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                ...
                Text('No Vacation Rentals', style: TextStyle(color: Colors.grey[500])),
              ]));
            }
            return RefreshIndicator(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (ctx, i) {
                  final item = list[i];
                  final _title = item.rentalType?.toString() ?? 'Unknown';
                  return Card(
      ...
      floatingActionButton: FloatingActionButton.extended(
        heroTag: 'VacationRentalClientFAB',
      ...
      builder: (ctx) => DraggableScrollableSheet(
        ...
        builder: (ctx2, sc) => Column(children: [
          ...
          Padding(padding: const EdgeInsets.symmetric(horizontal: 16),
            child: Row(children: [
              const Text('Vacation Rental Details', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
              const Spacer(),
  ...
  void _showForm(BuildContext context, {VacationRental? item}) {
    showModalBottomSheet(
      context: context, isScrollControlled: true,
      shape: const RoundedRectangleBorder(borderRadius: BorderRadius.vertical(top: Radius.circular(20))),
      builder: (ctx) => Padding(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          Padding(padding: const EdgeInsets.symmetric(horizontal: 16),
            child: Align(alignment: Alignment.centerLeft,
              child: Text(item != null ? 'Edit Vacation Rental' : 'New Vacation Rental',
