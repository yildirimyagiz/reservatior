...
// ── InvestorProperty List Widget

class InvestorPropertyListWidget extends StatelessWidget {
  final List<InvestorProperty> items;
  final void Function(InvestorProperty)? onTap;
  final void Function(InvestorProperty)? onEdit;
  final void Function(InvestorProperty)? onDelete;
  const InvestorPropertyListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
