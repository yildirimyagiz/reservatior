...
// ── HomeInformationPack List Widget

class HomeInformationPackListWidget extends StatelessWidget {
  final List<HomeInformationPack> items;
  final void Function(HomeInformationPack)? onTap;
  final void Function(HomeInformationPack)? onEdit;
  final void Function(HomeInformationPack)? onDelete;
  const HomeInformationPackListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
