...
// ── AIValuationModel Detail Widget  |  12 fields

class AIValuationModelDetailWidget extends StatelessWidget {
  final AIValuationModel item;
  const AIValuationModelDetailWidget({super.key, required this.item});
