...
// ── PropertyAmenity List Widget

class PropertyAmenityListWidget extends StatelessWidget {
  final List<PropertyAmenity> items;
  final void Function(PropertyAmenity)? onTap;
  final void Function(PropertyAmenity)? onEdit;
  final void Function(PropertyAmenity)? onDelete;
  const PropertyAmenityListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
