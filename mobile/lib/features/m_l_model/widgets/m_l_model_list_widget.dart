...
class MLModelListWidget extends StatelessWidget {
  final List<MLModel> items;
  final void Function(MLModel)? onTap;
  final void Function(MLModel)? onEdit;
  final void Function(MLModel)? onDelete;
  const MLModelListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
