...
class PermissionListWidget extends StatelessWidget {
  ...
  final void Function(Permission)? onEdit;
  final void Function(Permission)? onDelete;
  const PermissionListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
