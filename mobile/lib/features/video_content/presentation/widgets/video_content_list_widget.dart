...
// ── VideoContent List Widget

class VideoContentListWidget extends StatelessWidget {
  final List<VideoContent> items;
  final void Function(VideoContent)? onTap;
  final void Function(VideoContent)? onEdit;
  final void Function(VideoContent)? onDelete;
  const VideoContentListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
