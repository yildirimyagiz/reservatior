...
// ── GiftCard List Widget

class GiftCardListWidget extends StatelessWidget {
  final List<GiftCard> items;
  final void Function(GiftCard)? onTap;
  final void Function(GiftCard)? onEdit;
  final void Function(GiftCard)? onDelete;
  const GiftCardListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
