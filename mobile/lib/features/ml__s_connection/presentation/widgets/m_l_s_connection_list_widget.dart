...
// ── MLSConnection List Widget

class MLSConnectionListWidget extends StatelessWidget {
  final List<MLSConnection> items;
  final void Function(MLSConnection)? onTap;
  final void Function(MLSConnection)? onEdit;
  final void Function(MLSConnection)? onDelete;
  const MLSConnectionListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
