...
class AchievementListWidget extends StatelessWidget {
  ...
  final void Function(Achievement)? onEdit;
  final void Function(Achievement)? onDelete;
  const AchievementListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
