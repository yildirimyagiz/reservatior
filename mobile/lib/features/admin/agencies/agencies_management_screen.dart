...
import 'package:reservatior/shared/providers/agency_provider.dart';

class AgenciesManagementScreen extends ConsumerWidget {
  const AgenciesManagementScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final items = ref.watch(agencyListProvider);
