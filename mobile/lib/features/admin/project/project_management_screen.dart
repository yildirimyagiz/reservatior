...
import 'package:reservatior/core/providers/admin/project_provider.dart';
            ...
            data: (projects) {
              if (projects.isEmpty) {
                return  SliverFillRemaining(
                  child: Center(
                    child: Text('admin.common.no_projects'.tr(),
                    ...
                    return Container(
                          ...
                          child: ListTile(
                            ...
                            subtitle: Column(
                              ...
                              children: [
                                 SizedBox(height: 4),
                                Text('admin.common.type_prefix'.tr() + project.projectType,
