...
// ── CommunicationTemplate List Widget

class CommunicationTemplateListWidget extends StatelessWidget {
  final List<CommunicationTemplate> items;
  final void Function(CommunicationTemplate)? onTap;
  final void Function(CommunicationTemplate)? onEdit;
  final void Function(CommunicationTemplate)? onDelete;
  const CommunicationTemplateListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
