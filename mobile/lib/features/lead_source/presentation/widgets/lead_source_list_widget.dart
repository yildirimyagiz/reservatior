...
// ── LeadSource List Widget

class LeadSourceListWidget extends StatelessWidget {
  final List<LeadSource> items;
  final void Function(LeadSource)? onTap;
  final void Function(LeadSource)? onEdit;
  final void Function(LeadSource)? onDelete;
  const LeadSourceListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
