...
// ── EscrowStatusHistory Detail Widget  |  9 fields

class EscrowStatusHistoryDetailWidget extends StatelessWidget {
  final EscrowStatusHistory item;
  const EscrowStatusHistoryDetailWidget({super.key, required this.item});
      ...
      if (item.fromStatus != null)
        Padding(
          ...
          child: Chip(
            ...
            label: Text(item.fromStatus!.toString(), style: const TextStyle(fontWeight: FontWeight.w600)),
            backgroundColor: _stColor(item.fromStatus).withOpacity(0.15),
          ),
        ),
