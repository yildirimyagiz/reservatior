...
// ── SolicitorManagement Client Page

class SolicitorManagementClientPage extends ConsumerStatefulWidget {
  const SolicitorManagementClientPage({super.key});
  @override ConsumerState<SolicitorManagementClientPage> createState() => _SolicitorManagementClientPageState();
}

class _SolicitorManagementClientPageState extends ConsumerState<SolicitorManagementClientPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('My Solicitor Managements'),
        backgroundColor: Colors.teal[700], foregroundColor: Colors.white,
        actions: [
          IconButton(icon: const Icon(Icons.refresh), onPressed: () => ref.invalidate(solicitorManagementListProvider)),
        ],
      ),
          ...
          data: (items) {
            ...
            if (list.isEmpty) {
              return Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                ...
                Text('No Solicitor Managements', style: TextStyle(color: Colors.grey[500])),
              ]));
            }
            return RefreshIndicator(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (ctx, i) {
                  final item = list[i];
                  final _title = item.solicitorType?.toString() ?? 'Unknown';
                  return Card(
      ...
      floatingActionButton: FloatingActionButton.extended(
        heroTag: 'SolicitorManagementClientFAB',
      ...
      builder: (ctx) => DraggableScrollableSheet(
        ...
        builder: (ctx2, sc) => Column(children: [
          ...
          Padding(padding: const EdgeInsets.symmetric(horizontal: 16),
            child: Row(children: [
              const Text('Solicitor Management Details', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
              const Spacer(),
  ...
  void _showForm(BuildContext context, {SolicitorManagement? item}) {
    showModalBottomSheet(
      context: context, isScrollControlled: true,
      shape: const RoundedRectangleBorder(borderRadius: BorderRadius.vertical(top: Radius.circular(20))),
      builder: (ctx) => Padding(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          Padding(padding: const EdgeInsets.symmetric(horizontal: 16),
            child: Align(alignment: Alignment.centerLeft,
              child: Text(item != null ? 'Edit Solicitor Management' : 'New Solicitor Management',
