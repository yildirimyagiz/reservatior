...
class ChannelListWidget extends StatelessWidget {
  ...
  final void Function(Channel)? onEdit;
  final void Function(Channel)? onDelete;
  const ChannelListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
