...
// ── MortgagePreApproval List Widget

class MortgagePreApprovalListWidget extends StatelessWidget {
  final List<MortgagePreApproval> items;
  final void Function(MortgagePreApproval)? onTap;
  final void Function(MortgagePreApproval)? onEdit;
  final void Function(MortgagePreApproval)? onDelete;
  const MortgagePreApprovalListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
