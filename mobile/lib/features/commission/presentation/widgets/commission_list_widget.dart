...
// ── Commission List Widget

class CommissionListWidget extends StatelessWidget {
  final List<Commission> items;
  final void Function(Commission)? onTap;
  final void Function(Commission)? onEdit;
  final void Function(Commission)? onDelete;
  const CommissionListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
