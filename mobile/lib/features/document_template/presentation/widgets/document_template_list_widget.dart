...
// ── DocumentTemplate List Widget

class DocumentTemplateListWidget extends StatelessWidget {
  final List<DocumentTemplate> items;
  final void Function(DocumentTemplate)? onTap;
  final void Function(DocumentTemplate)? onEdit;
  final void Function(DocumentTemplate)? onDelete;
  const DocumentTemplateListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
