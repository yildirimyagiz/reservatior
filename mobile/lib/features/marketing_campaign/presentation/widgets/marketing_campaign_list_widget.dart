...
// ── MarketingCampaign List Widget

class MarketingCampaignListWidget extends StatelessWidget {
  final List<MarketingCampaign> items;
  final void Function(MarketingCampaign)? onTap;
  final void Function(MarketingCampaign)? onEdit;
  final void Function(MarketingCampaign)? onDelete;
  const MarketingCampaignListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
