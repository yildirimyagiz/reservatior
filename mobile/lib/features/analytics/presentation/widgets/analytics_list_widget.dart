...
class AnalyticsListWidget extends StatelessWidget {
  final List<Analytics> items;
  final void Function(Analytics)? onTap;
  final void Function(Analytics)? onEdit;
  final void Function(Analytics)? onDelete;
  const AnalyticsListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
      ...
      itemBuilder: (ctx, i) {
        ...
        return Card(
          ...
          child: ListTile(
            ...
            subtitle: Text('Entity Id: ${item.entityId?.toString() ?? "N/A"}'),
