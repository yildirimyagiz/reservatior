...
// ── ReferenceSource List Widget

class ReferenceSourceListWidget extends StatelessWidget {
  final List<ReferenceSource> items;
  final void Function(ReferenceSource)? onTap;
  final void Function(ReferenceSource)? onEdit;
  final void Function(ReferenceSource)? onDelete;
  const ReferenceSourceListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
