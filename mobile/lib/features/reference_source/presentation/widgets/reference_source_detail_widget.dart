...
// ── ReferenceSource Detail Widget  |  11 fields

class ReferenceSourceDetailWidget extends StatelessWidget {
  final ReferenceSource item;
  const ReferenceSourceDetailWidget({super.key, required this.item});
