...
// ── ProjectReport List Widget

class ProjectReportListWidget extends StatelessWidget {
  final List<ProjectReport> items;
  final void Function(ProjectReport)? onTap;
  final void Function(ProjectReport)? onEdit;
  final void Function(ProjectReport)? onDelete;
  const ProjectReportListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
