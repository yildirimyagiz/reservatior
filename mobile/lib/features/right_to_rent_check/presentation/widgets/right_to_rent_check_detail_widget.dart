...
// ── RightToRentCheck Detail Widget  |  13 fields

class RightToRentCheckDetailWidget extends StatelessWidget {
  final RightToRentCheck item;
  const RightToRentCheckDetailWidget({super.key, required this.item});
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      if (item.status != null)
        ...
        _row('Check Type', item.checkType?.toString() ?? 'N/A', Icons.text_fields),
