...
// ── LedgerEntry List Widget

class LedgerEntryListWidget extends StatelessWidget {
  final List<LedgerEntry> items;
  final void Function(LedgerEntry)? onTap;
  final void Function(LedgerEntry)? onEdit;
  final void Function(LedgerEntry)? onDelete;
  const LedgerEntryListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
