...
class EventClientPage extends ConsumerStatefulWidget {
  const EventClientPage({super.key});
  @override ConsumerState<EventClientPage> createState() => _EventClientPageState();
}

class _EventClientPageState extends ConsumerState<EventClientPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(icon: const Icon(Icons.refresh), onPressed: () => ref.invalidate(eventListProvider)),
        ],
      ),
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          const Padding(padding: EdgeInsets.symmetric(horizontal: 16),
            child: Align(alignment: Alignment.centerLeft,
              child: Text('New Event', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)))),
          const Divider(),
          ConstrainedBox(
            ...
            child: SingleChildScrollView(
              ...
              child: EventFormWidget(
                onSubmit: (newItem) {
                  ref.read(eventCreateStateProvider.notifier).state = newItem;
                  Navigator.pop(ctx);
                },
              ),
            ),
