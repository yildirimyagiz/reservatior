...
class ApiKeyListWidget extends StatelessWidget {
  ...
  final void Function(ApiKey)? onTap;
  final void Function(ApiKey)? onEdit;
  final void Function(ApiKey)? onDelete;
  const ApiKeyListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
