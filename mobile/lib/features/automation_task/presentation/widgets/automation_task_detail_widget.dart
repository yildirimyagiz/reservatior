...
// ── AutomationTask Detail Widget  |  13 fields

class AutomationTaskDetailWidget extends StatelessWidget {
  final AutomationTask item;
  const AutomationTaskDetailWidget({super.key, required this.item});
