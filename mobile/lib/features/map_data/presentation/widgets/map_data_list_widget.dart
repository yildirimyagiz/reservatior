...
class MapDataListWidget extends StatelessWidget {
  final List<MapData> items;
  final void Function(MapData)? onTap;
  final void Function(MapData)? onEdit;
  final void Function(MapData)? onDelete;
  const MapDataListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
