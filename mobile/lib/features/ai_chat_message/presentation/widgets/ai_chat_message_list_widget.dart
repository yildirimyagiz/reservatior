...
// ── AIChatMessage List Widget

class AIChatMessageListWidget extends StatelessWidget {
  final List<AIChatMessage> items;
  final void Function(AIChatMessage)? onTap;
  final void Function(AIChatMessage)? onEdit;
  final void Function(AIChatMessage)? onDelete;
  const AIChatMessageListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
