...
// ── AIMarketAnalysis List Widget

class AIMarketAnalysisListWidget extends StatelessWidget {
  final List<AIMarketAnalysis> items;
  final void Function(AIMarketAnalysis)? onTap;
  final void Function(AIMarketAnalysis)? onEdit;
  final void Function(AIMarketAnalysis)? onDelete;
  const AIMarketAnalysisListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
