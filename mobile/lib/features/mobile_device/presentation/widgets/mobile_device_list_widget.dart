...
// ── MobileDevice List Widget

class MobileDeviceListWidget extends StatelessWidget {
  final List<MobileDevice> items;
  final void Function(MobileDevice)? onTap;
  final void Function(MobileDevice)? onEdit;
  final void Function(MobileDevice)? onDelete;
  const MobileDeviceListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
