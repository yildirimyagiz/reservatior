...
// ── AuditLog List Widget

class AuditLogListWidget extends StatelessWidget {
  final List<AuditLog> items;
  final void Function(AuditLog)? onTap;
  final void Function(AuditLog)? onEdit;
  final void Function(AuditLog)? onDelete;
  const AuditLogListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
