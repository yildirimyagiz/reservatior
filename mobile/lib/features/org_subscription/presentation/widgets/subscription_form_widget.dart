...
// Fields: userId, name, type, price, currency, billingCycle, maxProperties, maxListings, featuredListings, prioritySupport, apiAccess, commissionDiscount, loyaltyMultiplier, isActive, userSubscriptions
...
class _SubscriptionFormWidgetState extends State<SubscriptionFormWidget> {
  ...
  void _submit() {
    ...
    final data = <String, dynamic>{
        ...
        'isActive': _isActive,
        if (_userSubscriptions != null) 'userSubscriptions': _userSubscriptions,
    };
