...
class EarningListWidget extends StatelessWidget {
  ...
  final void Function(Earning)? onTap;
  final void Function(Earning)? onEdit;
  final void Function(Earning)? onDelete;
  const EarningListWidget({super.key, required this.items, this.onTap, this.onEdit, this.onDelete});
