...
/// Repository for HomeInformationPack operations
/// Provides CRUD operations with proper error handling and type safety
class HomeInformationPackRepository {
  final DioClient _dioClient;

  HomeInformationPackRepository(this._dioClient);

  /// Get HomeInformationPack by ID
  /// Returns [HomeInformationPack] if found, throws [RepositoryException] otherwise
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        throw RepositoryException(
          message: 'Failed to fetch home_information_pack',
  ...
  /// Get all home_information_packs with pagination and filtering
  /// Returns list of [HomeInformationPack] objects
  Future<List<HomeInformationPack>> gethome_information_packs({
    int page = 1,
    int limit = 20,
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return data.map((item) => HomeInformationPack.fromJson(item)).toList();
      } else {
        throw RepositoryException(
          message: 'Failed to fetch home_information_packs',
          code: response.statusCode.toString(),
  ...
  /// Create new HomeInformationPack
  /// Returns created [HomeInformationPack] object
