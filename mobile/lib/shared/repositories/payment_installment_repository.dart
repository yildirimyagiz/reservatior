...
/// Repository for PaymentInstallment operations
/// Provides CRUD operations with proper error handling and type safety
class PaymentInstallmentRepository {
  final DioClient _dioClient;

  PaymentInstallmentRepository(this._dioClient);

  /// Get PaymentInstallment by ID
  /// Returns [PaymentInstallment] if found, throws [RepositoryException] otherwise
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        throw RepositoryException(
          message: 'Failed to fetch payment_installment',
  ...
  /// Get all payment_installments with pagination and filtering
  /// Returns list of [PaymentInstallment] objects
  Future<List<PaymentInstallment>> getpayment_installments({
    int page = 1,
    int limit = 20,
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return data.map((item) => PaymentInstallment.fromJson(item)).toList();
      } else {
        throw RepositoryException(
          message: 'Failed to fetch payment_installments',
          code: response.statusCode.toString(),
  ...
  /// Create new PaymentInstallment
  /// Returns created [PaymentInstallment] object
