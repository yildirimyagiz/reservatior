...
class AiValuationModel {
  ...
  final List<AiPropertyValuation>? valuations;
  final Organization? org;

  const AiValuationModel({
    required this.id,
    this.orgId,
  ...
  factory AiValuationModel.fromJson(Map<String, dynamic> json) {
    return AiValuationModel(
      ...
      valuations: (json['valuations'] as List<dynamic>?)?.map((e) => AiPropertyValuation.fromJson(e as Map<String, dynamic>)).toList(),
