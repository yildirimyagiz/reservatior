...
class AiLeadScoringFormWidget extends ConsumerStatefulWidget {
  final AiLeadScoring? item;
  final Function(AiLeadScoring) onSubmit;
  const AiLeadScoringFormWidget({super.key, this.item, required this.onSubmit});
  @override
  ConsumerState<AiLeadScoringFormWidget> createState() =>
      _AiLeadScoringFormWidgetState();
}

class _AiLeadScoringFormWidgetState
    extends ConsumerState<AiLeadScoringFormWidget> {
  String? _modelName;
    ...
    return Container(
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            Text(
              widget.item == null ? "${'mobile.auto.new'.tr()} ${'mobile.modules.aileadscoring'.tr()}" : "${'mobile.auto.edit'.tr()} ${'mobile.modules.aileadscoring'.tr()}",
            ...
            ElevatedButton(
              onPressed: () {
                ...
                try {
                  ...
                  widget.onSubmit(AiLeadScoring.fromJson(json));
                } catch (e) {
