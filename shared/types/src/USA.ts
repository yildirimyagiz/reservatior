// Otomatik üretilmiş Valibot schema'ları (USA)
// Generated: 2026-07-06T02:23:48.460Z
...
// OrganizationMember Schemas (USA)
...
export const propertyUpdateSchema = v.partial(v.object({
  ...
  strEstimatedRevenue: v.optional(v.number()),
  strOccupancyRate: v.optional(v.number()),
  strReviewScore: v.optional(v.number()),
  strReviewCount: v.optional(v.number()),
  arbitrageOpportunity: v.optional(v.boolean()),
  managementOpportunity: v.optional(v.boolean())
}));
...
// ListingStatusHistory Schemas (USA)
...
// GovernmentIntegration Schemas (USA)
...
// HomeInformationPack Schemas (USA)
...
// SolicitorManagement Schemas (USA)
...
// ExternalRentalListing Schemas (USA)
...
// VacationRentalPlatform Schemas (USA)
...
// MlsListingEnhancement Schemas (USA)
...
// ClientRelationship Schemas (USA)
...
// MaintenanceWorkOrder Schemas (USA)
...
// UserFinancialProfile Schemas (USA)
...
// MLSExternalListing Schemas (USA)
...
// PropertyCompliance Schemas (USA)
...
// RecommendationResult Schemas (USA)
...
// CommunicationTemplate Schemas (USA)
...
// SecurityDepositProtection Schemas (USA)
...
// PropertyDisclosure Schemas (USA)
...
// ImmigrationStatusCheck Schemas (USA)
...
// AttorneyManagement Schemas (USA)
...
// MortgagePreApproval Schemas (USA)
...
// QueueConfiguration Schemas (USA)
...
// AutomationExecution Schemas (USA)
...
// AIPropertyValuation Schemas (USA)
...
// AIPropertyDescription Schemas (USA)
...
// AIPriceOptimization Schemas (USA)
...
// AISentimentAnalysis Schemas (USA)
...
// AIPredictiveMaintenance Schemas (USA)
...
// AIInvestmentAnalysis Schemas (USA)
...
// DashboardConfiguration Schemas (USA)
...
// PaymentNegotiation Schemas (USA)
...
// PaymentInstallment Schemas (USA)
...
// AmbassadorContract Schemas (USA)
...
// AmbassadorCampaign Schemas (USA)
...
// SocialImpactCounter Schemas (USA)
...
// SocialImpactRecord Schemas (USA)
...
// SocialInboundMessage Schemas (USA)
...
// SocialCommentReply Schemas (USA)
...
// SocialAutomationRule Schemas (USA)
...
// SocialAccountMetric Schemas (USA)
...
// EscrowStatusHistory Schemas (USA)
...
// PropertyOwnershipVerification Schemas (USA)
...
// OwnershipVerificationDocument Schemas (USA)
...
// PropertyOwnershipTransfer Schemas (USA)
...
// BookingSecurityScreening Schemas (USA)
...
// VideoVendorPartnership Schemas (USA)
...
// PartnershipEarning Schemas (USA)
...
// VideoQualityReview Schemas (USA)
...
// VendorQualityReview Schemas (USA)
...
// UserValuationPreference Schemas (USA)
...
// GlobalTaxRegulation Schemas (USA)
...
// MarketRateComparison Schemas (USA)
...
// PlatformRevenueRecord Schemas (USA)
...
// AiBrochureGeneration Schemas (USA)
...
// CategoryTranslation Schemas (USA)
...
// USPropertyAssessment Schemas (USA)
...
// UKPropertyCertificateRecord Schemas (USA)
...
// TRPropertyDocumentRecord Schemas (USA)
...
// TenantVerificationStage Schemas (USA)
...
// TenantReliabilityScore Schemas (USA)
...
// PropertySecurityConfig Schemas (USA)
...
// ContractTransition Schemas (USA)
...
// ListingDistribution Schemas (USA)
...
// ReputationDecayLog Schemas (USA)
...
// DemandGenerationLog Schemas (USA)
...
// AgentEscrowTransaction Schemas (USA)
...
// HotelProviderMapping Schemas (USA)
...
// PropertyTrustScore Schemas (USA)
...
// BookingFailoverEvent Schemas (USA)
...
// AIKnowledgeArticle Schemas (USA)
...
// UserRevenueProfile Schemas (USA)
