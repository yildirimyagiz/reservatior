// Otomatik üretilmiş Valibot schema'ları (NZ)
// Generated: 2026-07-07T07:57:03.522Z
...
// ListingStatusHistory Schemas (NZ)
...
// GovernmentIntegration Schemas (NZ)
...
// HomeInformationPack Schemas (NZ)
...
// SolicitorManagement Schemas (NZ)
...
// ExternalRentalListing Schemas (NZ)
...
// VacationRentalPlatform Schemas (NZ)
...
// MlsListingEnhancement Schemas (NZ)
...
// MaintenanceWorkOrder Schemas (NZ)
...
// UserFinancialProfile Schemas (NZ)
...
// RecommendationResult Schemas (NZ)
...
// CommunicationTemplate Schemas (NZ)
...
// SecurityDepositProtection Schemas (NZ)
...
// ImmigrationStatusCheck Schemas (NZ)
...
// MortgagePreApproval Schemas (NZ)
...
// AutomationExecution Schemas (NZ)
...
// AIPropertyValuation Schemas (NZ)
...
// AIPropertyDescription Schemas (NZ)
...
// AIPriceOptimization Schemas (NZ)
...
// AISentimentAnalysis Schemas (NZ)
...
// AIPredictiveMaintenance Schemas (NZ)
...
// AIInvestmentAnalysis Schemas (NZ)
...
// DashboardConfiguration Schemas (NZ)
...
// SocialImpactCounter Schemas (NZ)
...
// SocialInboundMessage Schemas (NZ)
...
// SocialAutomationRule Schemas (NZ)
...
// SocialAccountMetric Schemas (NZ)
...
// EscrowStatusHistory Schemas (NZ)
...
// PropertyOwnershipVerification Schemas (NZ)
...
// OwnershipVerificationDocument Schemas (NZ)
...
// PropertyOwnershipTransfer Schemas (NZ)
...
// BookingSecurityScreening Schemas (NZ)
...
// VideoVendorPartnership Schemas (NZ)
...
// VendorQualityReview Schemas (NZ)
...
// UserValuationPreference Schemas (NZ)
...
// GlobalTaxRegulation Schemas (NZ)
...
// MarketRateComparison Schemas (NZ)
...
// PlatformRevenueRecord Schemas (NZ)
...
// AiBrochureGeneration Schemas (NZ)
...
// CategoryTranslation Schemas (NZ)
...
// USPropertyAssessment Schemas (NZ)
...
// UKPropertyCertificateRecord Schemas (NZ)
...
// TRPropertyDocumentRecord Schemas (NZ)
...
// TenantVerificationStage Schemas (NZ)
...
// TenantReliabilityScore Schemas (NZ)
...
// PropertySecurityConfig Schemas (NZ)
...
// ListingDistribution Schemas (NZ)
...
// DemandGenerationLog Schemas (NZ)
...
// AgentEscrowTransaction Schemas (NZ)
...
// HotelProviderMapping Schemas (NZ)
...
// BookingFailoverEvent Schemas (NZ)
