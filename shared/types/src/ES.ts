// Otomatik üretilmiş Valibot schema'ları (ES)
// Generated: 2026-07-07T07:57:03.621Z
...
// ListingStatusHistory Schemas (ES)
...
// GovernmentIntegration Schemas (ES)
...
// HomeInformationPack Schemas (ES)
...
// SolicitorManagement Schemas (ES)
...
// ExternalRentalListing Schemas (ES)
...
// VacationRentalPlatform Schemas (ES)
...
// MlsListingEnhancement Schemas (ES)
...
// MaintenanceWorkOrder Schemas (ES)
...
// UserFinancialProfile Schemas (ES)
...
export const orgSubscriptionUpdateSchema = v.partial(v.object({
  ...
  obMandateId: v.optional(v.string())
}));
...
// RecommendationResult Schemas (ES)
...
// CommunicationTemplate Schemas (ES)
...
// SecurityDepositProtection Schemas (ES)
...
// ImmigrationStatusCheck Schemas (ES)
...
// MortgagePreApproval Schemas (ES)
...
// AutomationExecution Schemas (ES)
...
// AIPropertyValuation Schemas (ES)
...
// AIPropertyDescription Schemas (ES)
...
// AIPriceOptimization Schemas (ES)
...
// AISentimentAnalysis Schemas (ES)
...
// AIPredictiveMaintenance Schemas (ES)
...
// AIInvestmentAnalysis Schemas (ES)
...
// DashboardConfiguration Schemas (ES)
...
// SocialImpactCounter Schemas (ES)
...
// SocialInboundMessage Schemas (ES)
...
// SocialAutomationRule Schemas (ES)
...
// SocialAccountMetric Schemas (ES)
...
// EscrowStatusHistory Schemas (ES)
...
// PropertyOwnershipVerification Schemas (ES)
...
// OwnershipVerificationDocument Schemas (ES)
...
// PropertyOwnershipTransfer Schemas (ES)
...
// BookingSecurityScreening Schemas (ES)
...
// VideoVendorPartnership Schemas (ES)
...
// VendorQualityReview Schemas (ES)
...
// UserValuationPreference Schemas (ES)
...
// GlobalTaxRegulation Schemas (ES)
...
// MarketRateComparison Schemas (ES)
...
// PlatformRevenueRecord Schemas (ES)
...
// AiBrochureGeneration Schemas (ES)
...
// CategoryTranslation Schemas (ES)
...
// USPropertyAssessment Schemas (ES)
...
// UKPropertyCertificateRecord Schemas (ES)
...
// TRPropertyDocumentRecord Schemas (ES)
...
// TenantVerificationStage Schemas (ES)
...
// TenantReliabilityScore Schemas (ES)
...
// PropertySecurityConfig Schemas (ES)
...
// ListingDistribution Schemas (ES)
...
// DemandGenerationLog Schemas (ES)
...
// AgentEscrowTransaction Schemas (ES)
...
// HotelProviderMapping Schemas (ES)
...
// BookingFailoverEvent Schemas (ES)
