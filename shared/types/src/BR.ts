// Otomatik üretilmiş Valibot schema'ları (BR)
// Generated: 2026-07-06T02:23:48.531Z
...
// ListingStatusHistory Schemas (BR)
...
// GovernmentIntegration Schemas (BR)
...
// HomeInformationPack Schemas (BR)
...
// SolicitorManagement Schemas (BR)
...
// ExternalRentalListing Schemas (BR)
...
// VacationRentalPlatform Schemas (BR)
...
// MlsListingEnhancement Schemas (BR)
...
// MaintenanceWorkOrder Schemas (BR)
...
// UserFinancialProfile Schemas (BR)
...
// RecommendationResult Schemas (BR)
...
// CommunicationTemplate Schemas (BR)
...
// SecurityDepositProtection Schemas (BR)
...
// ImmigrationStatusCheck Schemas (BR)
...
// MortgagePreApproval Schemas (BR)
...
// AutomationExecution Schemas (BR)
...
// AIPropertyValuation Schemas (BR)
...
// AIPropertyDescription Schemas (BR)
...
// AIPriceOptimization Schemas (BR)
...
// AISentimentAnalysis Schemas (BR)
...
// AIPredictiveMaintenance Schemas (BR)
...
// AIInvestmentAnalysis Schemas (BR)
...
// DashboardConfiguration Schemas (BR)
...
// SocialImpactCounter Schemas (BR)
...
// SocialInboundMessage Schemas (BR)
...
// SocialAutomationRule Schemas (BR)
...
// SocialAccountMetric Schemas (BR)
...
// EscrowStatusHistory Schemas (BR)
...
// PropertyOwnershipVerification Schemas (BR)
...
// OwnershipVerificationDocument Schemas (BR)
...
// PropertyOwnershipTransfer Schemas (BR)
...
// BookingSecurityScreening Schemas (BR)
...
// VideoVendorPartnership Schemas (BR)
...
// VendorQualityReview Schemas (BR)
...
// UserValuationPreference Schemas (BR)
...
// GlobalTaxRegulation Schemas (BR)
...
// MarketRateComparison Schemas (BR)
...
// PlatformRevenueRecord Schemas (BR)
...
// AiBrochureGeneration Schemas (BR)
...
// CategoryTranslation Schemas (BR)
...
// USPropertyAssessment Schemas (BR)
...
// UKPropertyCertificateRecord Schemas (BR)
...
// TRPropertyDocumentRecord Schemas (BR)
...
// TenantVerificationStage Schemas (BR)
...
// TenantReliabilityScore Schemas (BR)
...
// PropertySecurityConfig Schemas (BR)
...
// ListingDistribution Schemas (BR)
...
// DemandGenerationLog Schemas (BR)
...
// AgentEscrowTransaction Schemas (BR)
...
// HotelProviderMapping Schemas (BR)
...
// BookingFailoverEvent Schemas (BR)
