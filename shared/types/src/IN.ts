// Otomatik üretilmiş Valibot schema'ları (IN)
// Generated: 2026-07-07T07:57:03.719Z
...
// ListingStatusHistory Schemas (IN)
...
// GovernmentIntegration Schemas (IN)
...
// HomeInformationPack Schemas (IN)
...
// SolicitorManagement Schemas (IN)
...
// ExternalRentalListing Schemas (IN)
...
// VacationRentalPlatform Schemas (IN)
...
// MlsListingEnhancement Schemas (IN)
...
// MaintenanceWorkOrder Schemas (IN)
...
// UserFinancialProfile Schemas (IN)
...
// RecommendationResult Schemas (IN)
...
// CommunicationTemplate Schemas (IN)
...
// SecurityDepositProtection Schemas (IN)
...
// ImmigrationStatusCheck Schemas (IN)
...
// MortgagePreApproval Schemas (IN)
...
// AutomationExecution Schemas (IN)
...
// AIPropertyValuation Schemas (IN)
...
// AIPropertyDescription Schemas (IN)
...
// AIPriceOptimization Schemas (IN)
...
// AISentimentAnalysis Schemas (IN)
...
// AIPredictiveMaintenance Schemas (IN)
...
// AIInvestmentAnalysis Schemas (IN)
...
// DashboardConfiguration Schemas (IN)
...
// SocialImpactCounter Schemas (IN)
...
// SocialInboundMessage Schemas (IN)
...
// SocialAutomationRule Schemas (IN)
...
// SocialAccountMetric Schemas (IN)
...
// EscrowStatusHistory Schemas (IN)
...
// PropertyOwnershipVerification Schemas (IN)
...
// OwnershipVerificationDocument Schemas (IN)
...
// PropertyOwnershipTransfer Schemas (IN)
...
// BookingSecurityScreening Schemas (IN)
...
// VideoVendorPartnership Schemas (IN)
...
// VendorQualityReview Schemas (IN)
...
// UserValuationPreference Schemas (IN)
...
// GlobalTaxRegulation Schemas (IN)
...
// MarketRateComparison Schemas (IN)
...
// PlatformRevenueRecord Schemas (IN)
...
// AiBrochureGeneration Schemas (IN)
...
// CategoryTranslation Schemas (IN)
...
// USPropertyAssessment Schemas (IN)
...
// UKPropertyCertificateRecord Schemas (IN)
...
// TRPropertyDocumentRecord Schemas (IN)
...
// TenantVerificationStage Schemas (IN)
...
// TenantReliabilityScore Schemas (IN)
...
// PropertySecurityConfig Schemas (IN)
...
// ListingDistribution Schemas (IN)
...
// DemandGenerationLog Schemas (IN)
...
// AgentEscrowTransaction Schemas (IN)
...
// HotelProviderMapping Schemas (IN)
...
// BookingFailoverEvent Schemas (IN)
