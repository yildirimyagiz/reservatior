// Otomatik üretilmiş Valibot schema'ları (TEMP)
// Generated: 2026-07-07T07:57:03.835Z
...
// OrganizationMember Schemas (TEMP)
...
// ListingStatusHistory Schemas (TEMP)
...
// GovernmentIntegration Schemas (TEMP)
...
// HomeInformationPack Schemas (TEMP)
...
// DepositProtection Schemas (TEMP)
...
// SolicitorManagement Schemas (TEMP)
...
// ExternalRentalListing Schemas (TEMP)
...
// VacationRentalPlatform Schemas (TEMP)
...
// MlsListingEnhancement Schemas (TEMP)
...
// InvestorPortfolio Schemas (TEMP)
...
// PropertyValuation Schemas (TEMP)
...
// ClientRelationship Schemas (TEMP)
...
// TenantApplication Schemas (TEMP)
...
// MaintenanceWorkOrder Schemas (TEMP)
...
// UserFinancialProfile Schemas (TEMP)
...
// MarketingCampaign Schemas (TEMP)
...
// MLSExternalListing Schemas (TEMP)
...
// PropertyCompliance Schemas (TEMP)
...
// RecommendationResult Schemas (TEMP)
...
// CommunicationTemplate Schemas (TEMP)
...
// PropertyInventory Schemas (TEMP)
...
// SecurityDepositProtection Schemas (TEMP)
...
// PropertyDisclosure Schemas (TEMP)
...
// ImmigrationStatusCheck Schemas (TEMP)
...
// AttorneyManagement Schemas (TEMP)
...
// MortgagePreApproval Schemas (TEMP)
...
// AIModelDeployment Schemas (TEMP)
...
// QueueConfiguration Schemas (TEMP)
...
// AutomationExecution Schemas (TEMP)
...
// AIPropertyValuation Schemas (TEMP)
...
// AIPropertyDescription Schemas (TEMP)
...
// AIPriceOptimization Schemas (TEMP)
...
// AISentimentAnalysis Schemas (TEMP)
...
// AIPredictiveMaintenance Schemas (TEMP)
...
// AITenantScreening Schemas (TEMP)
...
// AIInvestmentAnalysis Schemas (TEMP)
...
// DashboardConfiguration Schemas (TEMP)
...
// PaymentNegotiation Schemas (TEMP)
...
// PaymentInstallment Schemas (TEMP)
...
// AmbassadorContract Schemas (TEMP)
...
// AmbassadorCampaign Schemas (TEMP)
...
// SocialImpactCounter Schemas (TEMP)
...
// SocialImpactRecord Schemas (TEMP)
...
// SocialInboundMessage Schemas (TEMP)
...
// SocialCommentReply Schemas (TEMP)
...
// SocialAutomationRule Schemas (TEMP)
...
// SocialAccountMetric Schemas (TEMP)
...
// EscrowStatusHistory Schemas (TEMP)
...
// PropertyPromotion Schemas (TEMP)
...
// PropertyOwnershipVerification Schemas (TEMP)
...
// OwnershipVerificationDocument Schemas (TEMP)
...
// PropertyOwnershipTransfer Schemas (TEMP)
...
// BookingSecurityScreening Schemas (TEMP)
...
// VideoVendorPartnership Schemas (TEMP)
...
// PartnershipEarning Schemas (TEMP)
...
// VideoQualityReview Schemas (TEMP)
...
// VendorQualityReview Schemas (TEMP)
...
// UserValuationPreference Schemas (TEMP)
...
// GlobalTaxRegulation Schemas (TEMP)
...
// MarketRateComparison Schemas (TEMP)
...
// PlatformRevenueRecord Schemas (TEMP)
...
// AiVideoGeneration Schemas (TEMP)
...
// AiBrochureGeneration Schemas (TEMP)
...
// CategoryTranslation Schemas (TEMP)
...
// USPublicTaxRecord Schemas (TEMP)
...
// USPropertyAssessment Schemas (TEMP)
...
// UKPropertyCertificateRecord Schemas (TEMP)
...
// TRPropertyDocumentRecord Schemas (TEMP)
...
// GuestVerification Schemas (TEMP)
...
// TenantVerificationStage Schemas (TEMP)
...
// TenantReliabilityScore Schemas (TEMP)
...
// PropertySecurityConfig Schemas (TEMP)
...
// ContractTransition Schemas (TEMP)
...
// ListingDistribution Schemas (TEMP)
...
// ReputationDecayLog Schemas (TEMP)
...
// DemandGenerationLog Schemas (TEMP)
...
// AgentEscrowWallet Schemas (TEMP)
...
// AgentEscrowTransaction Schemas (TEMP)
...
// EscrowSplitConfig Schemas (TEMP)
...
// HotelProviderMapping Schemas (TEMP)
...
// PropertyTrustScore Schemas (TEMP)
...
// PaymentRoutingLog Schemas (TEMP)
...
// BookingFailoverEvent Schemas (TEMP)
...
// ExperienceBooking Schemas (TEMP)
...
// AIKnowledgeArticle Schemas (TEMP)
...
// UserRevenueProfile Schemas (TEMP)
