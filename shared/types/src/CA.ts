// Otomatik üretilmiş Valibot schema'ları (CA)
// Generated: 2026-07-06T02:23:48.499Z
...
// ListingStatusHistory Schemas (CA)
...
// GovernmentIntegration Schemas (CA)
...
// HomeInformationPack Schemas (CA)
...
// SolicitorManagement Schemas (CA)
...
// ExternalRentalListing Schemas (CA)
...
// VacationRentalPlatform Schemas (CA)
...
// MlsListingEnhancement Schemas (CA)
...
// MaintenanceWorkOrder Schemas (CA)
...
// UserFinancialProfile Schemas (CA)
...
// RecommendationResult Schemas (CA)
...
// CommunicationTemplate Schemas (CA)
...
// SecurityDepositProtection Schemas (CA)
...
// ImmigrationStatusCheck Schemas (CA)
...
// MortgagePreApproval Schemas (CA)
...
// AutomationExecution Schemas (CA)
...
// AIPropertyValuation Schemas (CA)
...
// AIPropertyDescription Schemas (CA)
...
// AIPriceOptimization Schemas (CA)
...
// AISentimentAnalysis Schemas (CA)
...
// AIPredictiveMaintenance Schemas (CA)
...
// AIInvestmentAnalysis Schemas (CA)
...
// DashboardConfiguration Schemas (CA)
...
// SocialImpactCounter Schemas (CA)
...
// SocialInboundMessage Schemas (CA)
...
// SocialAutomationRule Schemas (CA)
...
// SocialAccountMetric Schemas (CA)
...
// EscrowStatusHistory Schemas (CA)
...
// PropertyOwnershipVerification Schemas (CA)
...
// OwnershipVerificationDocument Schemas (CA)
...
// PropertyOwnershipTransfer Schemas (CA)
...
// BookingSecurityScreening Schemas (CA)
...
// VideoVendorPartnership Schemas (CA)
...
// VendorQualityReview Schemas (CA)
...
// UserValuationPreference Schemas (CA)
...
// GlobalTaxRegulation Schemas (CA)
...
// MarketRateComparison Schemas (CA)
...
// PlatformRevenueRecord Schemas (CA)
...
// AiBrochureGeneration Schemas (CA)
...
// CategoryTranslation Schemas (CA)
...
// USPropertyAssessment Schemas (CA)
...
// UKPropertyCertificateRecord Schemas (CA)
...
// TRPropertyDocumentRecord Schemas (CA)
...
// TenantVerificationStage Schemas (CA)
...
// TenantReliabilityScore Schemas (CA)
...
// PropertySecurityConfig Schemas (CA)
...
// ListingDistribution Schemas (CA)
...
// DemandGenerationLog Schemas (CA)
...
// AgentEscrowTransaction Schemas (CA)
...
// HotelProviderMapping Schemas (CA)
...
// BookingFailoverEvent Schemas (CA)
