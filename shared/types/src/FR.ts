// Otomatik üretilmiş Valibot schema'ları (FR)
// Generated: 2026-07-07T07:57:03.551Z
...
// ListingStatusHistory Schemas (FR)
...
// GovernmentIntegration Schemas (FR)
...
// HomeInformationPack Schemas (FR)
...
// SolicitorManagement Schemas (FR)
...
// ExternalRentalListing Schemas (FR)
...
// VacationRentalPlatform Schemas (FR)
...
// MlsListingEnhancement Schemas (FR)
...
// MaintenanceWorkOrder Schemas (FR)
...
// UserFinancialProfile Schemas (FR)
...
// RecommendationResult Schemas (FR)
...
// CommunicationTemplate Schemas (FR)
...
// SecurityDepositProtection Schemas (FR)
...
// ImmigrationStatusCheck Schemas (FR)
...
// MortgagePreApproval Schemas (FR)
...
// AutomationExecution Schemas (FR)
...
// AIPropertyValuation Schemas (FR)
...
// AIPropertyDescription Schemas (FR)
...
// AIPriceOptimization Schemas (FR)
...
// AISentimentAnalysis Schemas (FR)
...
// AIPredictiveMaintenance Schemas (FR)
...
// AIInvestmentAnalysis Schemas (FR)
...
// DashboardConfiguration Schemas (FR)
...
// SocialImpactCounter Schemas (FR)
...
// SocialInboundMessage Schemas (FR)
...
// SocialAutomationRule Schemas (FR)
...
// SocialAccountMetric Schemas (FR)
...
// EscrowStatusHistory Schemas (FR)
...
// PropertyOwnershipVerification Schemas (FR)
...
// OwnershipVerificationDocument Schemas (FR)
...
// PropertyOwnershipTransfer Schemas (FR)
...
// BookingSecurityScreening Schemas (FR)
...
// VideoVendorPartnership Schemas (FR)
...
// VendorQualityReview Schemas (FR)
...
// UserValuationPreference Schemas (FR)
...
// GlobalTaxRegulation Schemas (FR)
...
// MarketRateComparison Schemas (FR)
...
// PlatformRevenueRecord Schemas (FR)
...
// AiBrochureGeneration Schemas (FR)
...
// CategoryTranslation Schemas (FR)
...
// USPropertyAssessment Schemas (FR)
...
// UKPropertyCertificateRecord Schemas (FR)
...
// TRPropertyDocumentRecord Schemas (FR)
...
// TenantVerificationStage Schemas (FR)
...
// TenantReliabilityScore Schemas (FR)
...
// PropertySecurityConfig Schemas (FR)
...
// ListingDistribution Schemas (FR)
...
// DemandGenerationLog Schemas (FR)
...
// AgentEscrowTransaction Schemas (FR)
...
// HotelProviderMapping Schemas (FR)
...
// BookingFailoverEvent Schemas (FR)
