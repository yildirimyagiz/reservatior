// Otomatik üretilmiş Valibot schema'ları (TH)
// Generated: 2026-07-07T07:57:03.849Z
...
// ListingStatusHistory Schemas (TH)
...
// GovernmentIntegration Schemas (TH)
...
// HomeInformationPack Schemas (TH)
...
// SolicitorManagement Schemas (TH)
...
// ExternalRentalListing Schemas (TH)
...
// VacationRentalPlatform Schemas (TH)
...
// MlsListingEnhancement Schemas (TH)
...
// MaintenanceWorkOrder Schemas (TH)
...
// UserFinancialProfile Schemas (TH)
...
// RecommendationResult Schemas (TH)
...
// CommunicationTemplate Schemas (TH)
...
// SecurityDepositProtection Schemas (TH)
...
// ImmigrationStatusCheck Schemas (TH)
...
// MortgagePreApproval Schemas (TH)
...
// AutomationExecution Schemas (TH)
...
// AIPropertyValuation Schemas (TH)
...
// AIPropertyDescription Schemas (TH)
...
// AIPriceOptimization Schemas (TH)
...
// AISentimentAnalysis Schemas (TH)
...
// AIPredictiveMaintenance Schemas (TH)
...
// AIInvestmentAnalysis Schemas (TH)
...
// DashboardConfiguration Schemas (TH)
...
// SocialImpactCounter Schemas (TH)
...
// SocialInboundMessage Schemas (TH)
...
// SocialAutomationRule Schemas (TH)
...
// SocialAccountMetric Schemas (TH)
...
// EscrowStatusHistory Schemas (TH)
...
// PropertyOwnershipVerification Schemas (TH)
...
// OwnershipVerificationDocument Schemas (TH)
...
// PropertyOwnershipTransfer Schemas (TH)
...
// BookingSecurityScreening Schemas (TH)
...
// VideoVendorPartnership Schemas (TH)
...
// VendorQualityReview Schemas (TH)
...
// UserValuationPreference Schemas (TH)
...
// GlobalTaxRegulation Schemas (TH)
...
// MarketRateComparison Schemas (TH)
...
// PlatformRevenueRecord Schemas (TH)
...
// AiBrochureGeneration Schemas (TH)
...
// CategoryTranslation Schemas (TH)
...
// USPropertyAssessment Schemas (TH)
...
// UKPropertyCertificateRecord Schemas (TH)
...
// TRPropertyDocumentRecord Schemas (TH)
...
// TenantVerificationStage Schemas (TH)
...
// TenantReliabilityScore Schemas (TH)
...
// PropertySecurityConfig Schemas (TH)
...
// ListingDistribution Schemas (TH)
...
// DemandGenerationLog Schemas (TH)
...
// AgentEscrowTransaction Schemas (TH)
...
// HotelProviderMapping Schemas (TH)
...
// BookingFailoverEvent Schemas (TH)
