// Otomatik üretilmiş Valibot schema'ları (MX)
// Generated: 2026-07-06T02:23:48.468Z
...
// ListingStatusHistory Schemas (MX)
...
// GovernmentIntegration Schemas (MX)
...
// HomeInformationPack Schemas (MX)
...
// SolicitorManagement Schemas (MX)
...
// ExternalRentalListing Schemas (MX)
...
// VacationRentalPlatform Schemas (MX)
...
// MlsListingEnhancement Schemas (MX)
...
// MaintenanceWorkOrder Schemas (MX)
...
// UserFinancialProfile Schemas (MX)
...
// RecommendationResult Schemas (MX)
...
// CommunicationTemplate Schemas (MX)
...
// SecurityDepositProtection Schemas (MX)
...
// ImmigrationStatusCheck Schemas (MX)
...
// MortgagePreApproval Schemas (MX)
...
// AutomationExecution Schemas (MX)
...
// AIPropertyValuation Schemas (MX)
...
// AIPropertyDescription Schemas (MX)
...
// AIPriceOptimization Schemas (MX)
...
// AISentimentAnalysis Schemas (MX)
...
// AIPredictiveMaintenance Schemas (MX)
...
// AIInvestmentAnalysis Schemas (MX)
...
// DashboardConfiguration Schemas (MX)
...
// SocialImpactCounter Schemas (MX)
...
// SocialInboundMessage Schemas (MX)
...
// SocialAutomationRule Schemas (MX)
...
// SocialAccountMetric Schemas (MX)
...
// EscrowStatusHistory Schemas (MX)
...
// PropertyOwnershipVerification Schemas (MX)
...
// OwnershipVerificationDocument Schemas (MX)
...
// PropertyOwnershipTransfer Schemas (MX)
...
// BookingSecurityScreening Schemas (MX)
...
// VideoVendorPartnership Schemas (MX)
...
// VendorQualityReview Schemas (MX)
...
// UserValuationPreference Schemas (MX)
...
// GlobalTaxRegulation Schemas (MX)
...
// MarketRateComparison Schemas (MX)
...
// PlatformRevenueRecord Schemas (MX)
...
// AiBrochureGeneration Schemas (MX)
...
// CategoryTranslation Schemas (MX)
...
// USPropertyAssessment Schemas (MX)
...
// UKPropertyCertificateRecord Schemas (MX)
...
// TRPropertyDocumentRecord Schemas (MX)
...
// TenantVerificationStage Schemas (MX)
...
// TenantReliabilityScore Schemas (MX)
...
// PropertySecurityConfig Schemas (MX)
...
// ListingDistribution Schemas (MX)
...
// DemandGenerationLog Schemas (MX)
...
// AgentEscrowTransaction Schemas (MX)
...
// HotelProviderMapping Schemas (MX)
...
// BookingFailoverEvent Schemas (MX)
