// Otomatik üretilmiş Valibot schema'ları (AE)
// Generated: 2026-07-06T02:23:48.490Z
...
// ListingStatusHistory Schemas (AE)
...
// GovernmentIntegration Schemas (AE)
...
// HomeInformationPack Schemas (AE)
...
// SolicitorManagement Schemas (AE)
...
// ExternalRentalListing Schemas (AE)
...
// VacationRentalPlatform Schemas (AE)
...
// MlsListingEnhancement Schemas (AE)
...
// MaintenanceWorkOrder Schemas (AE)
...
// UserFinancialProfile Schemas (AE)
...
// RecommendationResult Schemas (AE)
...
// CommunicationTemplate Schemas (AE)
...
// SecurityDepositProtection Schemas (AE)
...
// ImmigrationStatusCheck Schemas (AE)
...
// MortgagePreApproval Schemas (AE)
...
// AutomationExecution Schemas (AE)
...
// AIPropertyValuation Schemas (AE)
...
// AIPropertyDescription Schemas (AE)
...
// AIPriceOptimization Schemas (AE)
...
// AISentimentAnalysis Schemas (AE)
...
// AIPredictiveMaintenance Schemas (AE)
...
// AIInvestmentAnalysis Schemas (AE)
...
// DashboardConfiguration Schemas (AE)
...
// SocialImpactCounter Schemas (AE)
...
// SocialInboundMessage Schemas (AE)
...
// SocialAutomationRule Schemas (AE)
...
// SocialAccountMetric Schemas (AE)
...
// EscrowStatusHistory Schemas (AE)
...
// PropertyOwnershipVerification Schemas (AE)
...
// OwnershipVerificationDocument Schemas (AE)
...
// PropertyOwnershipTransfer Schemas (AE)
...
// BookingSecurityScreening Schemas (AE)
...
// VideoVendorPartnership Schemas (AE)
...
// VendorQualityReview Schemas (AE)
...
// UserValuationPreference Schemas (AE)
...
// GlobalTaxRegulation Schemas (AE)
...
// MarketRateComparison Schemas (AE)
...
// PlatformRevenueRecord Schemas (AE)
...
// AiBrochureGeneration Schemas (AE)
...
// CategoryTranslation Schemas (AE)
...
// USPropertyAssessment Schemas (AE)
...
// UKPropertyCertificateRecord Schemas (AE)
...
// TRPropertyDocumentRecord Schemas (AE)
...
// TenantVerificationStage Schemas (AE)
...
// TenantReliabilityScore Schemas (AE)
...
// PropertySecurityConfig Schemas (AE)
...
// ListingDistribution Schemas (AE)
...
// DemandGenerationLog Schemas (AE)
...
// AgentEscrowTransaction Schemas (AE)
...
// HotelProviderMapping Schemas (AE)
...
// BookingFailoverEvent Schemas (AE)
