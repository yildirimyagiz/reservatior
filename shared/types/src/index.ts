// Otomatik üretilmiş Valibot schema'ları (BASE)
// Generated: 2026-07-07T07:57:03.508Z
...
export enum PermissionKey {
  ...
  GLOBAL_ARBITRAGE_VIEW = "GLOBAL_ARBITRAGE_VIEW",
...
export enum PropertyType {
  ...
  COMPOUND = "COMPOUND",
  VILLA = "VILLA",
  ADU_GUEST_HOUSE = "ADU_GUEST_HOUSE",
  CABIN_TINY_HOUSE = "CABIN_TINY_HOUSE",
...
export enum LeaseStatus {
  ...
  EVICTED_VIA_TECH = "EVICTED_VIA_TECH"
}
...
export const StateSchema = v.enum_(State);
...
export const SocialPostTypeSchema = v.enum_(SocialPostType);
...
export const SocialPostStatusSchema = v.enum_(SocialPostStatus);
...
export const AIContentTypeSchema = v.enum_(AIContentType);
...
export const InboundChannelSchema = v.enum_(InboundChannel);
...
export const InboundMessageStatusSchema = v.enum_(InboundMessageStatus);
...
export const MessageSentimentSchema = v.enum_(MessageSentiment);
...
export const ReplySourceSchema = v.enum_(ReplySource);
...
export const AutomationTriggerSchema = v.enum_(AutomationTrigger);
...
export const AutomationActionSchema = v.enum_(AutomationAction);
...
export const NZRegionSchema = v.enum_(NZRegion);

export enum NZTaxForm {
  GST_15 = "GST_15",
  INCOME_TAX = "INCOME_TAX",
  RATES = "RATES"
}
export const NZTaxFormSchema = v.enum_(NZTaxForm);
...
export const AUStateSchema = v.enum_(AUState);

export enum AUTaxForm {
  LAND_TAX = "LAND_TAX",
  STAMP_DUTY = "STAMP_DUTY",
  CGT = "CGT",
  GST_10 = "GST_10"
}
export const AUTaxFormSchema = v.enum_(AUTaxForm);

export enum NLProvince {
...
export const NLProvinceSchema = v.enum_(NLProvince);

export enum NLTaxForm {
  IB = "IB",
  BTW_21 = "BTW_21",
  OZB = "OZB",
  OVERDRACHTSBELASTING = "OVERDRACHTSBELASTING"
}
export const NLTaxFormSchema = v.enum_(NLTaxForm);

export enum USPresentUse {
  ...
  HOSPITAL = "HOSPITAL",
  GOVERNMENT = "GOVERNMENT",
  VACANT_LAND_SINGLE_FAMILY = "VACANT_LAND_SINGLE_FAMILY",
  VACANT_LAND_COMMERCIAL = "VACANT_LAND_COMMERCIAL",
  VACANT_LAND_INDUSTRIAL = "VACANT_LAND_INDUSTRIAL",
  VACANT_LAND_MULTIFAMILY = "VACANT_LAND_MULTIFAMILY",
  FARM = "FARM",
  TIMBER = "TIMBER",
  MINING = "MINING",
...
export const USPresentUseSchema = v.enum_(USPresentUse);
...
export const MXStateSchema = v.enum_(MXState);

export enum MXTaxForm {
  ISR = "ISR",
  IVA_16 = "IVA_16",
  PREDIAL = "PREDIAL",
  ISAI = "ISAI"
}
export const MXTaxFormSchema = v.enum_(MXTaxForm);

export enum UKCounty {
  GREATER_LONDON = "GREATER_LONDON",
  ESSEX = "ESSEX",
  KENT = "KENT",
  SURREY = "SURREY",
  SUSSEX_EAST = "SUSSEX_EAST",
  SUSSEX_WEST = "SUSSEX_WEST",
  HAMPSHIRE = "HAMPSHIRE",
  BERKSHIRE = "BERKSHIRE",
  ...
  YORKSHIRE_WEST = "YORKSHIRE_WEST",
  YORKSHIRE_SOUTH = "YORKSHIRE_SOUTH",
  YORKSHIRE_NORTH = "YORKSHIRE_NORTH",
  YORKSHIRE_EAST = "YORKSHIRE_EAST",
  DURHAM = "DURHAM",
  ...
  GWYNEDD = "GWYNEDD",
  ISLE_OF_ANGLESEY = "ISLE_OF_ANGLESEY",
  MERTHYR_TYDFIL = "MERTHYR_TYDFIL",
...
export const UKCountySchema = v.enum_(UKCounty);

export enum UKTaxForm {
  ...
  STAMP_DUTY_LAND_TAX = "STAMP_DUTY_LAND_TAX",
  ANNUAL_TAX_ON_ENVELOPED_DWELLINGS = "ANNUAL_TAX_ON_ENVELOPED_DWELLINGS"
}
export const UKTaxFormSchema = v.enum_(UKTaxForm);

export enum UKCouncilTaxBand {
  BAND_A = "BAND_A",
  BAND_B = "BAND_B",
  BAND_C = "BAND_C",
  BAND_D = "BAND_D",
...
export const UKCouncilTaxBandSchema = v.enum_(UKCouncilTaxBand);

export enum UKEPCRating {
...
export const UKEPCRatingSchema = v.enum_(UKEPCRating);

export enum UKTenureType {
  FREEHOLD = "FREEHOLD",
  LEASEHOLD = "LEASEHOLD",
...
export const UKTenureTypeSchema = v.enum_(UKTenureType);

export enum UKPropertyCertificate {
  EPC = "EPC",
...
export const UKPropertyCertificateSchema = v.enum_(UKPropertyCertificate);

export enum AEEmirate {
  ABU_DHABI = "ABU_DHABI",
  DUBAI = "DUBAI",
  SHARJAH = "SHARJAH",
  AJMAN = "AJMAN",
...
export const AEEmirateSchema = v.enum_(AEEmirate);

export enum AEArea {
  ABU_DHABI_CITY = "ABU_DHABI_CITY",
  AL_AIN = "AL_AIN",
  RUWAIS = "RUWAIS",
  KHALIFA_CITY = "KHALIFA_CITY",
  YAS_ISLAND = "YAS_ISLAND",
  SAADIYAT_ISLAND = "SAADIYAT_ISLAND",
  AL_REEM_ISLAND = "AL_REEM_ISLAND",
  MASDAR_CITY = "MASDAR_CITY",
  DOWNTOWN_DUBAI = "DOWNTOWN_DUBAI",
  ...
  DUBAI_SILICON_OASIS = "DUBAI_SILICON_OASIS",
  DEIRA = "DEIRA",
  BUR_DUBAI = "BUR_DUBAI",
  JUMEIRAH = "JUMEIRAH",
  AL_BARSHA = "AL_BARSHA",
  INTERNATIONAL_CITY = "INTERNATIONAL_CITY",
  DISCOVERY_GARDENS = "DISCOVERY_GARDENS",
  JLT = "JLT",
  DUBAI_SPORTS_CITY = "DUBAI_SPORTS_CITY",
  MOTOR_CITY = "MOTOR_CITY",
  STUDIO_CITY = "STUDIO_CITY",
  DUBAI_LAND = "DUBAI_LAND",
  MIRDIF = "MIRDIF",
  SHARJAH_CITY = "SHARJAH_CITY",
  AL_NAHDA = "AL_NAHDA",
  AL_MAJAZ = "AL_MAJAZ",
  AL_KHAN = "AL_KHAN",
  AJMAN_CITY = "AJMAN_CITY",
  UMM_AL_QUWAIN_CITY = "UMM_AL_QUWAIN_CITY",
  RAS_AL_KHAIMAH_CITY = "RAS_AL_KHAIMAH_CITY",
  FUJAIRAH_CITY = "FUJAIRAH_CITY"
}
export const AEAreaSchema = v.enum_(AEArea);

export enum AETaxForm {
  VAT_RETURN = "VAT_RETURN",
  CORPORATE_TAX_RETURN = "CORPORATE_TAX_RETURN",
  EXCISE_TAX = "EXCISE_TAX",
  CUSTOMS_DUTY = "CUSTOMS_DUTY",
  TOURISM_DIRHAM_FEE = "TOURISM_DIRHAM_FEE",
  MUNICIPALITY_TAX = "MUNICIPALITY_TAX",
  EJARI_REGISTRATION = "EJARI_REGISTRATION"
}
export const AETaxFormSchema = v.enum_(AETaxForm);

export enum AEPropertyOwnership {
  FREEHOLD = "FREEHOLD",
  LEASEHOLD = "LEASEHOLD",
  USUFRUCT = "USUFRUCT",
  MUSATAHA = "MUSATAHA"
}
export const AEPropertyOwnershipSchema = v.enum_(AEPropertyOwnership);

export enum AEPropertyDocument {
  TITLE_DEED = "TITLE_DEED",
  ...
  ADDC_CLEARANCE = "ADDC_CLEARANCE",
  RERA_CERTIFICATE = "RERA_CERTIFICATE",
  DLD_CERTIFICATE = "DLD_CERTIFICATE",
  ADRE_CERTIFICATE = "ADRE_CERTIFICATE",
  BUILDING_PERMIT = "BUILDING_PERMIT",
  OCCUPANCY_CERTIFICATE = "OCCUPANCY_CERTIFICATE"
}
export const AEPropertyDocumentSchema = v.enum_(AEPropertyDocument);
...
export const CAProvinceSchema = v.enum_(CAProvince);

export enum CATaxForm {
  ...
  QST_RETURN = "QST_RETURN",
  SCHEDULE_3 = "SCHEDULE_3",
  RC4288 = "RC4288",
  T4 = "T4",
  T5 = "T5"
}
export const CATaxFormSchema = v.enum_(CATaxForm);

export enum CAPropertyType {
  DETACHED_HOUSE = "DETACHED_HOUSE",
...
export const CAPropertyTypeSchema = v.enum_(CAPropertyType);

export enum CALandTitleSystem {
  TORRENS = "TORRENS",
  REGISTRY = "REGISTRY",
  LAND_TITLES = "LAND_TITLES"
}
export const CALandTitleSystemSchema = v.enum_(CALandTitleSystem);

export enum CAHeatingType {
  FORCED_AIR_GAS = "FORCED_AIR_GAS",
  FORCED_AIR_ELECTRIC = "FORCED_AIR_ELECTRIC",
  FORCED_AIR_OIL = "FORCED_AIR_OIL",
  HOT_WATER_RADIATOR = "HOT_WATER_RADIATOR",
  BASEBOARD_ELECTRIC = "BASEBOARD_ELECTRIC",
...
export const CAHeatingTypeSchema = v.enum_(CAHeatingType);

export enum ESProvince {
  ANDALUCIA = "ANDALUCIA",
  ARAGON = "ARAGON",
  ASTURIAS = "ASTURIAS",
  BALEARES = "BALEARES",
...
export const ESProvinceSchema = v.enum_(ESProvince);

export enum ESTaxForm {
  IRPF = "IRPF",
  IVA = "IVA",
  IBI = "IBI",
  PLUSVALIA = "PLUSVALIA",
...
export const ESTaxFormSchema = v.enum_(ESTaxForm);

export enum ESPropertyDocument {
  ...
  ITE = "ITE",
  LICENCIA_PRIMERA_OCUPACION = "LICENCIA_PRIMERA_OCUPACION",
  NIE = "NIE"
}
export const ESPropertyDocumentSchema = v.enum_(ESPropertyDocument);

export enum ESEnergyRating {
  A = "A",
  B = "B",
  C = "C",
  D = "D",
...
export const ESEnergyRatingSchema = v.enum_(ESEnergyRating);

export enum SARegion {
  RIYADH = "RIYADH",
  MAKKAH = "MAKKAH",
  MADINAH = "MADINAH",
...
export const SARegionSchema = v.enum_(SARegion);

export enum SATaxForm {
  VAT_15 = "VAT_15",
  ZAKAT = "ZAKAT",
  REAL_ESTATE_TAX = "REAL_ESTATE_TAX"
}
export const SATaxFormSchema = v.enum_(SATaxForm);
...
export const BRStateSchema = v.enum_(BRState);

export enum BRTaxForm {
  IPTU = "IPTU",
  ITBI = "ITBI",
  IRPF = "IRPF",
  IRRF = "IRRF"
}
export const BRTaxFormSchema = v.enum_(BRTaxForm);
...
export const DEStateSchema = v.enum_(DEState);

export enum KRRegion {
  SEOUL = "SEOUL",
  BUSAN = "BUSAN",
  DAEGU = "DAEGU",
  INCHEON = "INCHEON",
...
export const KRRegionSchema = v.enum_(KRRegion);

export enum KRTaxForm {
  JAESAN_SE = "JAESAN_SE",
  YANG_DO_SE = "YANG_DO_SE",
  CHONGBOO_SE = "CHONGBOO_SE"
}
export const KRTaxFormSchema = v.enum_(KRTaxForm);
...
export const INStateSchema = v.enum_(INState);

export enum INTaxForm {
  PROPERTY_TAX = "PROPERTY_TAX",
  STAMP_DUTY = "STAMP_DUTY",
  GST_18 = "GST_18"
}
export const INTaxFormSchema = v.enum_(INTaxForm);
...
export const ITRegionSchema = v.enum_(ITRegion);

export enum ITTaxForm {
  IMU = "IMU",
  TARI = "TARI",
  TASI = "TASI",
  IVA_22 = "IVA_22",
...
export const ITTaxFormSchema = v.enum_(ITTaxForm);

export enum ARProvince {
...
export const ARProvinceSchema = v.enum_(ARProvince);

export enum ARTaxForm {
  ABL = "ABL",
  ARBA = "ARBA",
  IIBB = "IIBB",
  IVA_21 = "IVA_21"
}
export const ARTaxFormSchema = v.enum_(ARTaxForm);
...
export const TRCitySchema = v.enum_(TRCity);

export enum TRTaxForm {
  GELIR_VERGISI_BEYANNAMESI = "GELIR_VERGISI_BEYANNAMESI",
  KURUMLAR_VERGISI_BEYANNAMESI = "KURUMLAR_VERGISI_BEYANNAMESI",
  KDV_BEYANNAMESI = "KDV_BEYANNAMESI",
  MUHTASAR_BEYANNAME = "MUHTASAR_BEYANNAME",
  YILLIK_GELIR_VERGISI = "YILLIK_GELIR_VERGISI",
  GECICI_VERGI = "GECICI_VERGI",
  VERASET_INTIKAL_VERGISI = "VERASET_INTIKAL_VERGISI",
  EMLAK_VERGISI = "EMLAK_VERGISI",
  CEVRESEL_TEMIZLIK_VERGISI = "CEVRESEL_TEMIZLIK_VERGISI",
  DAMGA_VERGISI = "DAMGA_VERGISI",
  HARCIRAH_BEYANI = "HARCIRAH_BEYANI"
}
export const TRTaxFormSchema = v.enum_(TRTaxForm);

export enum TRPropertyDocument {
  TAPU = "TAPU",
  IMAR_DURUMU = "IMAR_DURUMU",
  ISKAN_RUHSATI = "ISKAN_RUHSATI",
  YAPI_RUHSATI = "YAPI_RUHSATI",
  YAPI_KULLANMA_IZIN_BELGESI = "YAPI_KULLANMA_IZIN_BELGESI",
  CEVRESEL_ETKI_DEGERLENDIRMESI = "CEVRESEL_ETKI_DEGERLENDIRMESI",
  YANGINA_KARSI_KORUMA = "YANGINA_KARSI_KORUMA",
  DEPREM_RAPORU = "DEPREM_RAPORU",
  ZEMIN_ETUT_RAPORU = "ZEMIN_ETUT_RAPORU",
  APLIKASYON_PROJESI = "APLIKASYON_PROJESI",
  KAT_IRTIFAKI = "KAT_IRTIFAKI",
  KAT_MULKIYETI = "KAT_MULKIYETI"
}
export const TRPropertyDocumentSchema = v.enum_(TRPropertyDocument);

export enum TRZoningType {
  KONUT = "KONUT",
  TICARI = "TICARI",
  SANAYI = "SANAYI",
  KARMA = "KARMA",
  TARLA = "TARLA",
  ARSA = "ARSA",
  KAMU_HIZMETI = "KAMU_HIZMETI",
  REKREASYON = "REKREASYON",
  TURIZM = "TURIZM",
  OZEL_PROJE_ALANI = "OZEL_PROJE_ALANI"
}
export const TRZoningTypeSchema = v.enum_(TRZoningType);

export enum TREarthquakeZone {
  DEPREM_BOLGE_1 = "DEPREM_BOLGE_1",
  DEPREM_BOLGE_2 = "DEPREM_BOLGE_2",
  DEPREM_BOLGE_3 = "DEPREM_BOLGE_3",
  DEPREM_BOLGE_4 = "DEPREM_BOLGE_4",
  DEPREM_BOLGE_5 = "DEPREM_BOLGE_5"
}
export const TREarthquakeZoneSchema = v.enum_(TREarthquakeZone);
...
export const CNProvinceSchema = v.enum_(CNProvince);

export enum CNTaxForm {
  PROPERTY_TAX = "PROPERTY_TAX",
  DEED_TAX = "DEED_TAX",
  VAT_13 = "VAT_13"
}
export const CNTaxFormSchema = v.enum_(CNTaxForm);

export enum SGRegion {
  CENTRAL = "CENTRAL",
  EAST = "EAST",
  NORTH = "NORTH",
...
export const SGRegionSchema = v.enum_(SGRegion);

export enum SGTaxForm {
  PROPERTY_TAX = "PROPERTY_TAX",
  STAMP_DUTY = "STAMP_DUTY",
  GST_9 = "GST_9"
}
export const SGTaxFormSchema = v.enum_(SGTaxForm);

export enum THRegion {
  BANGKOK = "BANGKOK",
  CENTRAL = "CENTRAL",
  EASTERN = "EASTERN",
  NORTHERN = "NORTHERN",
...
export const THRegionSchema = v.enum_(THRegion);

export enum THTaxForm {
  LAND_TAX = "LAND_TAX",
  BUILDING_TAX = "BUILDING_TAX",
  VAT_7 = "VAT_7"
}
export const THTaxFormSchema = v.enum_(THTaxForm);
...
export const MYStateSchema = v.enum_(MYState);

export enum MYTaxForm {
  QUIT_RENT = "QUIT_RENT",
  ASSESSMENT_TAX = "ASSESSMENT_TAX",
  RPGT = "RPGT"
}
export const MYTaxFormSchema = v.enum_(MYTaxForm);
...
export enum VerificationStage {
  ...
  TRUSTED_TRAVELER = "TRUSTED_TRAVELER",
  ELITE_MEMBER = "ELITE_MEMBER"
}
export const VerificationStageSchema = v.enum_(VerificationStage);
...
export const VerificationStatusSchema = v.enum_(VerificationStatus);
...
export const SecurityIncidentTypeSchema = v.enum_(SecurityIncidentType);
...
export const SecurityIncidentSeveritySchema = v.enum_(SecurityIncidentSeverity);
...
export const SecurityIncidentStatusSchema = v.enum_(SecurityIncidentStatus);

export enum OperatorLicenseStatus {
  PENDING = "PENDING",
  APPROVED = "APPROVED",
  SUSPENDED = "SUSPENDED",
  REVOKED = "REVOKED",
...
export const OperatorLicenseStatusSchema = v.enum_(OperatorLicenseStatus);
...
export const ReliabilityTierSchema = v.enum_(ReliabilityTier);
...
// OrganizationMember Schemas (BASE)
...
export const propertyUpdateSchema = v.partial(v.object({
  ...
  notes: v.optional(v.string()),
  locationId: v.optional(v.string()),
  stateCode: v.optional(v.enum_(State)),
  ...
  nzCode: v.optional(v.enum_(NZRegion)),
  legalDescription: v.optional(v.string()),
  titleNumber: v.optional(v.string()),
  councilRates: v.optional(v.number()),
  bodyCorpFees: v.optional(v.number()),
  auCode: v.optional(v.enum_(AUState)),
  lotNumber: v.optional(v.string()),
  titleReference: v.optional(v.string()),
  strataFees: v.optional(v.number()),
  waterRates: v.optional(v.number()),
  nlCode: v.optional(v.enum_(NLProvince)),
  kadasterNummer: v.optional(v.string()),
  energyLabel: v.optional(v.string()),
  bouwjaar: v.optional(v.number()),
  balkon: v.optional(v.boolean()),
  tuin: v.optional(v.boolean()),
  parkeerplaats: v.optional(v.boolean()),
  mxCode: v.optional(v.enum_(MXState)),
  claveCatastral: v.optional(v.string()),
  escrituraPublica: v.optional(v.string()),
  folioReal: v.optional(v.string()),
  predial: v.optional(v.number()),
  mantenimiento: v.optional(v.number()),
  countyCode: v.optional(v.enum_(UKCounty)),
  councilTaxBand: v.optional(v.enum_(UKCouncilTaxBand)),
  epcRating: v.optional(v.enum_(UKEPCRating)),
  epcScore: v.optional(v.number()),
  epcValidUntil: v.optional(v.string()),
  tenureType: v.optional(v.enum_(UKTenureType)),
  leaseYearsRemaining: v.optional(v.number()),
  groundRent: v.optional(v.number()),
  serviceCharge: v.optional(v.number()),
  estateCharge: v.optional(v.number()),
  stampDutyPaid: v.optional(v.number()),
  buildingsSafetyAct: v.optional(v.boolean()),
  ews1Certificate: v.optional(v.boolean()),
  ews1ValidUntil: v.optional(v.string()),
  gasSafetyCertValidUntil: v.optional(v.string()),
  eicrValidUntil: v.optional(v.string()),
  hmoLicenseNumber: v.optional(v.string()),
  hmoLicenseValidUntil: v.optional(v.string()),
  selectiveLicenseNumber: v.optional(v.string()),
  rightToBuyProperty: v.optional(v.boolean()),
  listedBuildingGrade: v.optional(v.string()),
  conservationArea: v.optional(v.boolean()),
  floodRisk: v.optional(v.string()),
  councilName: v.optional(v.string()),
  councilTaxReference: v.optional(v.string()),
  emirateCode: v.optional(v.enum_(AEEmirate)),
  areaCode: v.optional(v.enum_(AEArea)),
  titleDeedNumber: v.optional(v.string()),
  plotNumber: v.optional(v.string()),
  makaniNumber: v.optional(v.string()),
  ownershipType: v.optional(v.enum_(AEPropertyOwnership)),
  ejariNumber: v.optional(v.string()),
  ejariValidUntil: v.optional(v.string()),
  oqoodNumber: v.optional(v.string()),
  reraPermitNumber: v.optional(v.string()),
  dldRegistrationNumber: v.optional(v.string()),
  municipalityFees: v.optional(v.number()),
  housingFee: v.optional(v.number()),
  dewaDepositNumber: v.optional(v.string()),
  chiller: v.optional(v.boolean()),
  chillerIncluded: v.optional(v.boolean()),
  chillerProvider: v.optional(v.string()),
  vat5Percent: v.optional(v.boolean()),
  serviceChargeSqft: v.optional(v.number()),
  totalServiceCharge: v.optional(v.number()),
  communityName: v.optional(v.string()),
  buildingName: v.optional(v.string()),
  unitNumber: v.optional(v.string()),
  maidsRoom: v.optional(v.boolean()),
  studyRoom: v.optional(v.boolean()),
  balconyArea: v.optional(v.number()),
  furnished: v.optional(v.boolean()),
  cheques: v.optional(v.number()),
  vacatingNoticeDays: v.optional(v.number()),
  securityDeposit: v.optional(v.number()),
  aeParkingSpaces: v.optional(v.number()),
  provinceCode: v.optional(v.enum_(CAProvince)),
  rollNumber: v.optional(v.string()),
  pidNumber: v.optional(v.string()),
  landTitleSystem: v.optional(v.enum_(CALandTitleSystem)),
  propertyTaxAccount: v.optional(v.string()),
  gstHstApplicable: v.optional(v.boolean()),
  qstApplicable: v.optional(v.boolean()),
  condoFees: v.optional(v.number()),
  condoFeesFrequency: v.optional(v.string()),
  strataPlan: v.optional(v.string()),
  caPropertyTaxRate: v.optional(v.number()),
  annualPropertyTax: v.optional(v.number()),
  schoolTax: v.optional(v.number()),
  waterTax: v.optional(v.number()),
  heatingIncluded: v.optional(v.boolean()),
  hydroIncluded: v.optional(v.boolean()),
  waterIncluded: v.optional(v.boolean()),
  parkingIncluded: v.optional(v.boolean()),
  parkingSpots: v.optional(v.number()),
  lockerIncluded: v.optional(v.boolean()),
  petFriendly: v.optional(v.boolean()),
  smokingAllowed: v.optional(v.boolean()),
  rpacCompliant: v.optional(v.boolean()),
  zoning: v.optional(v.string()),
  lotSize: v.optional(v.string()),
  frontage: v.optional(v.number()),
  depth: v.optional(v.number()),
  squareFootage: v.optional(v.number()),
  aboveGradeFinished: v.optional(v.number()),
  belowGradeFinished: v.optional(v.number()),
  totalFinished: v.optional(v.number()),
  referenceCatastral: v.optional(v.string()),
  notariaRegistro: v.optional(v.string()),
  numeroEscritura: v.optional(v.string()),
  registroPropiedad: v.optional(v.string()),
  numeroFinca: v.optional(v.string()),
  cedulaHabitabilidad: v.optional(v.string()),
  certificadoEnergetico: v.optional(v.string()),
  esEnergyRating: v.optional(v.enum_(ESEnergyRating)),
  energyScore: v.optional(v.number()),
  energyValidUntil: v.optional(v.string()),
  ibi: v.optional(v.number()),
  plusvalia: v.optional(v.number()),
  basuraYAgua: v.optional(v.number()),
  comunidadGastos: v.optional(v.number()),
  derramas: v.optional(v.boolean()),
  orientacion: v.optional(v.string()),
  vistas: v.optional(v.string()),
  planta: v.optional(v.number()),
  plantasTotales: v.optional(v.number()),
  superficie: v.optional(v.number()),
  superficieUtil: v.optional(v.number()),
  superficieTerraza: v.optional(v.number()),
  ascensor: v.optional(v.boolean()),
  portero: v.optional(v.boolean()),
  videoPortero: v.optional(v.boolean()),
  terraza: v.optional(v.boolean()),
  balcon: v.optional(v.boolean()),
  solarium: v.optional(v.boolean()),
  trastero: v.optional(v.boolean()),
  garaje: v.optional(v.boolean()),
  plazaGaraje: v.optional(v.number()),
  piscina: v.optional(v.boolean()),
  piscinaComunitaria: v.optional(v.boolean()),
  jardin: v.optional(v.boolean()),
  jardinPrivado: v.optional(v.boolean()),
  zonaVerde: v.optional(v.boolean()),
  aireAcondicionado: v.optional(v.boolean()),
  calefaccion: v.optional(v.boolean()),
  tipoCalefaccion: v.optional(v.string()),
  sueloRadiante: v.optional(v.boolean()),
  chimenea: v.optional(v.boolean()),
  armarios: v.optional(v.boolean()),
  armariosEmpotrados: v.optional(v.boolean()),
  vestidor: v.optional(v.boolean()),
  amueblado: v.optional(v.boolean()),
  cocinaEquipada: v.optional(v.boolean()),
  electrodomesticos: v.optional(v.boolean()),
  lavadero: v.optional(v.boolean()),
  alarma: v.optional(v.boolean()),
  puertoBlindada: v.optional(v.boolean()),
  accesoMinusvalidos: v.optional(v.boolean()),
  zonaInfantil: v.optional(v.boolean()),
  zonaDeportiva: v.optional(v.boolean()),
  urbanizacion: v.optional(v.string()),
  saCode: v.optional(v.enum_(SARegion)),
  deedNumber: v.optional(v.string()),
  serviceFees: v.optional(v.number()),
  brCode: v.optional(v.enum_(BRState)),
  inscricaoImobiliaria: v.optional(v.string()),
  matricula: v.optional(v.string()),
  iptu: v.optional(v.number()),
  condominio: v.optional(v.number()),
  bundeslandCode: v.optional(v.enum_(DEState)),
  krCode: v.optional(v.enum_(KRRegion)),
  jibeonNumber: v.optional(v.string()),
  jaesanSe: v.optional(v.number()),
  gwanlibi: v.optional(v.number()),
  inCode: v.optional(v.enum_(INState)),
  surveyNumber: v.optional(v.string()),
  khataNumber: v.optional(v.string()),
  maintenanceCharges: v.optional(v.number()),
  ...
  itCode: v.optional(v.enum_(ITRegion)),
  codiceFiscale: v.optional(v.string()),
  particellaEdificale: v.optional(v.string()),
  foglio: v.optional(v.string()),
  subalterno: v.optional(v.string()),
  renditaCatastale: v.optional(v.number()),
  categoriaCalastale: v.optional(v.string()),
  classeEnergetica: v.optional(v.string()),
  apeRating: v.optional(v.string()),
  apeScore: v.optional(v.number()),
  apeValidUntil: v.optional(v.string()),
  imu: v.optional(v.number()),
  tari: v.optional(v.number()),
  tasi: v.optional(v.number()),
  condominioSpese: v.optional(v.number()),
  piano: v.optional(v.number()),
  pianiFuoriTerra: v.optional(v.number()),
  pianiInterrati: v.optional(v.number()),
  ascensore: v.optional(v.boolean()),
  montacarichi: v.optional(v.boolean()),
  terrazzo: v.optional(v.boolean()),
  balcone: v.optional(v.boolean()),
  giardino: v.optional(v.boolean()),
  cantina: v.optional(v.boolean()),
  soffitta: v.optional(v.boolean()),
  taverna: v.optional(v.boolean()),
  postoAuto: v.optional(v.boolean()),
  boxAuto: v.optional(v.boolean()),
  arredato: v.optional(v.boolean()),
  cucina: v.optional(v.boolean()),
  riscaldamento: v.optional(v.string()),
  condizionamento: v.optional(v.boolean()),
  esposizione: v.optional(v.string()),
  arCode: v.optional(v.enum_(ARProvince)),
  partida: v.optional(v.string()),
  escritura: v.optional(v.string()),
  abl: v.optional(v.number()),
  expensas: v.optional(v.number()),
  cityCode: v.optional(v.enum_(TRCity)),
  tapuNo: v.optional(v.string()),
  adaNo: v.optional(v.string()),
  parselNo: v.optional(v.string()),
  paftaNo: v.optional(v.string()),
  katIrtifaki: v.optional(v.boolean()),
  imarDurumu: v.optional(v.string()),
  imar: v.optional(v.enum_(TRZoningType)),
  iskanRuhsatiNo: v.optional(v.string()),
  iskanRuhsatiTarihi: v.optional(v.string()),
  yapiRuhsatiNo: v.optional(v.string()),
  yapiRuhsatiTarihi: v.optional(v.string()),
  depremBolgesi: v.optional(v.enum_(TREarthquakeZone)),
  depremYonetmeligi: v.optional(v.string()),
  zeminsIncelemeRaporu: v.optional(v.boolean()),
  aidat: v.optional(v.number()),
  aidatTipi: v.optional(v.string()),
  tapu_tasinmaz_tipi: v.optional(v.string()),
  emlakVergisiNo: v.optional(v.string()),
  cevreTemizlikVergisi: v.optional(v.number()),
  belediye: v.optional(v.string()),
  mahalle: v.optional(v.string()),
  cadde: v.optional(v.string()),
  sokak: v.optional(v.string()),
  binaNo: v.optional(v.string()),
  daireNo: v.optional(v.string()),
  kat: v.optional(v.number()),
  toplamKat: v.optional(v.number()),
  asansorSayisi: v.optional(v.number()),
  otopark: v.optional(v.boolean()),
  otoparkKapasitesi: v.optional(v.number()),
  havuz: v.optional(v.boolean()),
  sauna: v.optional(v.boolean()),
  spor_salonu: v.optional(v.boolean()),
  guvenlik: v.optional(v.boolean()),
  kamera_sistemi: v.optional(v.boolean()),
  jenerator: v.optional(v.boolean()),
  isitma_sistemi: v.optional(v.enum_(TRHeatingType)),
  teras: v.optional(v.boolean()),
  bahce: v.optional(v.boolean()),
  mobilyali: v.optional(v.boolean()),
  esyali: v.optional(v.boolean()),
  kullanim_durumu: v.optional(v.string()),
  tapu_durumu: v.optional(v.string()),
  krediye_uygun: v.optional(v.boolean()),
  takas: v.optional(v.boolean()),
  site_ici: v.optional(v.boolean()),
  unitId: v.optional(v.string()),
  balkonTipi: v.optional(v.string()),
  katKategorisi: v.optional(v.string()),
  cnCode: v.optional(v.enum_(CNProvince)),
  propertyNumber: v.optional(v.string()),
  managementFee: v.optional(v.number()),
  deedTax: v.optional(v.number()),
  sgCode: v.optional(v.enum_(SGRegion)),
  maintenanceFee: v.optional(v.number()),
  thCode: v.optional(v.enum_(THRegion)),
  landTax: v.optional(v.number()),
  commonFee: v.optional(v.number()),
  myCode: v.optional(v.enum_(MYState)),
  quitRent: v.optional(v.number()),
  assessmentTax: v.optional(v.number())
}));
...
// ListingStatusHistory Schemas (BASE)
...
// GovernmentIntegration Schemas (BASE)
...
// HomeInformationPack Schemas (BASE)
...
// DepositProtection Schemas (BASE)
...
// SolicitorManagement Schemas (BASE)
...
// ExternalRentalListing Schemas (BASE)
...
// VacationRentalPlatform Schemas (BASE)
...
// MlsListingEnhancement Schemas (BASE)
...
// InvestorPortfolio Schemas (BASE)
...
// PropertyValuation Schemas (BASE)
...
// ClientRelationship Schemas (BASE)
...
// TenantApplication Schemas (BASE)
...
// MaintenanceWorkOrder Schemas (BASE)
...
// UserFinancialProfile Schemas (BASE)
...
// MarketingCampaign Schemas (BASE)
...
// MLSExternalListing Schemas (BASE)
...
// PropertyCompliance Schemas (BASE)
...
// RecommendationResult Schemas (BASE)
...
// CommunicationTemplate Schemas (BASE)
...
// PropertyInventory Schemas (BASE)
...
// SecurityDepositProtection Schemas (BASE)
...
// PropertyDisclosure Schemas (BASE)
...
// ImmigrationStatusCheck Schemas (BASE)
...
// AttorneyManagement Schemas (BASE)
...
// MortgagePreApproval Schemas (BASE)
...
// AIModelDeployment Schemas (BASE)
...
// QueueConfiguration Schemas (BASE)
...
// AutomationExecution Schemas (BASE)
...
// AIPropertyValuation Schemas (BASE)
...
// AIPropertyDescription Schemas (BASE)
...
// AIPriceOptimization Schemas (BASE)
...
// AISentimentAnalysis Schemas (BASE)
...
// AIPredictiveMaintenance Schemas (BASE)
...
// AITenantScreening Schemas (BASE)
...
// AIInvestmentAnalysis Schemas (BASE)
...
// DashboardConfiguration Schemas (BASE)
...
// PaymentNegotiation Schemas (BASE)
...
// PaymentInstallment Schemas (BASE)
...
// AmbassadorContract Schemas (BASE)
...
// AmbassadorCampaign Schemas (BASE)
...
// SocialImpactCounter Schemas (BASE)
...
// SocialImpactRecord Schemas (BASE)
...
// SocialAccount Schemas (BASE)
export const socialAccountCreateSchema = v.object({
  orgId: v.string(),
  platform: v.enum_(SocialPlatform),
  accountId: v.string(),
...
export const socialAccountUpdateSchema = v.partial(v.object({
  orgId: v.optional(v.string()),
  platform: v.optional(v.enum_(SocialPlatform)),
  accountId: v.optional(v.string()),
  accountName: v.optional(v.string()),
  accessToken: v.optional(v.string()),
  accessTokenExpiry: v.optional(v.string()),
...
export const socialPostUpdateSchema = v.partial(v.object({
  ...
  platform: v.optional(v.enum_(SocialPlatform)),
  postType: v.optional(v.enum_(SocialPostType)),
  status: v.optional(v.enum_(SocialPostStatus)),
  content: v.optional(v.string()),
  mediaUrls: v.optional(v.string()),
...
// SocialAIContent Schemas (BASE)
export const socialAIContentCreateSchema = v.object({
  orgId: v.string(),
  contentType: v.enum_(AIContentType),
  prompt: v.string(),
  generatedText: v.string(),
  generatedHashtags: v.string()
});

export const socialAIContentUpdateSchema = v.partial(v.object({
  orgId: v.optional(v.string()),
  listingId: v.optional(v.string()),
  contentType: v.optional(v.enum_(AIContentType)),
  prompt: v.optional(v.string()),
  generatedText: v.optional(v.string()),
  generatedHashtags: v.optional(v.string()),
...
// SocialInboundMessage Schemas (BASE)
export const socialInboundMessageCreateSchema = v.object({
  orgId: v.string(),
  socialAccountId: v.string(),
  externalMessageId: v.string(),
  externalSenderId: v.string(),
  channel: v.enum_(InboundChannel),
...
export const socialInboundMessageUpdateSchema = v.partial(v.object({
  ...
  senderProfileUrl: v.optional(v.string()),
  channel: v.optional(v.enum_(InboundChannel)),
  messageText: v.optional(v.string()),
  mediaUrls: v.optional(v.string()),
  sentiment: v.optional(v.enum_(MessageSentiment)),
  intent: v.optional(v.string()),
  status: v.optional(v.enum_(InboundMessageStatus)),
  isLeadConverted: v.optional(v.boolean()),
  leadId: v.optional(v.string()),
...
export const socialCommentReplyUpdateSchema = v.partial(v.object({
  ...
  replySource: v.optional(v.enum_(ReplySource)),
  aiContentId: v.optional(v.string()),
  repliedByUserId: v.optional(v.string()),
  externalReplyId: v.optional(v.string()),
  sentAt: v.optional(v.string()),
  failureReason: v.optional(v.string())
}));
...
// SocialAutomationRule Schemas (BASE)
export const socialAutomationRuleCreateSchema = v.object({
  orgId: v.string(),
  socialAccountId: v.string(),
  name: v.string(),
  triggerType: v.enum_(AutomationTrigger),
  keywords: v.string(),
  action: v.enum_(AutomationAction)
});
...
export const socialAutomationRuleUpdateSchema = v.partial(v.object({
  ...
  socialAccountId: v.optional(v.string()),
  name: v.optional(v.string()),
  triggerType: v.optional(v.enum_(AutomationTrigger)),
  keywords: v.optional(v.string()),
  action: v.optional(v.enum_(AutomationAction)),
...
// SocialAccountMetric Schemas (BASE)
...
// EscrowStatusHistory Schemas (BASE)
...
export const paymentUpdateSchema = v.partial(v.object({
  ...
  reference: v.optional(v.string()),
  notes: v.optional(v.string()),
  obPaymentId: v.optional(v.string()),
  obConsentId: v.optional(v.string()),
  obBankId: v.optional(v.string()),
  obStatus: v.optional(v.string()),
  obError: v.optional(v.string()),
  gatewayName: v.optional(v.string()),
  gatewayTransactionId: v.optional(v.string()),
  gatewayAuthCode: v.optional(v.string()),
  cardLastFour: v.optional(v.string()),
  cardBrand: v.optional(v.string()),
  installmentCount: v.optional(v.number()),
  gatewayStatus: v.optional(v.string()),
  isSplitPayment: v.optional(v.boolean()),
  subMerchantId: v.optional(v.string()),
  propertyId: v.optional(v.string()),
...
// PropertyPromotion Schemas (BASE)
...
export const tenantUpdateSchema = v.partial(v.object({
  ...
  professionCategory: v.optional(v.string()),
  paymentMethod: v.optional(v.string()),
  paymentHistoryScore: v.optional(v.number()),
  depositStatus: v.optional(v.string()),
  escrowScore: v.optional(v.number()),
  overallScore: v.optional(v.number()),
  riskLevel: v.optional(v.string()),
  annualPayment: v.optional(v.boolean()),
  commissionHistory: v.optional(v.unknown())
}));
...
// PropertyOwnershipVerification Schemas (BASE)
...
// OwnershipVerificationDocument Schemas (BASE)
...
// PropertyOwnershipTransfer Schemas (BASE)
...
// BookingSecurityScreening Schemas (BASE)
...
// VideoVendorPartnership Schemas (BASE)
...
// PartnershipEarning Schemas (BASE)
...
// VideoQualityReview Schemas (BASE)
...
// VendorQualityReview Schemas (BASE)
...
// UserValuationPreference Schemas (BASE)
...
// GlobalTaxRegulation Schemas (BASE)
...
// MarketRateComparison Schemas (BASE)
...
// PlatformRevenueRecord Schemas (BASE)
...
// AiVideoGeneration Schemas (BASE)
...
// AiBrochureGeneration Schemas (BASE)
...
// CategoryTranslation Schemas (BASE)
...
// USPublicTaxRecord Schemas (BASE)
export const uSPublicTaxRecordCreateSchema = v.object({
  orgId: v.string(),
  parcelNumber: v.string(),
  taxYear: v.number()
});
...
export const uSPublicTaxRecordUpdateSchema = v.partial(v.object({
  ...
  levyCode: v.optional(v.string()),
  totalAssessedValue: v.optional(v.number()),
  landAssessedValue: v.optional(v.number()),
  improvementValue: v.optional(v.number()),
  totalTaxAmount: v.optional(v.number()),
  regularLevyAmount: v.optional(v.number()),
  voterApprovedAmount: v.optional(v.number()),
  excessLevyAmount: v.optional(v.number()),
  stateTaxAmount: v.optional(v.number()),
  seniorExemption: v.optional(v.boolean()),
  exemptionAmount: v.optional(v.number()),
  paymentStatus: v.optional(v.string()),
  firstHalfDueDate: v.optional(v.string()),
  secondHalfDueDate: v.optional(v.string()),
  firstHalfPaid: v.optional(v.number()),
  secondHalfPaid: v.optional(v.number()),
  delinquentAmount: v.optional(v.number()),
...
// USPropertyAssessment Schemas (BASE)
export const uSPropertyAssessmentCreateSchema = v.object({
  orgId: v.string(),
  parcelNumber: v.string(),
  assessmentYear: v.number()
});
...
export const uSPropertyAssessmentUpdateSchema = v.partial(v.object({
  ...
  stateName: v.optional(v.string()),
  districtName: v.optional(v.string()),
  propertyUseCode: v.optional(v.string()),
  propertyUseDesc: v.optional(v.string()),
  presentUse: v.optional(v.enum_(USPresentUse)),
  legalDescription: v.optional(v.string()),
  platName: v.optional(v.string()),
  platBlock: v.optional(v.string()),
  platLot: v.optional(v.string()),
  ...
  totalRooms: v.optional(v.number()),
  garageType: v.optional(v.string()),
  garageSqFt: v.optional(v.number()),
  basementType: v.optional(v.string()),
  basementSqFt: v.optional(v.number()),
  condition: v.optional(v.string()),
  constructionClass: v.optional(v.string()),
  roofType: v.optional(v.string()),
  heatingSystem: v.optional(v.string()),
  viewType: v.optional(v.string()),
  waterfrontFootage: v.optional(v.number()),
  landValue: v.optional(v.number()),
  improvementValue: v.optional(v.number()),
  totalValue: v.optional(v.number()),
  appraisedLandValue: v.optional(v.number()),
  appraisedImprValue: v.optional(v.number()),
  appraisedTotalValue: v.optional(v.number()),
  saleDate: v.optional(v.string()),
  salePrice: v.optional(v.number()),
  saleInstrument: v.optional(v.string()),
...
// UKPropertyCertificateRecord Schemas (BASE)
export const uKPropertyCertificateRecordCreateSchema = v.object({
  orgId: v.string(),
  propertyId: v.string(),
  certificateType: v.enum_(UKPropertyCertificate)
});

export const uKPropertyCertificateRecordUpdateSchema = v.partial(v.object({
  orgId: v.optional(v.string()),
  propertyId: v.optional(v.string()),
  certificateType: v.optional(v.enum_(UKPropertyCertificate)),
  certificateNumber: v.optional(v.string()),
  issueDate: v.optional(v.string()),
  expiryDate: v.optional(v.string()),
  inspectorName: v.optional(v.string()),
  inspectorCompany: v.optional(v.string()),
...
// TRPropertyDocumentRecord Schemas (BASE)
export const tRPropertyDocumentRecordCreateSchema = v.object({
  orgId: v.string(),
  propertyId: v.string(),
  documentType: v.enum_(TRPropertyDocument)
});

export const tRPropertyDocumentRecordUpdateSchema = v.partial(v.object({
  orgId: v.optional(v.string()),
  propertyId: v.optional(v.string()),
  documentType: v.optional(v.enum_(TRPropertyDocument)),
  documentNumber: v.optional(v.string()),
  issueDate: v.optional(v.string()),
  expiryDate: v.optional(v.string()),
...
// TRTaxDeclaration Schemas (BASE)
export const tRTaxDeclarationCreateSchema = v.object({
  orgId: v.string(),
  taxYear: v.number(),
  declarationType: v.enum_(TRTaxForm)
});
...
export const tRTaxDeclarationUpdateSchema = v.partial(v.object({
  ...
  propertyId: v.optional(v.string()),
  taxYear: v.optional(v.number()),
  declarationType: v.optional(v.enum_(TRTaxForm)),
  declarationNumber: v.optional(v.string()),
  filingDate: v.optional(v.string()),
  taxAmount: v.optional(v.number()),
  taxPaid: v.optional(v.number()),
  taxPending: v.optional(v.number()),
  rentalIncome: v.optional(v.number()),
  deductions: v.optional(v.number()),
  netIncome: v.optional(v.number()),
  vergiDairesi: v.optional(v.string()),
  vergiNo: v.optional(v.string()),
  documentUrl: v.optional(v.string()),
  notes: v.optional(v.string()),
  status: v.optional(v.string())
}));
...
// GuestVerification Schemas (BASE)
export const guestVerificationCreateSchema = v.object({
  orgId: v.string(),
  contactId: v.string(),
  stageProgress: v.unknown()
});
...
export const guestVerificationUpdateSchema = v.partial(v.object({
  ...
  contactId: v.optional(v.string()),
  bookingId: v.optional(v.string()),
  currentStage: v.optional(v.enum_(VerificationStage)),
  stageProgress: v.optional(v.unknown()),
  organizationId: v.optional(v.string())
}));
...
// TenantVerificationStage Schemas (BASE)
export const tenantVerificationStageCreateSchema = v.object({
  orgId: v.string(),
  contactId: v.string(),
  stage: v.enum_(VerificationStage),
  requiredCriteria: v.unknown(),
  completedCriteria: v.unknown()
});

export const tenantVerificationStageUpdateSchema = v.partial(v.object({
  orgId: v.optional(v.string()),
  contactId: v.optional(v.string()),
  stage: v.optional(v.enum_(VerificationStage)),
  status: v.optional(v.enum_(VerificationStatus)),
  requiredCriteria: v.optional(v.unknown()),
  completedCriteria: v.optional(v.unknown()),
  timeToComplete: v.optional(v.string()),
  startedAt: v.optional(v.string()),
  completedAt: v.optional(v.string()),
  conversionGate: v.optional(v.boolean()),
  notes: v.optional(v.string())
}));
...
// SecurityIncident Schemas (BASE)
export const securityIncidentCreateSchema = v.object({
  orgId: v.string(),
  propertyId: v.string(),
  incidentType: v.enum_(SecurityIncidentType),
  description: v.string(),
  reportedBy: v.string()
});
...
export const securityIncidentUpdateSchema = v.partial(v.object({
  ...
  bookingId: v.optional(v.string()),
  contactId: v.optional(v.string()),
  incidentType: v.optional(v.enum_(SecurityIncidentType)),
  severity: v.optional(v.enum_(SecurityIncidentSeverity)),
  status: v.optional(v.enum_(SecurityIncidentStatus)),
  description: v.optional(v.string()),
  location: v.optional(v.string()),
  reportedBy: v.optional(v.string()),
  reportedAt: v.optional(v.string()),
  ...
  propertyDamage: v.optional(v.number()),
  fineAmount: v.optional(v.number()),
  fineCurrency: v.optional(v.string()),
  followUpRequired: v.optional(v.boolean()),
...
// OperatorLicense Schemas (BASE)
export const operatorLicenseCreateSchema = v.object({
  orgId: v.string(),
  operatorOrgId: v.string(),
  licenseNumber: v.string(),
  licenseType: v.string(),
  issuingAuthority: v.string(),
  issuedAt: v.string(),
  expiresAt: v.string(),
  serviceAreas: v.unknown()
});

export const operatorLicenseUpdateSchema = v.partial(v.object({
  orgId: v.optional(v.string()),
  operatorOrgId: v.optional(v.string()),
  licenseNumber: v.optional(v.string()),
  licenseType: v.optional(v.string()),
  issuingAuthority: v.optional(v.string()),
  issuedAt: v.optional(v.string()),
  expiresAt: v.optional(v.string()),
  status: v.optional(v.enum_(OperatorLicenseStatus)),
  serviceAreas: v.optional(v.unknown()),
  maxProperties: v.optional(v.number()),
  insuranceRequired: v.optional(v.boolean()),
  insuranceAmount: v.optional(v.number()),
  insuranceProvider: v.optional(v.string()),
  insuranceExpiresAt: v.optional(v.string()),
  backgroundCheckPassed: v.optional(v.boolean()),
  complianceScore: v.optional(v.number()),
  verifiedBy: v.optional(v.string()),
  verifiedAt: v.optional(v.string()),
  documents: v.optional(v.unknown()),
  notes: v.optional(v.string())
}));
...
// TenantReliabilityScore Schemas (BASE)
export const tenantReliabilityScoreCreateSchema = v.object({
  orgId: v.string(),
  contactId: v.string(),
  overallScore: v.number(),
  tier: v.enum_(ReliabilityTier),
  identityScore: v.number(),
  financialScore: v.number(),
  behavioralScore: v.number(),
  socialScore: v.number(),
  completedCriteria: v.string(),
  weightedCriteria: v.unknown()
});
...
export const tenantReliabilityScoreUpdateSchema = v.partial(v.object({
  ...
  contactId: v.optional(v.string()),
  overallScore: v.optional(v.number()),
  tier: v.optional(v.enum_(ReliabilityTier)),
  ...
  completedCriteria: v.optional(v.string()),
  weightedCriteria: v.optional(v.unknown()),
  organizationId: v.optional(v.string())
}));
...
export const propertySecurityConfigUpdateSchema = v.partial(v.object({
  ...
  minimumNights: v.optional(v.number()),
  peakSeasonNights: v.optional(v.number()),
  holidayNights: v.optional(v.number()),
  priceMultiplier: v.optional(v.number()),
  priceFloor: v.optional(v.number()),
  licensedOperatorOnly: v.optional(v.boolean()),
  minimumInsuranceAmount: v.optional(v.number()),
  requireBackgroundCheck: v.optional(v.boolean()),
  requireGovernmentId: v.optional(v.boolean()),
  minimumRating: v.optional(v.number()),
  separateEntrance: v.optional(v.boolean()),
  smartElevator: v.optional(v.boolean()),
  wristbandSystem: v.optional(v.boolean()),
  checkInProtocol: v.optional(v.string()),
  noiseMonitoringEnabled: v.optional(v.boolean()),
  noiseLimitDb: v.optional(v.number()),
  quietHoursStart: v.optional(v.string()),
  quietHoursEnd: v.optional(v.string()),
  enforcementEnabled: v.optional(v.boolean()),
  threeStrikePolicy: v.optional(v.boolean()),
  firstStrikeFine: v.optional(v.number()),
  secondStrikeFine: v.optional(v.number()),
  thirdStrikeBan: v.optional(v.boolean()),
  regionalOverrides: v.optional(v.unknown()),
  lastAuditAt: v.optional(v.string()),
...
// ContractTransition Schemas (BASE)
...
// ListingDistribution Schemas (BASE)
...
// ReputationDecayLog Schemas (BASE)
...
// DemandGenerationLog Schemas (BASE)
...
// AgentEscrowWallet Schemas (BASE)
...
// AgentEscrowTransaction Schemas (BASE)
...
// EscrowSplitConfig Schemas (BASE)
...
// HotelProviderMapping Schemas (BASE)
...
// PropertyTrustScore Schemas (BASE)
...
// PaymentRoutingLog Schemas (BASE)
...
// BookingFailoverEvent Schemas (BASE)
...
// ExperienceBooking Schemas (BASE)
...
// AIKnowledgeArticle Schemas (BASE)
...
// UserRevenueProfile Schemas (BASE)
