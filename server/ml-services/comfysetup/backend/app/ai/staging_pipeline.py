...
class StagingPipeline:
    ...
    STAGING_PROMPTS = {
        ...
        "industrial": {
            "living_room": "industrial loft living room, exposed brick wall, black leather chesterfield sofa, reclaimed wood coffee table, metal accents, Edison bulb pendant lights, urban aesthetic",
        ...
        "mid-century-modern": {
            "living_room": "mid-century modern living room, teak sideboard, mustard velvet armchair, tapered legs, geometric rug, arc floor lamp, retro patterns",
        ...
        "contemporary": {
            "living_room": "contemporary living room, modular sofa, bold statement art, track lighting, mixed textures, blue and grey accents, architectural elements",
        ...
        "bohemian": {
            "living_room": "bohemian living room, eclectic patterns, layered textiles, rattan furniture, macrame, indoor plants, colorful cushions, global influences",
