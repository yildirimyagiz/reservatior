...
export const DomainEvents = {
  ...
  BUNDLE_UPDATED: 'commerce.bundle.updated',
  CAMPAIGN_CREATED: 'commerce.campaign.created',
  CAMPAIGN_ACTIVATED: 'commerce.campaign.activated',
  CAMPAIGN_PAUSED: 'commerce.campaign.paused',
  CAMPAIGN_COMPLETED: 'commerce.campaign.completed',
  SUPPLIER_ONBOARDED_COMMERCE: 'commerce.supplier.onboarded',
  SUPPLIER_STATUS_CHANGED: 'commerce.supplier.status.changed',
  COMMISSION_CALCULATED: 'commerce.commission.calculated',
  COMMISSION_PAID_COMMERCE: 'commerce.commission.paid',
  ...
  CRM_LEAD_UNQUALIFIED: 'crm.lead.unqualified',
  CRM_LEAD_CONVERTED: 'crm.lead.converted',
  CRM_LEAD_SCORED: 'crm.lead.scored',
  ...
  CRM_INTERACTION_RECORDED: 'crm.interaction.recorded',
  CRM_PIPELINE_UPDATED: 'crm.pipeline.updated',
  CRM_CAMPAIGN_LAUNCHED: 'crm.campaign.launched',
  CRM_SEGMENT_CREATED: 'crm.segment.created',
  CRM_FOLLOWUP_SCHEDULED: 'crm.followup.scheduled',
  CRM_FOLLOWUP_COMPLETED: 'crm.followup.completed',

  // Portfolio OS
  PORTFOLIO_CREATED: 'portfolio.created',
  PORTFOLIO_UPDATED: 'portfolio.updated',
  PORTFOLIO_HOLDING_ADDED: 'portfolio.holding.added',
  PORTFOLIO_HOLDING_REMOVED: 'portfolio.holding.removed',
  PORTFOLIO_REBALANCED: 'portfolio.rebalanced',
  PORTFOLIO_VALUATION_UPDATED: 'portfolio.valuation.updated',
  REO_PROPERTY_ACQUIRED: 'portfolio.reo.acquired',
  REO_PROPERTY_LISTED: 'portfolio.reo.listed',
  REO_PROPERTY_SOLD: 'portfolio.reo.sold',
  REO_PROPERTY_WRITEOFF: 'portfolio.reo.writeoff',
  VALUATION_REQUESTED: 'portfolio.valuation.requested',
  VALUATION_COMPLETED: 'portfolio.valuation.completed',
  VALUATION_DISPUTED: 'portfolio.valuation.disputed',
  PORTFOLIO_REPORT_GENERATED: 'portfolio.report.generated',
  ...
  PLATFORM_FEATURE_FLAG_TOGGLED: 'platform.feature.flag.toggled',
  PLATFORM_FEATURE_FLAG_CREATED: 'platform.feature.flag.created',
  PLATFORM_MAINTENANCE_STARTED: 'platform.maintenance.started',
  PLATFORM_MAINTENANCE_COMPLETED: 'platform.maintenance.completed',
  PLATFORM_DEPLOY_TRIGGERED: 'platform.deploy.triggered',
  PLATFORM_DEPLOY_COMPLETED: 'platform.deploy.completed',
  PLATFORM_DEPLOY_FAILED: 'platform.deploy.failed',
  PLATFORM_SCALE_UP: 'platform.scale.up',
  PLATFORM_SCALE_DOWN: 'platform.scale.down',
