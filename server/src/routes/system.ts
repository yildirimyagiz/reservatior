...
export const systemRoutes = new Elysia({ prefix: "/system" })
  ...
  .get("/automation-executions", async ({ orgId, db, query }) => {
  ...
  .get("/automation-executions/:id", async ({ orgId, db, params, set }) => {
  ...
  .get("/automation-tasks", async ({ orgId, db, query }) => {
  ...
  .get("/tasks", async ({ orgId, db, query }) => {
    const {
      orgId,
      assignedToUserId,
      status,
  ...
  .get("/tasks/:id", async ({ orgId, db, params, set }) => {
  ...
  .delete("/tasks/:id", async ({ orgId, db, params }) => {
  ...
  .get("/languages", async ({ orgId, db, query }) => {
  ...
  .get("/languages/:id", async ({ orgId, db, params, set }) => {
  ...
  .delete("/languages/:id", async ({ orgId, db, params }) => {
  ...
  .get("/health", async ({ orgId, db, query }) => {
  ...
  .get("/health/:id", async ({ orgId, db, params, set }) => {
