...
export const aiRoutes = new Elysia({ prefix: "/ai" })
  ...
  // GET /ai/sessions
  .get("/sessions", async ({ orgId, db, query }) => {
  ...
  .get("/sessions/:sessionId", async ({ orgId, db, params, set }) => {
  ...
  .get("/sessions/:sessionId/messages", async ({ orgId, db, params }) => {
  ...
  .post(
    ...
    async ({ orgId, db, params, body, set }) => {
  ...
  // GET /ai/valuations
  .get("/valuations", async ({ orgId, db, query }) => {
  ...
  .get("/price-optimizations", async ({ orgId, db, query }) => {
  ...
  .patch("/price-optimizations/:id/apply", async ({ orgId, db, params }) => {
  ...
  // GET /ai/lead-scores
  .get("/lead-scores", async ({ orgId, db, query }) => {
  ...
  .get("/market-analyses", async ({ orgId, db, query }) => {
  ...
  .get("/fraud-detections", async ({ orgId, db, query }) => {
  ...
  .get("/recommendations", async ({ orgId, db, query }) => {
  ...
  .get("/predictive-maintenance", async ({ orgId, db, query }) => {
  ...
  .get("/models", async ({ orgId, db, query }) => {
  ...
  .post("/models", async ({ orgId, db, body, set }) => {
  ...
  .get("/models/:id", async ({ orgId, db, params, set }) => {
  ...
  .patch("/models/:id", async ({ orgId, db, params, body }) => {
  ...
  .delete("/models/:id", async ({ orgId, db, params }) => {
  ...
  .get("/deployments", async ({ orgId, db, query }) => {
  ...
  .post("/deployments", async ({ orgId, db, body, set }) => {
  ...
  .get("/deployments/:id", async ({ orgId, db, params, set }) => {
  ...
  .patch("/deployments/:id", async ({ orgId, db, params, body }) => {
  ...
  .get("/predictions", async ({ orgId, db, query }) => {
  ...
  .post("/predictions", async ({ orgId, db, body, set }) => {
  ...
  .get("/image-analyses", async ({ orgId, db, query }) => {
  ...
  .post("/image-analyses", async ({ orgId, db, body, set }) => {
  ...
  .get("/image-analyses/:id", async ({ orgId, db, params, set }) => {
  ...
  .get("/lead-scoring-models", async ({ orgId, db, query }) => {
  ...
  .post("/lead-scoring-models", async ({ orgId, db, body, set }) => {
  ...
  .get("/lead-scoring-models/:id", async ({ orgId, db, params, set }) => {
  ...
  .patch("/lead-scoring-models/:id", async ({ orgId, db, params, body }) => {
  ...
  .get("/property-descriptions", async ({ orgId, db, query }) => {
  ...
  .post("/property-descriptions", async ({ orgId, db, body, set }) => {
  ...
  .patch("/property-descriptions/:id", async ({ orgId, db, params, body }) => {
  ...
  .get("/valuation-models", async ({ orgId, db, query }) => {
    const { orgId, isActive } = query as any;
    const where: any = {};
    if (orgId) where.orgId = orgId;
    if (isActive !== undefined) where.isActive = isActive === "true";
  ...
  .post("/valuation-models", async ({ orgId, db, body, set }) => {
  ...
  .patch("/valuation-models/:id", async ({ orgId, db, params, body }) => {
  ...
  .put("/ml-config", async ({ orgId, db, body }) => {
  ...
  .get("/ml-models", async ({ orgId, db, query }) => {
  ...
  .post("/ml-models", async ({ orgId, db, body, set }) => {
  ...
  .patch("/ml-models/:id", async ({ orgId, db, params, body }) => {
  ...
  .get("/predictive-models", async ({ orgId, db, query }) => {
  ...
  .post("/predictive-models", async ({ orgId, db, body, set }) => {
  ...
  .patch("/predictive-models/:id", async ({ orgId, db, params, body }) => {
  ...
  .delete("/predictive-models/:id", async ({ orgId, db, params }) => {
  ...
  .post("/gemini-hub", async ({ orgId, db, body, user }) => {
  ...
  .post("/translate", async ({ orgId, db, body, set }) => {
  ...
  .post("/supercharge/staging", async ({ orgId, db, body }) => {
  ...
  .post("/supercharge/reels", async ({ orgId, db, body }) => {
  ...
  .get("/supercharge/tasks/:taskId", async ({ orgId, db, params, set }) => {
  ...
  .get("/supercharge/property/:propertyId/latest", async ({ orgId, db, params }) => {
  ...
  .post("/concierge", async ({ orgId, db, body, set }) => {
    try {
