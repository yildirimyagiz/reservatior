...
export const hoaRoutes = new Elysia({ prefix: "/hoa" })
  ...
  // ── SharedAmenity ─────────────────────────────────────────────────────────────
  .get("/amenities", async ({ orgId, db, query, set }) => {
    try {
  ...
  .post("/amenities", async ({ orgId, db, body, set }) => {
    try {
  ...
  .get("/amenities/:id", async ({ orgId, db, params, set }) => {
    try {
  ...
  .patch("/amenities/:id", async ({ orgId, db, params, body, set }) => {
    try {
  ...
  .delete("/amenities/:id", async ({ orgId, db, params, body, set }) => {
    try {
  ...
  // ── Facility ──────────────────────────────────────────────────────────────────
  .get("/facilities", async ({ orgId, db, query, set }) => {
    try {
  ...
  .post("/facilities", async ({ orgId, db, body, set }) => {
    try {
  ...
  .get("/facilities/:id", async ({ orgId, db, params, set }) => {
    try {
  ...
  .patch("/facilities/:id", async ({ orgId, db, params, body, set }) => {
    try {
  ...
  .delete("/facilities/:id", async ({ orgId, db, params, set }) => {
    try {
  ...
  // ── FacilityBlock ─────────────────────────────────────────────────────────────
  .get("/facility-blocks", async ({ orgId, db, query, set }) => {
    try {
  ...
  .post("/facility-blocks", async ({ orgId, db, body, set }) => {
    try {
  ...
  .get("/facility-blocks/:id", async ({ orgId, db, params, set }) => {
    try {
  ...
  .delete("/facility-blocks/:id", async ({ orgId, db, params, body, set }) => {
    try {
  ...
  .get("/increases", async ({ orgId, db, query, set }) => {
    try {
  ...
  .post("/increases", async ({ orgId, db, body, set }) => {
    try {
  ...
  .get("/increases/:id", async ({ orgId, db, params, set }) => {
    try {
  ...
  .patch("/increases/:id", async ({ orgId, db, params, body, set }) => {
    try {
  ...
  .delete("/increases/:id", async ({ orgId, db, params, set }) => {
    try {
  ...
  // ── Discount ──────────────────────────────────────────────────────────────────
  .get("/discounts", async ({ orgId, db, query, set }) => {
    try {
  ...
  .post("/discounts", async ({ orgId, db, body, set }) => {
    try {
  ...
  .get("/discounts/:id", async ({ orgId, db, params, set }) => {
    try {
  ...
  .patch("/discounts/:id", async ({ orgId, db, params, body, set }) => {
    try {
  ...
  .delete("/discounts/:id", async ({ orgId, db, params, set }) => {
    try {
  ...
  // ── GiftCard ──────────────────────────────────────────────────────────────────
  .get("/gift-cards", async ({ orgId, db, query, set }) => {
    try {
  ...
  .post("/gift-cards", async ({ orgId, db, body, set }) => {
    try {
  ...
  .get("/gift-cards/:id", async ({ orgId, db, params, set }) => {
    try {
  ...
  .patch("/gift-cards/:id", async ({ orgId, db, params, body, set }) => {
    try {
  ...
  .delete("/gift-cards/:id", async ({ orgId, db, params, body, set }) => {
    try {
