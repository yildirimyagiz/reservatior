...
export const adminRoutes = new Elysia({ prefix: "/admin" })
  ...
  .get("/plans", async ({ orgId, db, query }: { query: any }) => {
    const { 
      status, 
      minPrice, 
      maxPrice,
  ...
  .get("/plans/:id", async ({ orgId, db, params, set }: { params: any; set: any }) => {
  ...
  .post("/plans", async ({ orgId, db, body, set }: { body: any; set: any }) => {
  ...
  .patch("/admin/plans/:id", async ({ orgId, db, params, body, set }: { params: any; body: any; set: any }) => {
  ...
  .delete("/admin/plans/:id", async ({ orgId, db, params, set }: { params: any; set: any }) => {
    const plan = await prisma.plan.update({
      where: { id: params.id },
  ...
  .get("/subscriptions", async ({ orgId, db, query }: { query: any }) => {
    const { 
      orgId, 
      status, 
      planId,
  ...
  .get("/subscriptions/:id", async ({ orgId, db, params, set }: { params: any; set: any }) => {
  ...
  .post("/subscriptions", async ({ orgId, db, body, set }: { body: any; set: any }) => {
  ...
  .patch("/subscriptions/:id", async ({ orgId, db, params, body }: { params: any; body: any }) => {
  ...
  .post("/subscriptions/:id/cancel", async ({ orgId, db, params, body, set }: { params: any; body: any; set: any }) => {
  ...
  .get("/roles", async ({ orgId, db, query }: { query: any }) => {
    const { 
      orgId, 
      isSystem,
      sortBy = "createdAt",
  ...
  .get("/roles/:id", async ({ orgId, db, params, set }: { params: any; set: any }) => {
  ...
  .post("/roles", async ({ orgId, db, body, set }: { body: any; set: any }) => {
  ...
  .get("/permissions", async ({ orgId, db, query }: { query: any }) => {
  ...
  .post("/roles/:id/permissions", async ({ orgId, db, params, body, set }: { params: any; body: any; set: any }) => {
  ...
  .delete("/roles/:id/permissions/:permissionId", async ({ orgId, db, params }: { params: any }) => {
  ...
  .get("/jobs", async ({ orgId, db, query }: { query: any }) => {
    const { 
      orgId, 
      status, 
      type,
  ...
  .post("/jobs", async ({ orgId, db, body, set }: { body: any; set: any }) => {
  ...
  .patch("/jobs/:id", async ({ orgId, db, params, body }: { params: any; body: any }) => {
  ...
  .post("/jobs/:id/retry", async ({ orgId, db, params, set }: { params: any; set: any }) => {
    const job = await prisma.job.update({
      where: { id: params.id },
      data: {
        status: "PENDING",
  ...
  .get("/users", async ({ orgId, db, query }: { query: any }) => {
    const { 
      page = "1", 
      limit = "20", 
      search, 
  ...
  .get("/users/:userId", async ({ orgId, db, params, set }: { params: any; set: any }) => {
  ...
  .get("/analytics", async ({ orgId, db, query }: { query: any }) => {
  ...
  .get("/dashboard", async ({ orgId, db, query }: { query: any }) => {
  ...
  .get("/export", async ({ orgId, db, query, set }: { query: any; set: any }) => {
    const { 
      type = "users",
      status,
      role,
