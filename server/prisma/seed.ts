...
async function main() {
  ...
  // CountryConfig — 23 ülke (REGION_DB_MAP ile hizalı)
  const countryConfigs: Array<{ id: string; code: string; name: string; nativeName: string; currency: string; currencySymbol: string; language: string; timezone: string; dateFormat: string; numberFormat: string; taxRate: number | null; vatRate: number | null }> = [
    { id: id("country_us"), code: "US", name: "United States", nativeName: "United States", currency: "USD", currencySymbol: "$", language: "en", timezone: "America/New_York", dateFormat: "MM/DD/YYYY", numberFormat: "1,234.56", taxRate: 0.07, vatRate: null },
    { id: id("country_uk"), code: "UK", name: "United Kingdom", nativeName: "United Kingdom", currency: "GBP", currencySymbol: "£", language: "en", timezone: "Europe/London", dateFormat: "DD/MM/YYYY", numberFormat: "1,234.56", taxRate: 0.20, vatRate: 0.20 },
    { id: id("country_ca"), code: "CA", name: "Canada", nativeName: "Canada", currency: "CAD", currencySymbol: "CA$", language: "en", timezone: "America/Toronto", dateFormat: "MM/DD/YYYY", numberFormat: "1,234.56", taxRate: 0.13, vatRate: 0.05 },
    { id: id("country_mx"), code: "MX", name: "Mexico", nativeName: "México", currency: "MXN", currencySymbol: "MX$", language: "es", timezone: "America/Mexico_City", dateFormat: "DD/MM/YYYY", numberFormat: "1,234.56", taxRate: 0.16, vatRate: 0.16 },
    { id: id("country_br"), code: "BR", name: "Brazil", nativeName: "Brasil", currency: "BRL", currencySymbol: "R$", language: "pt", timezone: "America/Sao_Paulo", dateFormat: "DD/MM/YYYY", numberFormat: "1.234,56", taxRate: 0.12, vatRate: 0.12 },
    { id: id("country_ar"), code: "AR", name: "Argentina", nativeName: "Argentina", currency: "ARS", currencySymbol: "$", language: "es", timezone: "America/Argentina/Buenos_Aires", dateFormat: "DD/MM/YYYY", numberFormat: "1.234,56", taxRate: 0.21, vatRate: 0.21 },
    { id: id("country_de"), code: "DE", name: "Germany", nativeName: "Deutschland", currency: "EUR", currencySymbol: "€", language: "de", timezone: "Europe/Berlin", dateFormat: "DD.MM.YYYY", numberFormat: "1.234,56", taxRate: 0.19, vatRate: 0.19 },
    { id: id("country_fr"), code: "FR", name: "France", nativeName: "France", currency: "EUR", currencySymbol: "€", language: "fr", timezone: "Europe/Paris", dateFormat: "DD/MM/YYYY", numberFormat: "1 234,56", taxRate: 0.20, vatRate: 0.20 },
    { id: id("country_es"), code: "ES", name: "Spain", nativeName: "España", currency: "EUR", currencySymbol: "€", language: "es", timezone: "Europe/Madrid", dateFormat: "DD/MM/YYYY", numberFormat: "1.234,56", taxRate: 0.21, vatRate: 0.21 },
    { id: id("country_it"), code: "IT", name: "Italy", nativeName: "Italia", currency: "EUR", currencySymbol: "€", language: "it", timezone: "Europe/Rome", dateFormat: "DD/MM/YYYY", numberFormat: "1.234,56", taxRate: 0.22, vatRate: 0.22 },
    { id: id("country_nl"), code: "NL", name: "Netherlands", nativeName: "Nederland", currency: "EUR", currencySymbol: "€", language: "nl", timezone: "Europe/Amsterdam", dateFormat: "DD-MM-YYYY", numberFormat: "1.234,56", taxRate: 0.21, vatRate: 0.21 },
    { id: id("country_tr"), code: "TR", name: "Turkey", nativeName: "Türkiye", currency: "TRY", currencySymbol: "₺", language: "tr", timezone: "Europe/Istanbul", dateFormat: "DD.MM.YYYY", numberFormat: "1.234,56", taxRate: 0.20, vatRate: 0.20 },
    { id: id("country_au"), code: "AU", name: "Australia", nativeName: "Australia", currency: "AUD", currencySymbol: "A$", language: "en", timezone: "Australia/Sydney", dateFormat: "DD/MM/YYYY", numberFormat: "1,234.56", taxRate: 0.10, vatRate: 0.10 },
    { id: id("country_nz"), code: "NZ", name: "New Zealand", nativeName: "New Zealand", currency: "NZD", currencySymbol: "NZ$", language: "en", timezone: "Pacific/Auckland", dateFormat: "DD/MM/YYYY", numberFormat: "1,234.56", taxRate: 0.15, vatRate: 0.15 },
    { id: id("country_jp"), code: "JP", name: "Japan", nativeName: "日本", currency: "JPY", currencySymbol: "¥", language: "ja", timezone: "Asia/Tokyo", dateFormat: "YYYY/MM/DD", numberFormat: "1,234", taxRate: 0.10, vatRate: 0.10 },
    { id: id("country_kr"), code: "KR", name: "South Korea", nativeName: "대한민국", currency: "KRW", currencySymbol: "₩", language: "ko", timezone: "Asia/Seoul", dateFormat: "YYYY.MM.DD", numberFormat: "1,234", taxRate: 0.10, vatRate: 0.10 },
    { id: id("country_cn"), code: "CN", name: "China", nativeName: "中国", currency: "CNY", currencySymbol: "¥", language: "zh", timezone: "Asia/Shanghai", dateFormat: "YYYY/MM/DD", numberFormat: "1,234.56", taxRate: 0.13, vatRate: 0.13 },
    { id: id("country_in"), code: "IN", name: "India", nativeName: "भारत", currency: "INR", currencySymbol: "₹", language: "hi", timezone: "Asia/Kolkata", dateFormat: "DD/MM/YYYY", numberFormat: "1,234.56", taxRate: 0.18, vatRate: 0.18 },
    { id: id("country_sg"), code: "SG", name: "Singapore", nativeName: "Singapore", currency: "SGD", currencySymbol: "S$", language: "en", timezone: "Asia/Singapore", dateFormat: "DD/MM/YYYY", numberFormat: "1,234.56", taxRate: 0.09, vatRate: 0.09 },
    { id: id("country_my"), code: "MY", name: "Malaysia", nativeName: "Malaysia", currency: "MYR", currencySymbol: "RM", language: "en", timezone: "Asia/Kuala_Lumpur", dateFormat: "DD/MM/YYYY", numberFormat: "1,234.56", taxRate: 0.06, vatRate: 0.06 },
    { id: id("country_th"), code: "TH", name: "Thailand", nativeName: "ประเทศไทย", currency: "THB", currencySymbol: "฿", language: "th", timezone: "Asia/Bangkok", dateFormat: "DD/MM/YYYY", numberFormat: "1,234.56", taxRate: 0.07, vatRate: 0.07 },
    { id: id("country_ae"), code: "AE", name: "United Arab Emirates", nativeName: "الإمارات العربية المتحدة", currency: "AED", currencySymbol: "د.إ", language: "ar", timezone: "Asia/Dubai", dateFormat: "DD/MM/YYYY", numberFormat: "1,234.56", taxRate: 0.05, vatRate: 0.05 },
    { id: id("country_sa"), code: "SA", name: "Saudi Arabia", nativeName: "المملكة العربية السعودية", currency: "SAR", currencySymbol: "﷼", language: "ar", timezone: "Asia/Riyadh", dateFormat: "DD/MM/YYYY", numberFormat: "1,234.56", taxRate: 0.15, vatRate: 0.15 },
  ];
  await prisma.countryConfig.createMany({
    data: countryConfigs.map((c) => ({
      id: c.id,
      code: c.code,
      name: c.name,
  ...
  // CountryFintechConfig — 23 ülke (Property FK + /localization-os/countries)
  await prisma.countryFintechConfig.createMany({
    data: [
      { isoCode: "US", name: "United States", baseCurrency: "USD", requiresDepositEscrow: false, allowsDepositYield: true, maxRentInstallments: 1, allowsSalesCommissionInstallments: true, maxSalesCommissionInstallments: 12, maxSalesCommissionRateBps: 600, supportedGateways: [PaymentGatewayType.STRIPE, PaymentGatewayType.ACH_FEDNOW], kycStrictnessLevel: KYCStrictness.MODERATE },
      { isoCode: "UK", name: "United Kingdom", baseCurrency: "GBP", requiresDepositEscrow: true, allowsDepositYield: true, maxRentInstallments: 1, allowsSalesCommissionInstallments: true, maxSalesCommissionInstallments: 12, maxSalesCommissionRateBps: 600, supportedGateways: [PaymentGatewayType.STRIPE, PaymentGatewayType.OPEN_BANKING], kycStrictnessLevel: KYCStrictness.MODERATE },
      { isoCode: "CA", name: "Canada", baseCurrency: "CAD", requiresDepositEscrow: false, allowsDepositYield: true, maxRentInstallments: 1, allowsSalesCommissionInstallments: true, maxSalesCommissionInstallments: 12, maxSalesCommissionRateBps: 600, supportedGateways: [PaymentGatewayType.STRIPE, PaymentGatewayType.ACH_FEDNOW], kycStrictnessLevel: KYCStrictness.MODERATE },
      { isoCode: "MX", name: "Mexico", baseCurrency: "MXN", requiresDepositEscrow: false, allowsDepositYield: true, maxRentInstallments: 1, allowsSalesCommissionInstallments: true, maxSalesCommissionInstallments: 12, maxSalesCommissionRateBps: 600, supportedGateways: [PaymentGatewayType.STRIPE], kycStrictnessLevel: KYCStrictness.LIGHT },
      { isoCode: "BR", name: "Brazil", baseCurrency: "BRL", requiresDepositEscrow: false, allowsDepositYield: true, maxRentInstallments: 1, allowsSalesCommissionInstallments: true, maxSalesCommissionInstallments: 12, maxSalesCommissionRateBps: 600, supportedGateways: [PaymentGatewayType.STRIPE], kycStrictnessLevel: KYCStrictness.MODERATE },
      { isoCode: "AR", name: "Argentina", baseCurrency: "ARS", requiresDepositEscrow: false, allowsDepositYield: true, maxRentInstallments: 1, allowsSalesCommissionInstallments: true, maxSalesCommissionInstallments: 12, maxSalesCommissionRateBps: 600, supportedGateways: [PaymentGatewayType.STRIPE], kycStrictnessLevel: KYCStrictness.LIGHT },
      { isoCode: "DE", name: "Germany", baseCurrency: "EUR", requiresDepositEscrow: true, allowsDepositYield: true, maxRentInstallments: 1, allowsSalesCommissionInstallments: true, maxSalesCommissionInstallments: 12, maxSalesCommissionRateBps: 600, supportedGateways: [PaymentGatewayType.STRIPE, PaymentGatewayType.OPEN_BANKING], kycStrictnessLevel: KYCStrictness.MODERATE },
      { isoCode: "FR", name: "France", baseCurrency: "EUR", requiresDepositEscrow: true, allowsDepositYield: true, maxRentInstallments: 1, allowsSalesCommissionInstallments: true, maxSalesCommissionInstallments: 12, maxSalesCommissionRateBps: 600, supportedGateways: [PaymentGatewayType.STRIPE, PaymentGatewayType.OPEN_BANKING], kycStrictnessLevel: KYCStrictness.MODERATE },
      { isoCode: "ES", name: "Spain", baseCurrency: "EUR", requiresDepositEscrow: true, allowsDepositYield: true, maxRentInstallments: 1, allowsSalesCommissionInstallments: true, maxSalesCommissionInstallments: 12, maxSalesCommissionRateBps: 600, supportedGateways: [PaymentGatewayType.STRIPE, PaymentGatewayType.OPEN_BANKING], kycStrictnessLevel: KYCStrictness.MODERATE },
      { isoCode: "IT", name: "Italy", baseCurrency: "EUR", requiresDepositEscrow: true, allowsDepositYield: true, maxRentInstallments: 1, allowsSalesCommissionInstallments: true, maxSalesCommissionInstallments: 12, maxSalesCommissionRateBps: 600, supportedGateways: [PaymentGatewayType.STRIPE, PaymentGatewayType.OPEN_BANKING], kycStrictnessLevel: KYCStrictness.MODERATE },
      { isoCode: "NL", name: "Netherlands", baseCurrency: "EUR", requiresDepositEscrow: true, allowsDepositYield: true, maxRentInstallments: 1, allowsSalesCommissionInstallments: true, maxSalesCommissionInstallments: 12, maxSalesCommissionRateBps: 600, supportedGateways: [PaymentGatewayType.STRIPE, PaymentGatewayType.OPEN_BANKING], kycStrictnessLevel: KYCStrictness.MODERATE },
      { isoCode: "TR", name: "Turkey", baseCurrency: "TRY", requiresDepositEscrow: true, allowsDepositYield: true, maxRentInstallments: 1, allowsSalesCommissionInstallments: true, maxSalesCommissionInstallments: 12, maxSalesCommissionRateBps: 400, supportedGateways: [PaymentGatewayType.PAYTR, PaymentGatewayType.STRIPE_CONNECT, PaymentGatewayType.OPEN_BANKING], kycStrictnessLevel: KYCStrictness.STRICT },
      { isoCode: "AU", name: "Australia", baseCurrency: "AUD", requiresDepositEscrow: true, allowsDepositYield: true, maxRentInstallments: 1, allowsSalesCommissionInstallments: true, maxSalesCommissionInstallments: 12, maxSalesCommissionRateBps: 500, supportedGateways: [PaymentGatewayType.STRIPE, PaymentGatewayType.OPEN_BANKING], kycStrictnessLevel: KYCStrictness.MODERATE },
      { isoCode: "NZ", name: "New Zealand", baseCurrency: "NZD", requiresDepositEscrow: true, allowsDepositYield: true, maxRentInstallments: 1, allowsSalesCommissionInstallments: true, maxSalesCommissionInstallments: 12, maxSalesCommissionRateBps: 500, supportedGateways: [PaymentGatewayType.STRIPE], kycStrictnessLevel: KYCStrictness.MODERATE },
      { isoCode: "JP", name: "Japan", baseCurrency: "JPY", requiresDepositEscrow: true, allowsDepositYield: true, maxRentInstallments: 1, allowsSalesCommissionInstallments: true, maxSalesCommissionInstallments: 12, maxSalesCommissionRateBps: 600, supportedGateways: [PaymentGatewayType.STRIPE], kycStrictnessLevel: KYCStrictness.MODERATE },
      { isoCode: "KR", name: "South Korea", baseCurrency: "KRW", requiresDepositEscrow: false, allowsDepositYield: true, maxRentInstallments: 1, allowsSalesCommissionInstallments: true, maxSalesCommissionInstallments: 12, maxSalesCommissionRateBps: 600, supportedGateways: [PaymentGatewayType.STRIPE], kycStrictnessLevel: KYCStrictness.MODERATE },
      { isoCode: "CN", name: "China", baseCurrency: "CNY", requiresDepositEscrow: false, allowsDepositYield: true, maxRentInstallments: 1, allowsSalesCommissionInstallments: true, maxSalesCommissionInstallments: 12, maxSalesCommissionRateBps: 600, supportedGateways: [PaymentGatewayType.STRIPE_CONNECT], kycStrictnessLevel: KYCStrictness.STRICT },
      { isoCode: "IN", name: "India", baseCurrency: "INR", requiresDepositEscrow: false, allowsDepositYield: true, maxRentInstallments: 1, allowsSalesCommissionInstallments: true, maxSalesCommissionInstallments: 12, maxSalesCommissionRateBps: 600, supportedGateways: [PaymentGatewayType.STRIPE], kycStrictnessLevel: KYCStrictness.MODERATE },
      { isoCode: "SG", name: "Singapore", baseCurrency: "SGD", requiresDepositEscrow: true, allowsDepositYield: true, maxRentInstallments: 1, allowsSalesCommissionInstallments: true, maxSalesCommissionInstallments: 12, maxSalesCommissionRateBps: 600, supportedGateways: [PaymentGatewayType.STRIPE, PaymentGatewayType.OPEN_BANKING], kycStrictnessLevel: KYCStrictness.MODERATE },
      { isoCode: "MY", name: "Malaysia", baseCurrency: "MYR", requiresDepositEscrow: false, allowsDepositYield: true, maxRentInstallments: 1, allowsSalesCommissionInstallments: true, maxSalesCommissionInstallments: 12, maxSalesCommissionRateBps: 600, supportedGateways: [PaymentGatewayType.STRIPE], kycStrictnessLevel: KYCStrictness.LIGHT },
      { isoCode: "TH", name: "Thailand", baseCurrency: "THB", requiresDepositEscrow: false, allowsDepositYield: true, maxRentInstallments: 1, allowsSalesCommissionInstallments: true, maxSalesCommissionInstallments: 12, maxSalesCommissionRateBps: 600, supportedGateways: [PaymentGatewayType.STRIPE], kycStrictnessLevel: KYCStrictness.MODERATE },
      { isoCode: "AE", name: "United Arab Emirates", baseCurrency: "AED", requiresDepositEscrow: true, allowsDepositYield: true, maxRentInstallments: 1, allowsSalesCommissionInstallments: true, maxSalesCommissionInstallments: 12, maxSalesCommissionRateBps: 250, supportedGateways: [PaymentGatewayType.STRIPE_CONNECT, PaymentGatewayType.OPEN_BANKING], kycStrictnessLevel: KYCStrictness.STRICT },
      { isoCode: "SA", name: "Saudi Arabia", baseCurrency: "SAR", requiresDepositEscrow: true, allowsDepositYield: true, maxRentInstallments: 1, allowsSalesCommissionInstallments: true, maxSalesCommissionInstallments: 12, maxSalesCommissionRateBps: 250, supportedGateways: [PaymentGatewayType.STRIPE_CONNECT, PaymentGatewayType.OPEN_BANKING], kycStrictnessLevel: KYCStrictness.STRICT },
    ],
    skipDuplicates: true,
  }).catch((e) => { console.error(e); });

  // StateFintechConfig — başlıca eyalet/bölge düzeyi düzenlemeler
  await prisma.stateFintechConfig.createMany({
    data: [
      { id: id("st_us_ca"), stateCode: "CA", countryIsoCode: "US", maxRentCapPercent: 10, evictionNoticeDays: 30 },
      { id: id("st_us_ny"), stateCode: "NY", countryIsoCode: "US", maxRentCapPercent: 10, evictionNoticeDays: 14 },
      { id: id("st_tr_ist"), stateCode: "İSTANBUL", countryIsoCode: "TR", maxRentCapPercent: 25, evictionNoticeDays: 30 },
      { id: id("st_de_be"), stateCode: "BERLIN", countryIsoCode: "DE", maxRentCapPercent: 15, evictionNoticeDays: 90 },
      { id: id("st_ae_dxb"), stateCode: "DUBAI", countryIsoCode: "AE", maxRentCapPercent: null, evictionNoticeDays: 30 },
    ],
    skipDuplicates: true,
  }).catch((e) => { console.error(e); });

  // LanguageConfig — 20 desteklenen dil
  await prisma.languageConfig.createMany({
    data: [
      ...
      { id: id("lang_ar"), code: "ar", name: "Arabic", nativeName: "العربية", isActive: true },
      { id: id("lang_zh"), code: "zh", name: "Chinese", nativeName: "中文", isActive: true },
      { id: id("lang_ja"), code: "ja", name: "Japanese", nativeName: "日本語", isActive: true },
      { id: id("lang_ko"), code: "ko", name: "Korean", nativeName: "한국어", isActive: true },
      { id: id("lang_ru"), code: "ru", name: "Russian", nativeName: "Русский", isActive: true },
      { id: id("lang_pt"), code: "pt", name: "Portuguese", nativeName: "Português", isActive: true },
      { id: id("lang_it"), code: "it", name: "Italian", nativeName: "Italiano", isActive: true },
      { id: id("lang_nl"), code: "nl", name: "Dutch", nativeName: "Nederlands", isActive: true },
      { id: id("lang_pl"), code: "pl", name: "Polish", nativeName: "Polski", isActive: true },
      { id: id("lang_sv"), code: "sv", name: "Swedish", nativeName: "Svenska", isActive: true },
      { id: id("lang_da"), code: "da", name: "Danish", nativeName: "Dansk", isActive: true },
      { id: id("lang_fi"), code: "fi", name: "Finnish", nativeName: "Suomi", isActive: true },
      { id: id("lang_el"), code: "el", name: "Greek", nativeName: "Ελληνικά", isActive: true },
      { id: id("lang_hi"), code: "hi", name: "Hindi", nativeName: "हिन्दी", isActive: true },
      { id: id("lang_no"), code: "no", name: "Norwegian", nativeName: "Norsk", isActive: true },
    ],
    skipDuplicates: true,
  }).catch((e) => { console.error(e); });

  // CurrencyConfig — 23 ülke para birimi
  await prisma.currencyConfig.createMany({
    data: [
      ...
      { id: id("curr_cad"), code: "CAD", name: "Canadian Dollar", symbol: "CA$", exchangeRate: 1.36, isActive: true },
      { id: id("curr_mxn"), code: "MXN", name: "Mexican Peso", symbol: "MX$", exchangeRate: 17.2, isActive: true },
      { id: id("curr_brl"), code: "BRL", name: "Brazilian Real", symbol: "R$", exchangeRate: 5.0, isActive: true },
      { id: id("curr_ars"), code: "ARS", name: "Argentine Peso", symbol: "$", exchangeRate: 900.0, isActive: true },
      ...
      { id: id("curr_aud"), code: "AUD", name: "Australian Dollar", symbol: "A$", exchangeRate: 1.52, isActive: true },
      { id: id("curr_nzd"), code: "NZD", name: "New Zealand Dollar", symbol: "NZ$", exchangeRate: 1.64, isActive: true },
      { id: id("curr_jpy"), code: "JPY", name: "Japanese Yen", symbol: "¥", exchangeRate: 149.5, isActive: true },
      { id: id("curr_krw"), code: "KRW", name: "South Korean Won", symbol: "₩", exchangeRate: 1330.0, isActive: true },
      { id: id("curr_cny"), code: "CNY", name: "Chinese Yuan", symbol: "¥", exchangeRate: 7.2, isActive: true },
      { id: id("curr_inr"), code: "INR", name: "Indian Rupee", symbol: "₹", exchangeRate: 83.2, isActive: true },
      { id: id("curr_sgd"), code: "SGD", name: "Singapore Dollar", symbol: "S$", exchangeRate: 1.34, isActive: true },
      { id: id("curr_myr"), code: "MYR", name: "Malaysian Ringgit", symbol: "RM", exchangeRate: 4.7, isActive: true },
      { id: id("curr_thb"), code: "THB", name: "Thai Baht", symbol: "฿", exchangeRate: 35.8, isActive: true },
      { id: id("curr_aed"), code: "AED", name: "UAE Dirham", symbol: "د.إ", exchangeRate: 3.67, isActive: true },
      { id: id("curr_sar"), code: "SAR", name: "Saudi Riyal", symbol: "﷼", exchangeRate: 3.75, isActive: true },
    ],
    skipDuplicates: true,
  }).catch((e) => { console.error(e); });
  ...
  await prisma.regionalPricing.createMany({
    data: [
      ...
      { id: id("reg_uk_detached"), countryCode: "UK", propertyType: "DETACHED_HOUSE", basePrice: 350000, adjustment: 1.0, season: "all", effectiveFrom: new Date("2024-01-01") },
      ...
      { id: id("reg_ca_detached"), countryCode: "CA", propertyType: "DETACHED_HOUSE", basePrice: 550000, adjustment: 1.0, season: "all", effectiveFrom: new Date("2024-01-01") },
      { id: id("reg_mx_detached"), countryCode: "MX", propertyType: "DETACHED_HOUSE", basePrice: 250000, adjustment: 1.0, season: "all", effectiveFrom: new Date("2024-01-01") },
      { id: id("reg_br_detached"), countryCode: "BR", propertyType: "DETACHED_HOUSE", basePrice: 300000, adjustment: 1.0, season: "all", effectiveFrom: new Date("2024-01-01") },
      { id: id("reg_ar_detached"), countryCode: "AR", propertyType: "DETACHED_HOUSE", basePrice: 120000, adjustment: 1.0, season: "all", effectiveFrom: new Date("2024-01-01") },
      { id: id("reg_fr_detached"), countryCode: "FR", propertyType: "DETACHED_HOUSE", basePrice: 380000, adjustment: 1.0, season: "all", effectiveFrom: new Date("2024-01-01") },
      { id: id("reg_es_detached"), countryCode: "ES", propertyType: "DETACHED_HOUSE", basePrice: 320000, adjustment: 1.0, season: "all", effectiveFrom: new Date("2024-01-01") },
      { id: id("reg_it_detached"), countryCode: "IT", propertyType: "DETACHED_HOUSE", basePrice: 340000, adjustment: 1.0, season: "all", effectiveFrom: new Date("2024-01-01") },
      { id: id("reg_nl_detached"), countryCode: "NL", propertyType: "DETACHED_HOUSE", basePrice: 480000, adjustment: 1.0, season: "all", effectiveFrom: new Date("2024-01-01") },
      { id: id("reg_au_detached"), countryCode: "AU", propertyType: "DETACHED_HOUSE", basePrice: 600000, adjustment: 1.0, season: "all", effectiveFrom: new Date("2024-01-01") },
      { id: id("reg_nz_detached"), countryCode: "NZ", propertyType: "DETACHED_HOUSE", basePrice: 520000, adjustment: 1.0, season: "all", effectiveFrom: new Date("2024-01-01") },
      { id: id("reg_jp_detached"), countryCode: "JP", propertyType: "DETACHED_HOUSE", basePrice: 300000, adjustment: 1.0, season: "all", effectiveFrom: new Date("2024-01-01") },
      { id: id("reg_kr_detached"), countryCode: "KR", propertyType: "DETACHED_HOUSE", basePrice: 280000, adjustment: 1.0, season: "all", effectiveFrom: new Date("2024-01-01") },
      { id: id("reg_cn_detached"), countryCode: "CN", propertyType: "DETACHED_HOUSE", basePrice: 250000, adjustment: 1.0, season: "all", effectiveFrom: new Date("2024-01-01") },
      { id: id("reg_in_detached"), countryCode: "IN", propertyType: "DETACHED_HOUSE", basePrice: 150000, adjustment: 1.0, season: "all", effectiveFrom: new Date("2024-01-01") },
      { id: id("reg_sg_detached"), countryCode: "SG", propertyType: "DETACHED_HOUSE", basePrice: 900000, adjustment: 1.0, season: "all", effectiveFrom: new Date("2024-01-01") },
      { id: id("reg_my_detached"), countryCode: "MY", propertyType: "DETACHED_HOUSE", basePrice: 250000, adjustment: 1.0, season: "all", effectiveFrom: new Date("2024-01-01") },
      { id: id("reg_th_detached"), countryCode: "TH", propertyType: "DETACHED_HOUSE", basePrice: 220000, adjustment: 1.0, season: "all", effectiveFrom: new Date("2024-01-01") },
      { id: id("reg_ae_detached"), countryCode: "AE", propertyType: "DETACHED_HOUSE", basePrice: 400000, adjustment: 1.0, season: "all", effectiveFrom: new Date("2024-01-01") },
      { id: id("reg_sa_detached"), countryCode: "SA", propertyType: "DETACHED_HOUSE", basePrice: 380000, adjustment: 1.0, season: "all", effectiveFrom: new Date("2024-01-01") },
    ],
    skipDuplicates: true,
  }).catch((e) => { console.error(e); });
