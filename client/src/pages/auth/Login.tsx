...
import { Github, Mail, Eye, EyeOff, AlertCircle, Facebook } from "lucide-react";
      ...
      <div className="flex-1 flex items-center justify-center p-4">
        ...
        scale: 1
          ...
          <div className="grid grid-cols-3 gap-4">
            <Button variant="outline" className="h-11 bg-[#1b1c22] border-slate-800 hover:bg-slate-800 text-slate-300 rounded-xl transition-all" onClick={() => handleSocialLogin("github")} disabled={loading || isLoading}>
              <Github className="mr-2 h-4 w-4" />{t("client.src.github")}</Button>
            <Button variant="outline" className="h-11 bg-[#1b1c22] border-slate-800 hover:bg-slate-800 text-slate-300 rounded-xl transition-all" onClick={() => handleSocialLogin("google")} disabled={loading || isLoading}>
              <Mail className="mr-2 h-4 w-4" />{t("client.src.google")}</Button>
            <Button variant="outline" className="h-11 bg-[#1b1c22] border-slate-800 hover:bg-slate-800 text-slate-300 rounded-xl transition-all" onClick={() => handleSocialLogin("facebook")} disabled={loading || isLoading}>
              <Facebook className="mr-2 h-4 w-4" />{t("client.src.facebook")}</Button>
          </div>
