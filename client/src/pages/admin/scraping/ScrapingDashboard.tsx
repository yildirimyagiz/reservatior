...
export default function ScrapingDashboard() {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case "running": return <Badge className="bg-blue-100 text-blue-700 hover:bg-blue-200 border-0 gap-1"><RefreshCw className="w-3 h-3 animate-spin" />{t("admin.scraping.running")}</Badge>;
