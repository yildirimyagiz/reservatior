                ...
                <CardContent>
                  <div className="h-48 flex items-end justify-between gap-2 px-4 pb-4">
                    {[45, 62, 58, 75, 42, 68, 85, 55, 92, 78, 64, 82].map((val, i) => (
                      <motion.div key={i} initial={{ height: 0 }} animate={{ height: `${val}%` }} transition={{ delay: i * 0.05, duration: 1, ease: "circOut" }} className="flex-1 bg-linear-to-t from-blue-600/20 to-blue-500/40 rounded-t-lg relative group cursor-pointer">
