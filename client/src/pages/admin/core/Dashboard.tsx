...
export default function Dashboard() {
  ...
  const fetchDashboardData = async () => {
    setLoading(true);
    try {
      // Mocked for now - since real endpoint might not exist yet
      setMetrics({
        totalRevenue: 2450000,
        totalExpenses: 1100000,
        totalProfit: 1350000,
        totalProperties: 1240,
        occupiedProperties: 1180,
        vacantProperties: 60,
        totalUsers: 4850,
        activeUsers: 3120,
        totalTasks: 420,
      ...
      setRecentActivities([{
        id: '1',
        type: 'DEAL',
        title: t("admin.core.new_premium_slot_materialized"),
        description: t("admin.core.villa_azure_linked_to"),
        timestamp: '2m ago',
        user: 'AI Core'
      }, {
        id: '2',
        type: 'AI',
        title: t("admin.core.yield_optimization_complete"),
        description: t("admin.core.revpar_increased_by_42"),
        timestamp: '15m ago',
        user: 'Neural Engine'
      }, {
        id: '3',
        type: 'USER',
        title: t("admin.core.highlevel_entry_detected"),
        description: t("admin.core.admin_cluster_node_authorization"),
        timestamp: '1h ago',
        user: 'SecOps'
      }]);
    } catch (error) {
