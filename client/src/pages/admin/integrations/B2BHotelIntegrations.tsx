  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">B2B Otel Toptancıları (Aggregator)</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {integrations.map((integration) => (
          <Card key={integration.id} className={integration.enabled ? "border-blue-500/50 shadow-[0_0_15px_rgba(59,130,246,0.1)]" : "border-white/5 opacity-70"}>
            <CardHeader className="flex flex-row justify-between items-start pb-2">
              <div className="flex gap-3 items-center">
                <div className="p-2 bg-white/5 rounded-lg">
                  <Globe className={integration.enabled ? "w-6 h-6 text-blue-500" : "w-6 h-6 text-muted-foreground"} />
                </div>
                <div>
