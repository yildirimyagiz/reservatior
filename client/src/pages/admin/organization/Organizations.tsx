                    ...
                    <TableCell className="text-right">
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          ...
                          <DropdownMenuItem>
                            <Edit className="h-4 w-4 mr-2" />{t("admin.organization.edit_organization")}</DropdownMenuItem>
                          <DropdownMenuItem>
                          ...
                          <DropdownMenuItem className="text-red-600">
                            <Trash2 className="h-4 w-4 mr-2" />{t("admin.organization.delete_organization")}</DropdownMenuItem>
                        </DropdownMenuContent>
                      </DropdownMenu>
                    </TableCell>
                  </TableRow>)}
