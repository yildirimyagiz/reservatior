...
import AIOperationsWidget from "@/components/ai/AIOperationsWidget";
...
export function AdminLayout({
  ...
  const adminNavigation: NavItem[] = [{
    ...
    children: [{
      ...
      title: t("admin.layout.event_log"),
      href: "/admin/event-log",
      icon: Activity
    }, {
      title: t("admin.layout.notification_templates"),
      href: "/admin/notification-templates",
      icon: FileText
    }, {
      title: t("admin.layout.execution_history"),
      href: "/admin/automation-executions",
      icon: Activity
    }]
  }];
