...
export default function SecurityOverview() {
  ...
  return <PageShell title={t("admin.security.security_matrix_overview")} description={t("admin.security.monitor_neural_handshake_stability")}>
      <div className="space-y-10 pb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="bg-card border-border rounded-3xl overflow-hidden shadow-2xl relative group border-l-emerald-500/30 border-l-2">
            ...
            <CardContent className="p-8">
              <p className="text-[10px] font-bold text-muted-foreground mb-1">{t("admin.security.mfa_adoption_dna")}</p>
              <h3 className="text-xl font-bold text-foreground leading-none">{stats.mfaAdoption}%</h3>
          ...
          <Card className="bg-card border-border rounded-3xl overflow-hidden shadow-2xl relative group">
            ...
            <CardContent className="p-8">
              <p className="text-[10px] font-bold text-muted-foreground mb-1">{t("admin.security.biometric_sync")}</p>
              <h3 className="text-xl font-bold text-foreground leading-none">{stats.biometricUsers}%</h3>
          ...
          <Card className="bg-card border-border rounded-3xl overflow-hidden shadow-2xl relative group border-l-rose-500/30 border-l-2">
            ...
            <CardContent className="p-8">
              <p className="text-[10px] font-bold text-muted-foreground mb-1">{t("admin.security.active_anomalies")}</p>
              <h3 className="text-xl font-bold text-rose-500 leading-none">{stats.activeThreats}</h3>
          ...
          <Card className="bg-card border-border rounded-3xl overflow-hidden shadow-2xl relative group">
            ...
            <CardContent className="p-8">
              <p className="text-[10px] font-bold text-muted-foreground mb-1">{t("admin.security.auth_failures_24h")}</p>
              <h3 className="text-xl font-bold text-foreground leading-none">{stats.failedLogins24h}</h3>
            ...
            <CardContent className="p-6 space-y-4">
              <div className="p-6 rounded-3xl bg-rose-500/5 border border-rose-500/10 flex items-start gap-4 hover:bg-rose-500/10 transition-all cursor-pointer group">
                ...
                <div className="flex-1">
                  <p className="text-[10px] font-bold text-foreground tracking-tight">{t("admin.security.bruteforce_blocked")}</p>
                  <p className="text-[10px] text-muted-foreground font-bold mt-1">{t("admin.security.ip_1852241102_15m_ago")}</p>
                </div>
                <Button variant="ghost" size="sm" className="h-8 w-8 rounded-xl hover:bg-muted/50 text-muted-foreground hover:text-foreground"><Eye className="w-4 h-4" /></Button>
              </div>
              ...
              <div className="p-6 rounded-3xl bg-orange-500/5 border border-orange-500/10 flex items-start gap-4 hover:bg-orange-500/10 transition-all cursor-pointer group">
                ...
                <div className="flex-1">
                  <p className="text-[10px] font-bold text-foreground tracking-tight">{t("admin.security.multiple_mfa_fails")}</p>
                  <p className="text-[10px] text-muted-foreground font-bold mt-1">{t("admin.security.user_adminpropos_2h_ago")}</p>
                </div>
                <Button variant="ghost" size="sm" className="h-8 w-8 rounded-xl hover:bg-muted/50 text-muted-foreground hover:text-foreground"><Eye className="w-4 h-4" /></Button>
              </div>

              <div className="p-6 rounded-3xl bg-muted/50 border border-border flex items-start gap-4 hover:bg-muted/50 transition-all cursor-pointer group">
                <div className="p-3 bg-[#14151a] border border-border rounded-2xl group-hover:scale-110 transition-all">
                   <Key className="w-5 h-5 text-muted-foreground" />
                </div>
                <div className="flex-1">
                  <p className="text-[10px] font-bold text-foreground tracking-tight">{t("admin.security.token_handshake_revealed")}</p>
                  <p className="text-[10px] text-muted-foreground font-bold mt-1">{t("admin.security.system_log_5h_ago")}</p>
                </div>
                <Button variant="ghost" size="sm" className="h-8 w-8 rounded-xl hover:bg-muted/50 text-muted-foreground hover:text-foreground"><Eye className="w-4 h-4" /></Button>
              </div>

              <Button variant="outline" className="w-full mt-4 h-14 rounded-2xl border-border bg-muted/50 hover:bg-muted/50 text-muted-foreground hover:text-foreground font-bold text-[10px] gap-2">{t("admin.security.synchronize_security_logs")}<ArrowRight className="w-4 h-4" />
              </Button>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
           <Card className="bg-card border-border rounded-3xl p-8 hover:bg-muted/50 transition-all cursor-pointer group">
              <div className="flex items-center gap-6">
                 ...
                 <div>
                    <h4 className="text-sm font-bold text-foreground">{t("admin.security.protocol_audit")}</h4>
                    <p className="text-[10px] font-bold text-muted-foreground mt-1">{t("admin.security.deep_neural_scan_of")}</p>
                 </div>
              </div>
           </Card>
           <Card className="bg-card border-border rounded-3xl p-8 hover:bg-muted/50 transition-all cursor-pointer group">
              <div className="flex items-center gap-6">
                 ...
                 <div>
                    <h4 className="text-sm font-bold text-foreground">{t("admin.security.key_rotation")}</h4>
                    <p className="text-[10px] font-bold text-muted-foreground mt-1">{t("admin.security.symmetric_encryption_update")}</p>
                 </div>
              </div>
           </Card>
           <Card className="bg-card border-border rounded-3xl p-8 hover:bg-muted/50 transition-all cursor-pointer group">
              <div className="flex items-center gap-6">
                 ...
                 <div>
                    <h4 className="text-sm font-bold text-foreground">{t("admin.security.health_snapshot")}</h4>
                    <p className="text-[10px] font-bold text-muted-foreground mt-1">{t("admin.security.generate_system_pulse_report")}</p>
                 </div>
              </div>
           </Card>
        </div>
