...
export default function InmanConnect() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0c] text-white font-sans selection:bg-blue-500/30 overflow-x-hidden">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-7xl h-[600px] bg-linear-to-b from-blue-500/10 via-indigo-500/5 to-transparent blur-3xl pointer-events-none -z-10" />

      {/* Top Banner for Event Mention */}
      <div className="bg-linear-to-r from-blue-900/30 via-indigo-900/30 to-purple-900/30 border-b border-[#24262f] py-3 px-4 text-center text-xs sm:text-sm font-semibold tracking-wide">
      ...
      <div className="max-w-6xl mx-auto px-4 py-12 sm:py-20">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 sm:mb-24">
          ...
          <motion.h1
            ...
            className="text-4xl sm:text-6xl font-black tracking-tight leading-none bg-linear-to-r from-white via-slate-200 to-slate-400 bg-clip-text text-transparent mb-6"
          >
        ...
        >
          ...
          <form onSubmit={handleAnalyze} className="flex flex-col sm:flex-row gap-4 mb-8">
            ...
            <Button
              type="submit"
              className="h-14 px-8 bg-linear-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white font-bold rounded-xl transition-all shadow-lg shadow-blue-500/20 shrink-0"
              disabled={isAnalyzing}
            >
            ...
            {showResult && (
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="relative rounded-2xl overflow-hidden border border-[#24262f] bg-[#0a0a0c]">
                    ...
                    <img src="https://images.unsplash.com/photo-1513694203232-719a280e022f?auto=format&fit=crop&w=600&q=80" alt="Before Staging" className="w-full h-64 object-cover opacity-50 grayscale" />
                    <div className="p-4">
                  ...
                  <div className="relative rounded-2xl overflow-hidden border border-blue-500/30 bg-[#0a0a0c] shadow-xl shadow-blue-500/5">
                    ...
                    <img src="https://images.unsplash.com/photo-1524758631624-e2822e304c36?auto=format&fit=crop&w=600&q=80" alt="After Staging" className="w-full h-64 object-cover" />
                    <div className="p-4 bg-linear-to-b from-transparent to-blue-500/5">
        ...
        <div className="text-center bg-linear-to-r from-blue-600/10 to-indigo-600/10 border border-blue-500/20 rounded-3xl p-8 sm:p-12 relative overflow-hidden">
