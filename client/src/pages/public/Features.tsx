      ...
      <div className="relative z-10 container mx-auto px-6 py-24 lg:py-32">
        ...
        <div className="max-w-3xl mb-24">
          ...
          once: true
            ...
            <h1 className="text-6xl lg:text-8xl font-black italic tracking-tighter mb-8 leading-[0.9]">{t("client.src.neural")}<span className="bg-linear-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent italic">{t("client.src.solutions")}</span>{t("client.src.for_the_next_gen")}</h1>
        ...
        once: true
      }} className="mt-32 p-12 lg:p-24 rounded-[4rem] bg-linear-to-br from-primary/20 via-purple-600/10 to-transparent border border-white/10 text-center relative overflow-hidden">
