              ...
              <ScrollArea className="flex-1 p-10 scrollbar-hide">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                  ...
                  <div className="space-y-10">
                    ...
                    {/* Performance Index */}
                     <Card className="bg-linear-to-br from-indigo-600/10 to-violet-600/5 border-white/5 rounded-3xl overflow-hidden shadow-2xl border-l border-t p-8 text-center relative">
