      ...
      <div className="max-w-[1700px] mx-auto grid grid-cols-1 xl:grid-cols-12 gap-10">
        ...
        <div className="xl:col-span-3 space-y-6">
           <Card className="bg-white dark:bg-[#14151a]/40 border-slate-200 dark:border-white/5 rounded-4xl overflow-hidden shadow-2xl sticky top-10">
              <CardHeader className="p-8 border-b border-slate-200 dark:border-white/5 bg-linear-to-b from-orange-600/5 to-transparent">
        ...
        <div className="xl:col-span-9 space-y-12">
           <AnimatePresence mode="wait">
            ...
            y: -20
                   ...
                   {/* RADIUS PULSE PANEL */}
                   <div className="p-12 bg-linear-to-br from-white via-slate-50 to-white dark:from-[#14151a] dark:via-[#0a0b0d] dark:to-[#14151a] border border-slate-200 dark:border-orange-500/10 rounded-[3.5rem] relative overflow-hidden group shadow-xl">
       ...
       <Dialog open={showEventDialog} onOpenChange={setShowEventDialog}>
         <DialogContent className="bg-white dark:bg-[#0a0b0d] border-none text-slate-900 dark:text-white rounded-[4rem] max-w-2xl overflow-hidden p-0 shadow-2xl">
            <div className="p-16 space-y-12 bg-linear-to-br from-orange-50 to-white dark:from-orange-600/10 dark:to-[#0a0b0d]">
