              ...
              x: -20
                  ...
                  <div className="h-[340px] p-8 flex flex-col gap-6 relative overflow-hidden">
                    ...
                    <div className="h-44 relative rounded-[32px] overflow-hidden shadow-2xl border border-white/10">
                      <img src={property.image} alt={property.title} className="w-full h-full object-cover group-hover/col:scale-110 transition-transform duration-1000 brightness-90 group-hover/col:brightness-100" />
