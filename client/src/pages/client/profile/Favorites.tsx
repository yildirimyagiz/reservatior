            ...
            delay: index * 0.05
                  ...
                  <Card className="bg-[#1a1b1e]/40 border-white/5 border-l border-t rounded-[40px] overflow-hidden group hover:bg-white/5 transition-all shadow-2xl relative">
                    ...
                    <div className="relative aspect-16/10 overflow-hidden">
                      <img src={property.image} alt={property.title} className="object-cover w-full h-full group-hover:scale-110 transition-transform duration-700 brightness-75 group-hover:brightness-100" />
                      <div className="absolute inset-0 bg-linear-to-t from-[#14151a] via-transparent to-transparent opacity-60" />
