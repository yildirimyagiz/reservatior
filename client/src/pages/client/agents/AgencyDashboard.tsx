      ...
      <div className="max-w-[1600px] mx-auto space-y-10">
        ...
        <AnimatePresence mode="wait">
              ...
              <Card className="bg-[#14151a]/60 border-slate-800/50 rounded-3xl overflow-hidden p-8">
                ...
                delay: index * 0.05
                      ...
                      <div className="flex items-center gap-5">
                        <div className="w-14 h-14 rounded-2xl bg-linear-to-br from-violet-600/20 to-indigo-600/20 border border-white/5 flex items-center justify-center text-violet-400 font-black text-xl">
                          {agent.name.charAt(0)}
                        </div>
                        <div>
          ...
          scale: 0.98
               ...
               <Card className="bg-linear-to-br from-violet-600/20 to-indigo-600/10 border-violet-500/30 rounded-3xl p-8 md:p-12 relative overflow-hidden">
