  ...
  return <div className="p-8 space-y-8 bg-[#0a0b0d] min-h-full text-slate-200 selection:bg-blue-500/30">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-4 space-y-8">
          ...
          <Card className="bg-linear-to-br from-blue-600/10 to-indigo-600/5 border-slate-800/50 rounded-4xl p-6 shadow-2xl relative overflow-hidden backdrop-blur-xl">
