    ...
    value: "12 ACTIVE"
      ...
      <div className="grid lg:grid-cols-2 gap-12 px-4">
        ...
        <div className="space-y-8">
          ...
          delay: 0.4
        }} className="p-10 rounded-[40px] bg-linear-to-br from-blue-600/10 to-purple-600/10 border border-white/5 backdrop-blur-3xl relative overflow-hidden">
