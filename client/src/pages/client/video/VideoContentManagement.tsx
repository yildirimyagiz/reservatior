            ...
            return <motion.div key={project.id} initial={{
              ...
              delay: idx * 0.08
                  ...
                  <Card className="bg-[#14151a]/60 border-slate-800/50 rounded-3xl overflow-hidden hover:border-violet-600/30 transition-all group cursor-pointer" onClick={() => openEditor(project)}>
                    {/* Thumbnail Area */}
                    <div className="h-44 bg-linear-to-br from-slate-900 to-slate-950 relative overflow-hidden">
                      <div className="absolute inset-0 bg-linear-to-t from-[#14151a] to-transparent z-10" />
                      ...
                      {/* LoRA gradient band */}
                      {LORA_STYLES.find(l => l.id === project.loraStyle) && <div className={cn("absolute bottom-0 left-0 right-0 h-0.5 bg-linear-to-r", LORA_STYLES.find(l => l.id === project.loraStyle)?.color)} />}
                    </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-8">
              <Card className="bg-[#14151a]/60 border-slate-800/50 rounded-4xl overflow-hidden">
                <div className="aspect-video bg-linear-to-br from-slate-900 via-slate-950 to-black relative flex items-center justify-center">
                  {selectedProject ? <>
            ...
            <div className="lg:col-span-4 space-y-4">
              ...
              {/* Engine Status */}
              <Card className="bg-linear-to-br from-violet-600/10 to-indigo-600/5 border-slate-800/50 rounded-4xl p-5">
          ...
          <Card className="bg-[#14151a]/60 border-slate-800/50 rounded-4xl p-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3">
              {LORA_STYLES.map(style => <div key={style.id} className="group cursor-pointer">
                  <div className={cn("h-20 rounded-xl bg-linear-to-br mb-2 border border-white/10 group-hover:scale-105 transition-transform shadow-lg", style.color)} />
