...
export default function PropertyDetail() {
  ...
  const [useDepositAlternative, setUseDepositAlternative] = useState(true);
  ...
  const { data: affiliateOffers } = useQuery({
    ...
    queryFn: async () => {
      ...
      const response = await fetch(`${import.meta.env.VITE_API_URL || ''}/api/v1/property/${id}/affiliate-offers`, {
                         ...
                         <div className="space-y-4">
                          ...
                          <div className="space-y-4">
                             ...
                             {dateRange?.from && dateRange?.to && (() => {
                               ...
                               const totalWithCash = totalRent + 120 + serviceFee + traditionalDeposit;
                               const totalWithAlternative = totalRent + 120 + serviceFee + depositPremium;
