                     ...
                     <Card className={cn(
                       ...
                       l.isDoped ? "border-amber-500/30 shadow-amber-900/10 ring-1 ring-amber-500/20" : ""
                        ...
                        <div className="aspect-video relative overflow-hidden">
                          {l.photos?.[0] ? <img src={l.photos[0]} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-1000 brightness-90 group-hover:brightness-100" /> : <div className="w-full h-full flex items-center justify-center bg-black/40"><Camera className="w-20 h-20 text-white/5" /></div>}
                          ...
                          <TableCell className="px-10 py-8">
                             <div className="flex items-center gap-8">
                                <div className="w-20 h-20 rounded-[24px] bg-black/40 border border-white/5 overflow-hidden shrink-0 shadow-inner relative group-hover/row:scale-105 transition-transform duration-500">
                                   {l.photos?.[0] ? <img src={l.photos[0]} className="w-full h-full object-cover" /> : <Camera className="w-full h-full p-6 text-white/5" />}
