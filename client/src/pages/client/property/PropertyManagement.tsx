...
export default function PropertyManagement() {
  ...
  return <div className="min-h-screen bg-[#14151a] p-8 lg:p-12 relative overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
        ...
        <div className="absolute inset-0 bg-linear-to-b from-transparent via-[#14151a]/50 to-[#14151a] opacity-80"></div>
      </div>
      ...
      <div className="max-w-[1600px] mx-auto space-y-12 relative z-10">
        ...
        y: 0
          ...
          <div className="flex items-center gap-8">
            ...
            <div className="space-y-1.5">
              ...
              <h1 className="text-5xl md:text-7xl font-black italic tracking-tighter leading-none bg-linear-to-br from-white via-blue-100 to-slate-500 bg-clip-text text-transparent drop-shadow-lg">{t('client.property.management.title')}</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          delay: i * 0.1
               ...
               <Card className="bg-[#1a1b1e]/40 border border-white/5 rounded-[32px] overflow-hidden p-8 hover:bg-[#1a1b1e]/80 transition-all duration-500 shadow-2xl relative backdrop-blur-xl group hover:shadow-[0_0_40px_rgba(59,130,246,0.15)] hover:-translate-y-2 hover:border-blue-500/30">
                 ...
                 <div className="absolute bottom-0 left-0 right-0 h-1 bg-linear-to-r from-transparent via-blue-500/20 to-transparent scale-x-0 group-hover:scale-x-100 transition-transform duration-700" />
               </Card>
             </motion.div>)}
        </div>
            ...
            delay: idx * 0.05
                     ...
                     <Card className="group relative bg-[#1a1b1e]/40 border border-white/5 rounded-[40px] overflow-hidden backdrop-blur-xl transition-all duration-700 hover:shadow-[0_0_50px_rgba(59,130,246,0.15)] hover:border-blue-500/40 h-full flex flex-col hover:-translate-y-3">
                        <div className="aspect-4/3 relative overflow-hidden">
                          ...
                          {p.photos?.[0] ? <img src={p.photos[0].url} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-1000 brightness-90 group-hover:brightness-110" /> : <div className="w-full h-full flex items-center justify-center bg-black/40">
                              <Home className="w-20 h-20 text-white/5" />
                            </div>}
                          <div className="absolute inset-0 bg-linear-to-t from-[#14151a] via-[#14151a]/40 to-transparent opacity-90 z-10" />
                  ...
                  <TableBody>
                     {filteredProperties.map(p => <TableRow key={p.id} className="border-b border-white/5 hover:bg-white/2 transition-all group/row">
                          <TableCell className="px-10 py-8">
                             <div className="flex items-center gap-8">
                               <div className="w-16 h-16 rounded-[20px] bg-black/40 overflow-hidden border border-white/5 shadow-inner grow-0 shrink-0 group-hover/row:scale-110 transition-transform duration-500">
                                  {p.photos?.[0] ? <img src={p.photos[0].url} className="w-full h-full object-cover" /> : <Home className="w-full h-full p-4 opacity-10" />}
                               </div>
                               <div className="space-y-1.5">
        ...
        if (!open) {
          ...
          <DialogContent className="max-w-4xl bg-[#1a1b1e] border-white/10 text-white rounded-[48px] p-0 overflow-hidden shadow-3xl backdrop-blur-3xl">
            <div className="bg-linear-to-r from-blue-600/10 to-purple-600/10 p-12 border-b border-white/5 flex items-center justify-between">
              <div>
