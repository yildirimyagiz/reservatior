  ...
  return <PageShell title={t("investors.portfolio.title", "Yatırım Portföyüm")} description={t("investors.portfolio.desc", "Yatırımlarınızı, varlık dağılımınızı ve nakit akışınızı tek bir yerden kolayca yönetin.")}>
      <div className="space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <Card className="border-white/5 bg-linear-to-br from-blue-600/20 to-indigo-600/20 backdrop-blur-3xl rounded-[40px] overflow-hidden shadow-3xl relative border-l border-t">
        ...
        <div className="relative rounded-[60px] overflow-hidden bg-linear-to-br from-[#1a1b1e] to-black p-16 shadow-3xl border border-white/5 border-l border-t group">
