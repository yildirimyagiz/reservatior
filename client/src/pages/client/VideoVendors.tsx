          ...
          return <motion.div key={vendor.id} initial={{
            ...
            delay: index * 0.1
                ...
                <Card className="bg-[#1a1b1e]/40 border-white/5 border-l border-t rounded-[40px] overflow-hidden group hover:bg-white/5 transition-all shadow-2xl relative">
                  ...
                  <div className="absolute top-0 left-0 w-full h-1 bg-linear-to-r from-blue-600/50 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
