              ...
              <div key={video.id} className="relative w-full h-full shrink-0 snap-start snap-always flex flex-col">
                ...
                <div className="flex-1 relative overflow-hidden bg-black flex items-center justify-center">
                  ...
                  <div className="absolute inset-0">
                     <img src={video.image} alt={video.title} className="absolute inset-0 w-full h-full object-cover opacity-80" />
                     <div className="absolute inset-0 bg-linear-to-t from-[#0E0F15] via-black/40 to-transparent" />
