...
export default function Dashboard() {
  ...
  return <div className="p-8 lg:p-12 space-y-12 max-w-[1600px] mx-auto bg-background min-h-screen">
      {/* Tactical Welcomer + Subscription Status */}
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="space-y-2">
            ...
            <h1 className="text-3xl md:text-4xl font-extrabold text-white tracking-tight">
              {t("welcome", { name: "" })}<span className="text-transparent bg-clip-text bg-linear-to-r from-blue-400 via-indigo-400 to-purple-400 ml-1">{user?.name || "Neural Comm"}</span>
            </h1>
