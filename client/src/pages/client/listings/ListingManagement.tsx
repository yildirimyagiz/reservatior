...
export default function ListingManagement() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-slate-950 via-slate-900 to-slate-950 p-6 lg:p-12 relative overflow-hidden">
      {/* Animated Background */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-linear-to-r from-blue-500/5 via-purple-500/5 to-pink-500/5 rounded-full blur-3xl" />
      ...
      <div className="max-w-[1800px] mx-auto space-y-8 relative z-10">
        ...
        <motion.div 
          ...
          className="relative"
        >
          <div className="bg-linear-to-r from-blue-600/20 via-purple-600/20 to-pink-600/20 backdrop-blur-3xl border border-white/10 rounded-3xl p-8 lg:p-12 relative overflow-hidden">
            <div className="absolute inset-0 bg-linear-to-r from-blue-500/10 to-purple-500/10" />
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-12 h-12 rounded-2xl bg-linear-to-br from-blue-500 to-purple-600 flex items-center justify-center shadow-2xl shadow-blue-500/30">
                ...
                {[
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div className={cn("w-10 h-10 rounded-xl bg-linear-to-br flex items-center justify-center shadow-lg", stat.color)}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
          {filteredListings.map((listing: Listing, idx: number) => (
            ...
            >
              <Card className={cn(
                "group relative bg-linear-to-br from-white/5 to-white/2 backdrop-blur-3xl border border-white/10 rounded-3xl overflow-hidden transition-all duration-500 hover:shadow-2xl hover:shadow-blue-500/10 hover:border-blue-500/30",
                listing.isPromoted && "border-amber-500/30 shadow-amber-500/10"
              )}>
                {/* Promoted Badge */}
                {listing.isPromoted && (
                  <div className="absolute top-4 right-4 z-20">
                    <Badge className="bg-linear-to-r from-amber-500 to-amber-600 text-white border-none px-4 py-1.5 rounded-full text-[10px] font-black tracking-widest shadow-lg shadow-amber-500/30 flex items-center gap-1.5">
                    ...
                    <div className="flex items-start justify-between gap-3">
                      ...
                      {listing.price && (
                        <div className="text-right">
                          ...
                          <span className="text-2xl font-black bg-linear-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent italic tracking-tighter">
      ...
      <Dialog open={tagDialogOpen} onOpenChange={setTagDialogOpen}>
        <DialogContent className="max-w-lg bg-slate-900/95 border-white/10 text-white rounded-3xl p-0 overflow-hidden backdrop-blur-3xl shadow-2xl">
          <DialogHeader className="p-8 pb-0">
            <DialogTitle className="text-2xl font-black italic tracking-tighter bg-linear-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">
              Select Tags
            </DialogTitle>
          ...
          <div className="p-8 space-y-6">
                ...
                return (
                  <button
                    ...
                    className={cn(
                      ...
                      isSelected 
                        ? "bg-linear-to-r from-blue-500 to-purple-600 text-white border-transparent shadow-lg shadow-blue-500/30" 
                        : isAlreadyAdded
            ...
            <DialogFooter className="pt-4">
              ...
              <Button
                ...
                className="h-12 px-8 rounded-2xl bg-linear-to-rrom-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white font-black italic text-xs tracking-widest shadow-lg shadow-blue-500/30 transition-all hover:scale-105"
              >
                Add Selected Tags
              </Button>
            </DialogFooter>
      ...
      <Dialog open={promotionDialogOpen} onOpenChange={setPromotionDialogOpen}>
        <DialogContent className="max-w-md bg-slate-900/95 border-white/10 text-white rounded-3xl p-0 overflow-hidden backdrop-blur-3xl shadow-2xl">
          <DialogHeader className="p-8 pb-0">
            <DialogTitle className="text-2xl font-black italic tracking-tighter bg-linear-to-r from-amber-400 to-orange-400 bg-clip-text text-transparent">
              Boost Your Listing
            </DialogTitle>
            <DialogDescription className="text-slate-400 font-black italic tracking-widest text-[10px] pt-4">
              ...
              {[
                ...
                >
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-3">
                      <div className={cn("w-10 h-10 rounded-xl bg-linear-to-br flex items-center justify-center shadow-lg", option.color)}>
                    ...
                    <span className="font-black bg-linear-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent italic tracking-tighter text-xl">
                      ${option.price}
                    </span>
                  </div>
                </button>
      ...
      <Dialog open={renewalDialogOpen} onOpenChange={setRenewalDialogOpen}>
        <DialogContent className="max-w-md bg-slate-900/95 border-white/10 text-white rounded-3xl p-0 overflow-hidden backdrop-blur-3xl shadow-2xl">
          <DialogHeader className="p-8 pb-0">
            <DialogTitle className="text-2xl font-black italic tracking-tighter bg-linear-to-r from-emerald-400 to-green-400 bg-clip-text text-transparent">
              Renew Listing
            </DialogTitle>
            <DialogDescription className="text-slate-400 font-black italic tracking-widest text-[10px] pt-4">
          ...
          <div className="p-8 space-y-6">
            <div className="p-6 rounded-2xl border border-white/10 bg-linear-to-brrom-white/5 to-white/2e-y-4">
              <div className="flex items-center justify-between">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="font-black bg-linear-to-r from-emerald-400 to-green-400 bg-clip-text text-transparent italic tracking-tighter text-xl">$5.00</span>
              </div>
            </div>
            <DialogFooter className="pt-4">
              <Button
              ...
              <Button
                ...
                className="h-12 px-8 rounded-2xl bg-linear-to-r from-emerald-500 to-green-600 hover:from-emerald-600 hover:to-green-700 text-white font-black italic text-xs tracking-widest shadow-lg shadow-emerald-500/30 transition-all hover:scale-105"
              >
