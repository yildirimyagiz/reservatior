...
export const documentUploadsApi = {
  getAll: async (orgId: string): Promise<DocumentUploads[]> =>
    await apiClient.get(`/documents`, { params: { orgId } }),

  getById: async (orgId: string, id: string): Promise<DocumentUploads> =>
    await apiClient.get(`/documents/${id}`, { params: { orgId } }),
  ...
  getDownloadUrl: async (
    ...
    await apiClient.get(`/documents/${id}/download-url`, { params: { orgId } }),
  ...
  getStatistics: async (orgId: string) =>
    await apiClient.get(`/documents/stats`, { params: { orgId } }),
};
