  ...
  return <>
              ...
              <div className="flex-1 bg-zinc-900 relative">
                <AnimatePresence mode="wait">
                  ...
                  opacity: 0
                      ...
                      {/* Hero Image */}
                      <div className="col-span-2 row-span-2 relative group cursor-pointer overflow-hidden rounded-tl-2xl rounded-bl-2xl bg-linear-to-br from-blue-100 to-blue-200 flex items-center justify-center" onClick={() => setLightboxOpen(true)}>
                      ...
                      {/* Secondary Images */}
                      {[1, 2, 3, 4].map(idx => <div key={idx} className={`relative group cursor-pointer overflow-hidden bg-linear-to-br from-blue-50 to-blue-100 flex items-center justify-center ${idx === 1 ? "rounded-tr-2xl" : ""} ${idx === 3 ? "rounded-br-2xl" : ""}`} onClick={() => setLightboxOpen(true)}>
                  ...
                  opacity: 0
                      ...
                      {isVideoPlaying ? <div className="relative w-full h-full">
                          ...
                          <img src="/api/placeholder/400/300" className="w-full h-full object-cover opacity-50 blur-sm animate-pulse" alt={t("client.src.video_placeholder")} />
                      ...
                      {!isVideoPlaying && <div className="absolute inset-0 opacity-20 blur-xl pointer-events-none">
                          <img src="/api/placeholder/400/300" className="w-full h-full object-cover" />
                        </div>}
                    </motion.div>}
      ...
      <Dialog open={lightboxOpen} onOpenChange={setLightboxOpen}>
        <DialogContent className="max-w-7xl w-[95vw] h-[90vh] p-0 border-none bg-black/95">
          <div className="w-full h-full flex items-center justify-center relative bg-linear-to-br from-blue-100 to-blue-200">
            <Camera className="w-16 h-16 text-blue-600" />
