...
export function AiStudioTab() {
  ...
  return <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card className="border-primary/20 bg-linear-to-br from-primary/5 to-purple-500/5">
          <CardHeader>
        ...
        <Card className="border-blue-500/20 bg-linear-to-br from-blue-500/5 to-indigo-500/5">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
