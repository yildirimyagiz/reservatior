...
export const DirectBookingAdvantage: React.FC<DirectBookingBadgeProps> = ({
  ...
  return <div className={`p-6 rounded-2xl bg-linear-to-br from-slate-900 to-indigo-950 text-white shadow-2xl border border-white/10 relative overflow-hidden group ${className}`}>
      {/* Decorative Glow */}
