...
export function Features() {
  ...
  return <section className="py-24 px-4 md:px-6 bg-linear-to-b from-background to-secondary/20">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              delay: index * 0.1
                  ...
                  <Card className="h-full hover:shadow-lg transition-all duration-300 border-primary/20 bg-linear-to-br from-card to-card/50">
