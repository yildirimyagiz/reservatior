...
export const SmartPricingBadge = ({
  ...
  return <div className={cn("inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-linear-to-r from-emerald-500/20 to-blue-500/20 border border-emerald-500/30 backdrop-blur-md shadow-lg shadow-emerald-500/10 animate-pulse", className)}>
...
export function SmartPricingHighlight() {
  ...
  return <section className="py-24 px-4 md:px-6 bg-linear-to-b from-secondary/5 to-background">
          ...
          delay: index * 0.1
              ...
              <Card className="group relative overflow-hidden bg-[#14151a]/40 border-white/5 rounded-[2.5rem] hover:border-emerald-500/30 transition-all duration-500 hover:shadow-2xl hover:shadow-emerald-500/10 h-full">
                <div className="relative aspect-4/3 overflow-hidden">
                  <img src={prop.image} alt={prop.title} className="object-cover w-full h-full group-hover:scale-110 transition-transform duration-700 opacity-80 group-hover:opacity-100" />
                  <div className="absolute inset-0 bg-linear-to-t from-[#0a0b0d] via-transparent to-transparent" />
