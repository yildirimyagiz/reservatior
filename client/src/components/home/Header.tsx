  ...
  return <nav className="fixed top-0 w-full z-50 border-b border-white/5 bg-background/50 backdrop-blur-xl">
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-2 group">
          <div>
            <h1 className="text-xl font-bold tracking-tight bg-linear-to-r from-blue-400 via-blue-200 to-blue-400 bg-size-[200%_auto] animate-shimmer bg-clip-text text-transparent">Reservatior</h1>
