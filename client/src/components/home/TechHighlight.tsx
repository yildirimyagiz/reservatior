        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h2 className="text-2xl md:text-3xl font-display font-medium mb-4 tracking-wide leading-tight">{t("client.src.from_photos_to")}<br />
              <span className="text-transparent bg-clip-text bg-linear-to-r from-blue-400 to-purple-400">{t("client.src.cinematic_video")}</span>
            </h2>
          ...
          <div className="relative">
            <div className="absolute -inset-4 bg-linear-to-r from-blue-500 to-purple-600 rounded-3xl opacity-20 blur-2xl animate-pulse" />
            <div className="relative bg-card border border-border rounded-2xl overflow-hidden shadow-2xl">
              <img src={MOCK_PROPERTIES[0].images[3]} alt={t("client.src.ai_tech_interface")} className="w-full h-auto" />
