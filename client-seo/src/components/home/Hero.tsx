...
export default function Hero() {
  ...
  return <section className="relative min-h-screen bg-background text-foreground overflow-hidden flex items-center transition-colors duration-300">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-primary text-primary-foreground rounded-full filter blur-[120px] opacity-10 dark:opacity-20"></div>
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-muted0 rounded-full filter blur-[120px] opacity-5 dark:opacity-10"></div>
      </div>
      ...
      <div className="relative z-10 container mx-auto px-6 py-20 mt-16">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <Badge className="bg-primary text-primary-foreground/10 text-brand dark:text-info border border-blue-600/20 px-3 py-1 rounded-full text-sm font-medium">
                🚀 {t('heroBadge')}
              </Badge>
              <h1 className="text-3xl lg:text-5xl font-display font-medium leading-[1.2] tracking-wide text-foreground">
                {t('title1')}
                <span className="block text-transparent bg-clip-text bg-gradient-to-r from-brand to-blue-500 dark:from-brand dark:to-blue-400 mt-2">
                  {t('title2')}
                </span>
              </h1>
            ...
            <div className="flex flex-wrap gap-4">
              <Link to="/client/signup" className="contents">
                <Button size="lg" className="h-12 px-8 bg-primary text-primary-foreground hover:bg-primary/90 text-white rounded-xl shadow-lg shadow-blue-600/20 font-bold uppercase italic tracking-widest text-[10px]">
                  {t('getStarted')}
                  <ArrowRight className="w-5 h-5 ml-2" />
                </Button>
              </Link>
              <ListingManagementDialog>
                <Button size="lg" variant="outline" className="h-12 px-8 border-blue-600/30 bg-primary text-primary-foreground/5 hover:bg-primary text-primary-foreground/10 text-foreground rounded-xl font-bold uppercase italic tracking-widest text-[10px] gap-2">
              ...
              <Link to="/trust" className="contents">
                <Button size="lg" variant="ghost" className="h-12 px-8 text-foreground rounded-xl font-bold uppercase italic tracking-widest text-[10px] hover:bg-accent/50 group">
                  <Play className="w-5 h-5 mr-2 text-brand group-hover:scale-110 transition-transform" />
                  {t('watchDemo')}
                </Button>
              </Link>
            </div>
          ...
          <div className="relative">
            <div className="bg-card/80 backdrop-blur-xl rounded-[32px] p-8 border border-border dark:border-border/50 shadow-2xl">
              <div className="space-y-6">
                ...
                <div className="bg-background/50 dark:bg-background rounded-2xl p-6 border border-border dark:border-border/50">
            ...
            {/* Floating Cards */}
            <div className="absolute -top-4 -right-4 bg-primary text-primary-foreground rounded-2xl p-4 shadow-2xl shadow-blue-600/20 border border-blue-500/30 animate-bounce">
            ...
            <div className="absolute -bottom-4 -left-4 bg-muted/80 backdrop-blur-md rounded-2xl p-4 shadow-2xl border border-border animate-bounce delay-500">
              <div className="text-foreground">
                <p className="text-2xl font-bold text-brand">{t("client.src.25x")}</p>
        ...
        {/* Bottom Stats */}
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mt-20 border-t border-border dark:border-border/50 pt-10">
          {[{
          value: "$2.5M+",
