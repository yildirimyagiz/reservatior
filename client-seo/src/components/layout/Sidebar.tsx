...
import { Home, Building2, Users, Calendar, FileText, Settings, DollarSign, Shield, Database, Menu, X, ChevronDown, ChevronRight, Brain, TrendingUp, Package, MessageSquare, Bell, Search, HelpCircle, Edit, Tag, ShieldCheck, ClipboardCheck, BarChart3, RefreshCw, Contact, Store, BadgeCheck, Briefcase, Activity, Building, Wrench, CheckSquare, Server } from 'lucide-react';
