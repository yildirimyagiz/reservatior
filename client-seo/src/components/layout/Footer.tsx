...
export function Footer() {
  ...
  return <footer className="w-full border-t border-border dark:border-slate-800/50 bg-card/80 dark:bg-[#14151a]/90 backdrop-blur-sm py-12 mt-auto transition-colors duration-300" suppressHydrationWarning>
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          {/* Brand & Mission */}
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              <span className="text-xl font-bold tracking-tight uppercase bg-gradient-to-r from-blue-600 via-blue-400 to-blue-600 bg-size-[200%_auto] animate-shimmer bg-clip-text text-transparent">Reservatior</span>
            </div>
            <p className="text-sm text-slate-600 dark:text-slate-300 leading-relaxed max-w-xs" suppressHydrationWarning>{t("client.src.empowering_property_managers_with")}</p>
          </div>
          ...
          <div>
            ...
            <p className="text-xs text-slate-700 dark:text-slate-200 uppercase font-medium mb-2" suppressHydrationWarning>{t("client.src.status_system")}</p>
            <div className="flex items-center gap-2">
              <div className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></div>
              <span className="text-xs text-slate-600 dark:text-slate-300" suppressHydrationWarning>{t("client.src.all_systems_operational")}</span>
            </div>
          </div>
        </div>
