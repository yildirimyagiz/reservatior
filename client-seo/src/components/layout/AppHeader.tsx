      ...
      <div className="max-w-[1600px] w-full mx-auto px-4 md:px-6 2xl:px-12 h-16 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 lg:gap-4 shrink-0">
          ...
          <Link to="/" className="flex items-center gap-2 group transition-all duration-300 hover:opacity-80">
            <div>
              <h1 className="text-xl font-bold tracking-tight leading-none bg-gradient-to-r from-blue-600 via-blue-400 to-blue-600 bg-size-[200%_auto] animate-shimmer bg-clip-text text-transparent group-hover:scale-105 transition-transform">Reservatior</h1>
            </div>
          </Link>
        </div>
