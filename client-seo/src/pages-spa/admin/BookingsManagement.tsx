...
export default function BookingsManagement() {
 ...
 <h3 className="text-3xl font-bold text-muted-foreground leading-none">{stats.confirmed}</h3>
 </CardContent>
 </Card>
 ...
 <TableCell className="px-8">
 <Badge className={cn("text-[9px] font-bold px-3 py-1 rounded-full border-none shadow-lg", (statusConfig[booking.status] || {}).color ||"bg-muted0/10 text-muted-foreground border-slate-500/20")}>
 ...
 <DialogContent className="max-w-4xl bg-card border-border text-foreground rounded-3xl overflow-hidden p-0 shadow-[0_0_50px_rgba(0,0,0,0.5)]">
 ...
 <Badge className={cn("text-[8px] font-bold px-3 py-1 rounded-full border-none shadow-lg", (statusConfig[selectedBooking.status] || {}).color ||"bg-muted0/10 text-muted-foreground border-slate-500/20")}>
 ...
 <p className="text-sm font-bold text-muted-foreground font-mono">{new Date(selectedBooking.startDate).toLocaleDateString()}</p>
 </div>
 <div className="space-y-1">
 ...
 <Badge className={cn("text-[9px] font-bold px-4 py-1.5 rounded-full border-none shadow-lg", (verificationConfig[selectedBooking.verificationStatus] || {}).color ||"bg-muted0/10 text-muted-foreground")}>
