...
export default function Commissions() {
 ...
 <Button className="bg-slate-600 hover:bg-slate-700 text-foreground shadow-lg shadow-slate-500/20" onClick={() => { setIsAddOpen(true); setFormData({ agentId:"", amountBase: 0, commissionRate: 0, currency:"USD", status:"PENDING" }); }}>
 ...
 <div>
 <p className="text-xs font-medium text-muted-foreground">{t("admin_financial_total_commissions","Total Commissions")}</p>
 ...
 <TableHead className="text-xs font-medium text-muted-foreground py-4 px-6">{t("admin_financial_id","ID")}</TableHead>
 <TableHead className="text-xs font-medium text-muted-foreground px-6">{t("admin_financial_amount","Amount")}</TableHead>
 <TableHead className="text-xs font-medium text-muted-foreground px-6">{t("admin_financial_rate","Rate")}</TableHead>
 <TableHead className="text-xs font-medium text-muted-foreground px-6">{t("admin_financial_base","Base")}</TableHead>
