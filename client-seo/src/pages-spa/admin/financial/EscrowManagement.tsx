              ...
              <Table>
                ...
                <TableBody>
                  {filteredAccounts.map(account => (
                    <TableRow key={account.id} className="border-b border-slate-200 dark:border-white/10 hover:bg-white/5 transition-colors">
                      <TableCell className="py-4 px-6 font-mono text-xs text-slate-500 dark:text-slate-400">#{account.accountNumber}</TableCell>
                      <TableCell className="px-6 text-sm text-slate-900 dark:text-white">{account.propertyName}</TableCell>
                      ...
                      <TableCell className="px-6 font-bold text-slate-900 dark:text-white">${account.totalAmount.toLocaleString()}</TableCell>
                      ...
                      <TableCell className="px-6 text-xs text-slate-500 dark:text-slate-400 font-mono">{new Date(account.createdAt).toLocaleDateString()}</TableCell>
              ...
              <Table>
                ...
                <TableBody>
                  {releases.map(release => (
                    <TableRow key={release.id} className="border-b border-slate-200 dark:border-white/10 hover:bg-white/5 transition-colors">
                      <TableCell className="py-4 px-6 font-mono text-xs text-slate-500 dark:text-slate-400">#{release.escrowAccountId.slice(0, 8)}</TableCell>
                      <TableCell className="px-6 font-bold text-slate-900 dark:text-white">${release.amount.toLocaleString()}</TableCell>
                      <TableCell className="px-6"><Badge className="bg-white/5 text-slate-300 border-slate-200 dark:border-white/10">{release.releaseType}</Badge></TableCell>
                      ...
                      <TableCell className="px-6 text-xs text-slate-500 dark:text-slate-400">{new Date(release.requestedAt).toLocaleDateString()}</TableCell>
                      <TableCell className="px-6 text-right">
                        <DropdownMenu>
                          <DropdownMenuTrigger asChild><Button variant="ghost" className="h-8 w-8 p-0"><MoreHorizontal className="h-4 w-4" /></Button></DropdownMenuTrigger>
                          <DropdownMenuContent align="end" className="bg-white dark:bg-slate-900 border-slate-200 dark:border-white/10 text-slate-900 dark:text-white">
              ...
              <Table>
                ...
                <TableBody>
                  {disputes.map(dispute => (
                    <TableRow key={dispute.id} className="border-b border-slate-200 dark:border-white/10 hover:bg-white/5 transition-colors">
                      <TableCell className="py-4 px-6 font-mono text-xs text-slate-500 dark:text-slate-400">#{dispute.escrowAccountId.slice(0, 8)}</TableCell>
                      <TableCell className="px-6 text-sm text-slate-300">{dispute.initiatedBy}</TableCell>
                      <TableCell className="px-6"><Badge className="bg-white/5 text-slate-300 border-slate-200 dark:border-white/10">{dispute.disputeType}</Badge></TableCell>
                      <TableCell className="px-6 text-sm text-slate-500 dark:text-slate-400 max-w-xs truncate">{dispute.description}</TableCell>
                      <TableCell className="px-6">
                        <div className="flex items-center gap-2">
                      ...
                      <TableCell className="px-6 text-xs text-slate-500 dark:text-slate-400">{new Date(dispute.createdAt).toLocaleDateString()}</TableCell>
                      <TableCell className="px-6 text-right">
                        <DropdownMenu>
                          <DropdownMenuTrigger asChild><Button variant="ghost" className="h-8 w-8 p-0"><MoreHorizontal className="h-4 w-4" /></Button></DropdownMenuTrigger>
                          <DropdownMenuContent align="end" className="bg-white dark:bg-slate-900 border-slate-200 dark:border-white/10 text-slate-900 dark:text-white">
