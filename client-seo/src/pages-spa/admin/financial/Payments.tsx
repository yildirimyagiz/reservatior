...
export default function Payments() {
 ...
 <DropdownMenuContent align="end" className="bg-card border-border rounded-2xl p-2 w-48 shadow-2xl">
 ...
 <CreditCard className="w-4 h-4 mr-3 text-muted-foreground" />{t("admin_financial_completestripe")}</DropdownMenuItem>
 ...
 <Copy className="w-4 h-4 mr-3 text-muted-foreground" />{t("admin_financial_syncreference")}</DropdownMenuItem>
 ...
 <DialogContent className="sm:max-w-lg bg-card border-border text-foreground rounded-4xl p-0 overflow-hidden shadow-2xl backdrop-blur-2xl">
