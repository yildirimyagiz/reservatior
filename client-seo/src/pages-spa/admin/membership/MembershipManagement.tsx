...
const MOCK_TIERS: MembershipTier[] = [{
 ...
 color:"bg-muted0/10 text-muted-foreground border-slate-500/20", icon:"Star"
}, {
 ...
 color:"bg-muted0/10 text-muted-foreground border-slate-500/20", icon:"Crown"
}, {
...
export default function MembershipManagement() {
 ...
 <Card className="bg-card border-border rounded-3xl p-6">
 <div className="flex items-center gap-3">
 <div className="w-10 h-10 rounded-xl bg-muted0/20 flex items-center justify-center"><TrendingUp className="w-5 h-5 text-muted-foreground" /></div>
 <div><p className="text-[10px] font-bold text-muted-foreground">{t('expiredMembers')}</p><p className="text-2xl font-bold text-foreground">{expiredMembers}</p></div>
 </div>
 </Card>
 <Card className="bg-card border-border rounded-3xl p-6">
 <div className="flex items-center gap-3">
 ...
 <Card className="bg-card border-border rounded-3xl p-6">
 <CardHeader>
 <CardTitle className="text-lg font-bold text-foreground">{t("admin_membership_filters")}</CardTitle>
 </CardHeader>
 <CardContent className="space-y-4">
 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
 <div className="space-y-2">
 <Label htmlFor="search" className="text-[10px] font-bold text-muted-foreground">{t("admin_membership_search")}</Label>
 <Input id="search" value={searchTerm} onChange={e => setSearchTerm(e.target.value)} placeholder={t("admin_membership_search_by_name_or")} className="bg-card border-border text-foreground" />
 </div>
 <div className="space-y-2">
 <Label htmlFor="tier" className="text-[10px] font-bold text-muted-foreground">{t("admin_membership_membership_tier")}</Label>
 <Select value={tierFilter} onValueChange={value => setTierFilter(value)}>
 <SelectTrigger className="bg-card border-border text-foreground"><SelectValue placeholder={t("admin_membership_all_tiers")} /></SelectTrigger>
 ...
 <p className="text-xs text-muted-foreground">{member.propertiesCount}{t("admin_membership_properties")}</p>
 </div>
 </div>
 ...
 <div>
 <p className="text-muted-foreground">{t("admin_membership_tier")}{member.membershipTierName}</p>
 <p className="text-muted-foreground">{t("admin_membership_start")}{new Date(member.startDate).toLocaleDateString()}</p>
