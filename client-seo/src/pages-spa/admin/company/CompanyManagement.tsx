              ...
              <CardContent className="space-y-4">
                ...
                scale: 1.02
                      ...
                      <div className="flex items-center gap-4 relative">
                        ...
                        <div className="flex items-center gap-2">
                          <Badge className={cn("text-[9px] font-bold   px-2", member.status === 'ACTIVE' ? 'bg-emerald-500/10 text-emerald-400 border-emerald-500/20' : 'bg-slate-500/10 text-muted-foreground border-slate-500/20')}>
                            {member.status}
                          </Badge>
                        </div>
                      </div>
