...
export default function CustomerInvoices() {
 ...
 <div>
 <p className="text-[10px] font-bold text-muted-foreground">{t("admin_invoices_total_customers")}</p>
 ...
 <button key={tab.id} onClick={() => setActiveTab(tab.id as any)} className={cn("px-4 py-3 text-sm font-medium transition-colors border-b-2", activeTab === tab.id ?"text-card-foreground border-slate-500" :"text-muted-foreground border-transparent hover:text-card-foreground")}>
 ...
 <Label htmlFor="search" className="text-[10px] font-bold text-muted-foreground">{t("admin_invoices_search")}</Label>
 ...
 <div className="space-y-2">
 <Label htmlFor="status" className="text-[10px] font-bold text-muted-foreground">{t("admin_invoices_status")}</Label>
 ...
 <div className="space-y-2">
 <Label htmlFor="customer" className="text-[10px] font-bold text-muted-foreground">{t("admin_invoices_customer")}</Label>
 ...
 <div className="space-y-2">
 <Label htmlFor="date" className="text-[10px] font-bold text-muted-foreground">{t("admin_invoices_due_date")}</Label>
 ...
 <div className="space-y-2">
 <p className="text-xs text-muted-foreground">{t("admin_invoices_invoice")}{invoice.id}</p>
 <p className="text-xs text-muted-foreground">{t("admin_invoices_due")}{new Date(invoice.dueDate).toLocaleDateString()}</p>
 ...
 <div>
 <p className="text-muted-foreground">{t("admin_invoices_paid_invoices")}</p>
 <p className="text-lg font-bold text-card-foreground">{invoices.filter((inv: any) => inv.status === 'PAID').length}</p>
 </div>
 <div>
 <p className="text-muted-foreground">{t("admin_invoices_pending_invoices")}</p>
 ...
 <p className="text-[10px] font-bold text-muted-foreground">{t("admin_invoices_risk_exposure")}</p>
 ...
 <p className="text-[9px] font-bold text-muted-foreground leading-none mb-1">{t("admin_invoices_overdue")}</p>
 <p className="text-lg font-bold text-card-foreground">{invoices.filter((inv: any) => inv.status === 'OVERDUE').length}</p>
 </div>
 <div className="p-3 bg-card rounded-xl border border-border">
 <p className="text-[9px] font-bold text-muted-foreground leading-none mb-1">{t("admin_invoices_avg_aging")}</p>
