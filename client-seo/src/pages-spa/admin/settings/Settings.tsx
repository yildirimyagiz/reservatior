...
export default function Settings() {
 ...
 <CardTitle className="text-xs font-bold text-foreground">{t("admin_settings_entity_parameters")}</CardTitle>
 <p className="text-[10px] font-bold text-muted-foreground">{t("admin_settings_personalized_neural_identification")}</p>
 </div>
 </CardHeader>
 ...
 <Label className="text-[10px] font-bold text-muted-foreground ml-1">{t("admin_settings_first_designation")}</Label>
 <Input value={profileSettings.firstName} onChange={e => setProfileSettings({ ...profileSettings, firstName: e.target.value })} className="bg-card border-border rounded-2xl h-14 text-foreground focus:ring-slate-500/20" />
 </div>
 <div className="space-y-3">
 <Label className="text-[10px] font-bold text-muted-foreground ml-1">{t("admin_settings_last_designation")}</Label>
 <Input value={profileSettings.lastName} onChange={e => setProfileSettings({ ...profileSettings, lastName: e.target.value })} className="bg-card border-border rounded-2xl h-14 text-foreground focus:ring-slate-500/20" />
 </div>
 <div className="space-y-3">
 <Label className="text-[10px] font-bold text-muted-foreground ml-1">{t("admin_settings_communication_node")}</Label>
 <Input type="email" value={profileSettings.email} readOnly className="bg-card border-border rounded-2xl h-14 text-muted-foreground cursor-not-allowed" />
 </div>
 <div className="space-y-3">
 <Label className="text-[10px] font-bold text-muted-foreground ml-1">{t("admin_settings_neural_frequency_phone")}</Label>
 <Input value={profileSettings.phone} onChange={e => setProfileSettings({ ...profileSettings, phone: e.target.value })} className="bg-card border-border rounded-2xl h-14 text-foreground focus:ring-slate-500/20" />
 </div>
 </div>
 ...
 <Card className="bg-card border-border rounded-4xl overflow-hidden shadow-2xl border-l border-t relative">
 <CardHeader className="pt-8 px-8">
 <CardTitle className="text-xs font-bold text-muted-foreground">{t("admin_settings_neural_alert_protocols")}</CardTitle>
 </CardHeader>
 ...
 <div>
 <h4 className="text-sm font-bold text-foreground mb-1 leading-none">{t("admin_settings_security_level_standard_handshake")}</h4>
 <p className="text-[10px] font-bold text-muted-foreground leading-relaxed">{t("admin_settings_system_protected_by_rsa4096")}</p>
 </div>
 </div>
 <div className="space-y-6">
 <div className="flex items-center justify-between p-6 rounded-3xl bg-card border border-border">
 <div className="flex items-center gap-6">
 ...
 <div>
 <h5 className="font-bold text-foreground text-xs leading-none">{t("admin_settings_multifactor_sync")}</h5>
 <p className="text-[10px] font-bold text-muted-foreground mt-1">{t("admin_settings_enhance_verification_with_biometric")}</p>
 </div>
 </div>
 ...
 <div className="space-y-3">
 <Label className="text-[10px] font-bold text-muted-foreground ml-1">{t("admin_settings_visual_theme")}</Label>
 ...
 <SelectTrigger className="bg-card border-border rounded-2xl h-14 text-foreground">
 ...
 <div className="space-y-3">
 <Label className="text-[10px] font-bold text-muted-foreground ml-1">{t("admin_settings_language_node")}</Label>
 ...
 <div className="space-y-3">
 <Label className="text-[10px] font-bold text-muted-foreground ml-1">{t("admin_settings_currency_standard")}</Label>
