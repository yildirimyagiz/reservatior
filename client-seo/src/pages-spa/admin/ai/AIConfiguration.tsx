...
export default function AIConfiguration() {
 ...
 <div className="w-12 h-12 rounded-2xl bg-card flex items-center justify-center text-primary border border-border">
 ...
 <span className="text-[10px] font-bold text-muted-foreground">{t('trainingProgress')}</span>
 <span className="text-xs font-bold text-foreground">{model.trainingData.accuracy}%</span>
 </div>
 <Progress value={model.trainingData.accuracy} className="h-1.5 bg-muted/50" indicatorClassName="bg-muted0 shadow-[0_0_10px_#3b82f6]" />
 </div>}
 </div>
 ...
 <DropdownMenuItem className="rounded-xl px-4 py-3 text-[10px] font-bold text-muted-foreground hover:text-foreground transition-all cursor-pointer">
 <Eye className="w-4 h-4 mr-3 text-muted-foreground" /> {t('viewDetails')}
 </DropdownMenuItem>
 </DropdownMenuContent>
 </DropdownMenu>
 </div>
 ...
 <DropdownMenuItem className="rounded-xl px-4 py-3 text-[10px] font-bold text-muted-foreground hover:text-foreground transition-all cursor-pointer">
 <Eye className="w-4 h-4 mr-3 text-muted-foreground" /> {t('viewLogs')}
 </DropdownMenuItem>
 </DropdownMenuContent>
 </DropdownMenu>
 </div>
 ...
 <DropdownMenuContent align="end" className="bg-card border-border rounded-2xl shadow-2xl p-2 min-w-[180px]">
 <DropdownMenuItem className="rounded-xl px-4 py-3 text-[10px] font-bold text-muted-foreground hover:text-foreground transition-all cursor-pointer">
 <RefreshCw className="w-4 h-4 mr-3 text-muted-foreground" /> {t('test')}
 </DropdownMenuItem>
 <DropdownMenuItem className="rounded-xl px-4 py-3 text-[10px] font-bold text-muted-foreground hover:text-foreground transition-all cursor-pointer">
 ...
 <span className="text-muted-foreground">{model.performance.latency}{t("admin_ai_ms")}</span>
 </div>
 <Progress value={(1 - model.performance.latency / 4000) * 100} className="h-1 bg-muted/50" indicatorClassName="bg-muted0 shadow-[0_0_8px_#8b5cf6]" />
 </div>
 </div>
 </div>)}
 </div>
 ...
 <DialogContent className="bg-card border-border rounded-3xl shadow-2xl p-8 max-w-2xl overflow-hidden">
