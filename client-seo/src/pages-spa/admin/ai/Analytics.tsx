...
export default function AIAnalytics() {
 ...
 <TabsTrigger value="overview" className="data-[state=active]:bg-primary data-[state=active]:text-white text-muted-foreground rounded-lg">{t("admin_ai_overview")}</TabsTrigger>
 <TabsTrigger value="models" className="data-[state=active]:bg-primary data-[state=active]:text-white text-muted-foreground rounded-lg">{t("admin_ai_models")}</TabsTrigger>
 <TabsTrigger value="insights" className="data-[state=active]:bg-primary data-[state=active]:text-white text-muted-foreground rounded-lg">{t("admin_ai_insights")}</TabsTrigger>
 </TabsList>
 ...
 <CardDescription className="text-muted-foreground">{t("admin_ai_weekly_accuracy_performance_across")}</CardDescription>
 </CardHeader>
 ...
 <Card className="bg-card border-border rounded-2xl hover:border-primary/20 transition-all">
 ...
 <p className="text-sm font-bold text-foreground">{model.latency}</p>
 </div>
 <div className="p-2 rounded-lg bg-card">
 <p className="text-xs text-muted-foreground">{t("admin_ai_last_train")}</p>
 <p className="text-sm font-bold truncate text-foreground">{model.lastTrained}</p>
 </div>
 </div>
 </CardContent>
 </Card>
 ...
 delay: idx * 0.06
 }} className={`p-4 rounded-xl border transition-all hover:border-primary/20 ${insight.impact ==="high" ?"border-l-4 border-l-amber-500 bg-amber-500/5 border-border" :"border-l-4 border-l-slate-500 bg-muted0/5 border-border"}`}>
