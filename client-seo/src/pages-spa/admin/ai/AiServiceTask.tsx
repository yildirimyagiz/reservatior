...
export default function AiServiceTaskPage() {
 ...
 <div>
 <h1 className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-slate-200 to-slate-500">{t("admin_ai_ai_service_tasks")}</h1>
 ...
 <div className="bg-muted0 h-2 rounded-full transition-all duration-300" style={{
 width: `${task.progress}%`
 }} />
 </div>
