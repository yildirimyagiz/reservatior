...
export default function SystemManagement() {
 ...
 <CardTitle className="text-sm font-medium text-muted-foreground">{t("admin_system_active_automations")}</CardTitle>
 <Bot className="h-4 w-4 text-muted-foreground" />
 </CardHeader>
 <CardContent>
 <div className="text-2xl font-bold text-foreground">{systemMetrics.activeAutomations}</div>
 <p className="text-xs text-muted-foreground">{t("admin_system_of")}{systemMetrics.totalAutomations}{t("admin_system_total")}</p>
 </CardContent>
 </Card>

 <Card className="bg-card border-border">
 <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
 <CardTitle className="text-sm font-medium text-muted-foreground">{t("admin_system_success_rate")}</CardTitle>
 ...
 <Card className="bg-card border-border">
 <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
 <CardTitle className="text-sm font-medium text-muted-foreground">{t("admin_system_queue_size")}</CardTitle>
 ...
 <Card className="bg-card border-border">
 <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
 <CardTitle className="text-sm font-medium text-muted-foreground">{t("admin_system_system_health")}</CardTitle>
 ...
 <Card className="bg-card border-border">
 <CardHeader>
 <CardTitle className="text-foreground">{t("admin_system_automation_rules")}</CardTitle>
 </CardHeader>
 <CardContent>
 <Table>
 <TableHeader>
 <TableRow className="border-border">
 <TableHead className="text-muted-foreground">{t("admin_system_name")}</TableHead>
 <TableHead className="text-muted-foreground">{t("admin_system_trigger")}</TableHead>
 <TableHead className="text-muted-foreground">{t("admin_system_status")}</TableHead>
 <TableHead className="text-muted-foreground">{t("admin_system_success_rate")}</TableHead>
 <TableHead className="text-muted-foreground">{t("admin_system_executions")}</TableHead>
 <TableHead className="text-muted-foreground">{t("admin_system_avg_runtime")}</TableHead>
 <TableHead className="text-muted-foreground">{t("admin_system_last_run")}</TableHead>
 <TableHead className="text-muted-foreground">{t("admin_system_next_run")}</TableHead>
 <TableHead className="text-muted-foreground">{t("admin_system_actions")}</TableHead>
 </TableRow>
 </TableHeader>
 <TableBody>
 {filteredRules.map(rule => <TableRow key={rule.id} className="border-border">
 ...
 <TableCell>
 <Badge variant="outline" className="text-muted-foreground border-border">{rule.trigger.type}</Badge>
 </TableCell>
 <TableCell>
 ...
 <TableCell className="text-muted-foreground">{rule.executionCount.toLocaleString()}</TableCell>
 <TableCell className="text-muted-foreground">{rule.averageRuntime}{t("admin_system_ms")}</TableCell>
 <TableCell className="text-muted-foreground">{rule.lastRun ? new Date(rule.lastRun).toLocaleString() : 'Never'}</TableCell>
 ...
 <Card className="bg-card border-border">
 <CardHeader>
 <CardTitle className="text-foreground">{t("admin_system_recent_executions")}</CardTitle>
 </CardHeader>
 <CardContent>
 <Table>
 <TableHeader>
 <TableRow className="border-border">
 <TableHead className="text-muted-foreground">{t("admin_system_rule")}</TableHead>
 <TableHead className="text-muted-foreground">{t("admin_system_status")}</TableHead>
 <TableHead className="text-muted-foreground">{t("admin_system_trigger")}</TableHead>
 <TableHead className="text-muted-foreground">{t("admin_system_started")}</TableHead>
 <TableHead className="text-muted-foreground">{t("admin_system_duration")}</TableHead>
 <TableHead className="text-muted-foreground">{t("admin_system_result")}</TableHead>
 <TableHead className="text-muted-foreground">{t("admin_system_actions")}</TableHead>
 </TableRow>
 </TableHeader>
 <TableBody>
 {executions.slice(0, 20).map(execution => <TableRow key={execution.id} className="border-border">
 <TableCell className="font-medium text-foreground">{execution.ruleName}</TableCell>
 <TableCell>
 <div className="flex items-center gap-2 text-foreground">
 ...
 <TableCell>
 <Badge variant="outline" className="text-muted-foreground border-border">{execution.trigger}</Badge>
 </TableCell>
 ...
 {queueConfigs.map(config => <Card key={config.id} className="bg-card border-border">
 ...
 <span className="text-muted-foreground">{t("admin_system_type")}</span>
 <Badge variant="outline" className="text-muted-foreground border-border">{config.type}</Badge>
 </div>
 <div className="flex justify-between">
 ...
 <Card className="bg-card border-border">
 <CardHeader>
 <CardTitle className="text-foreground">{t("admin_system_queue_messages")}</CardTitle>
 </CardHeader>
 <CardContent>
 <Table>
 <TableHeader>
 <TableRow className="border-border">
 <TableHead className="text-muted-foreground">{t("admin_system_queue")}</TableHead>
 <TableHead className="text-muted-foreground">{t("admin_system_type")}</TableHead>
 <TableHead className="text-muted-foreground">{t("admin_system_priority")}</TableHead>
 <TableHead className="text-muted-foreground">{t("admin_system_status")}</TableHead>
 <TableHead className="text-muted-foreground">{t("admin_system_attempts")}</TableHead>
 <TableHead className="text-muted-foreground">{t("admin_system_created")}</TableHead>
 <TableHead className="text-muted-foreground">{t("admin_system_scheduled")}</TableHead>
 <TableHead className="text-muted-foreground">{t("admin_system_processing_time")}</TableHead>
 <TableHead className="text-muted-foreground">{t("admin_system_actions")}</TableHead>
 </TableRow>
 </TableHeader>
 <TableBody>
 {filteredMessages.slice(0, 20).map(message => <TableRow key={message.id} className="border-border">
 <TableCell className="font-medium text-foreground">{message.queueName}</TableCell>
 <TableCell>
 <Badge variant="outline" className="text-muted-foreground border-border">{message.messageType}</Badge>
 </TableCell>
 <TableCell>
 <div className="flex items-center gap-2 text-foreground">
 ...
 <Card className="bg-card border-border">
 <CardHeader>
 <CardTitle className="text-foreground">{t("admin_system_integration_logs")}</CardTitle>
 </CardHeader>
 <CardContent>
 <Table>
 <TableHeader>
 <TableRow className="border-border">
 <TableHead className="text-muted-foreground">{t("admin_system_integration")}</TableHead>
 <TableHead className="text-muted-foreground">{t("admin_system_type")}</TableHead>
 <TableHead className="text-muted-foreground">{t("admin_system_direction")}</TableHead>
 <TableHead className="text-muted-foreground">{t("admin_system_status")}</TableHead>
 <TableHead className="text-muted-foreground">{t("admin_system_endpoint")}</TableHead>
 <TableHead className="text-muted-foreground">{t("admin_system_duration")}</TableHead>
 <TableHead className="text-muted-foreground">{t("admin_system_timestamp")}</TableHead>
 <TableHead className="text-muted-foreground">{t("admin_system_size")}</TableHead>
 <TableHead className="text-muted-foreground">{t("admin_system_actions")}</TableHead>
 </TableRow>
 </TableHeader>
 <TableBody>
 {filteredLogs.slice(0, 20).map(log => <TableRow key={log.id} className="border-border">
 <TableCell className="font-medium text-foreground">{log.integrationName}</TableCell>
 <TableCell>
 ...
 <TableCell className="font-mono text-sm max-w-xs truncate text-muted-foreground">{log.endpoint || '-'}</TableCell>
 <TableCell className="text-muted-foreground">{log.duration}{t("admin_system_ms")}</TableCell>
 ...
 <Card className="bg-card border-border">
 <CardHeader>
 <CardTitle className="text-foreground">{t("admin_system_system_performance")}</CardTitle>
 </CardHeader>
 <CardContent>
 ...
 <span className="text-foreground">{systemMetrics.errorRate.toFixed(2)}%</span>
 </div>
 ...
 <Card className="bg-card border-border">
 <CardHeader>
 <CardTitle className="text-foreground">{t("admin_system_integration_status")}</CardTitle>
 </CardHeader>
 <CardContent>
 <div className="space-y-3">
 <div className="flex justify-between items-center">
 <span className="text-muted-foreground">{t("admin_system_total_integrations")}</span>
 <Badge variant="outline" className="text-muted-foreground border-border">{systemMetrics.integrationCount}</Badge>
 </div>
 <div className="flex justify-between items-center">
 ...
 <span className="text-foreground">{systemMetrics.averageExecutionTime}{t("admin_system_ms")}</span>
 </div>
 <div className="flex justify-between items-center">
 <span className="text-muted-foreground">{t("admin_system_total_executions_24h")}</span>
 <span className="text-foreground">{systemMetrics.totalExecutions.toLocaleString()}</span>
 </div>
 </div>
 </CardContent>
 </Card>
