...
export default function ExportJobs() {
 ...
 <div className="text-muted-foreground">{job.result.recordCount || 0}{t("admin_integrations_records")}</div>
 ...
 <div className="text-sm text-muted-foreground">{selectedJob.user?.email}</div>
 </div>
 </div>
 </div>
