...
const STATUS_CONFIG = {
 ...
 color:"bg-muted0/10 text-muted-foreground"
 }
};
...
export default function Reports() {
 ...
 <p className="text-[10px] font-bold text-muted-foreground mb-1">{t("admin_reports_matrix_capacity")}</p>
 <h3 className="text-xl font-bold text-foreground leading-none">{stats.total}</h3>
 <p className="text-[10px] font-bold text-muted-foreground mt-4">{t("admin_reports_total_report_nodes")}</p>
 </CardContent>
 </Card>
 ...
 <CardContent className="p-8">
 <p className="text-[10px] font-bold text-muted-foreground mb-1">{t("admin_reports_sync_failures")}</p>
 ...
 <TableHead className="text-[10px] font-bold text-muted-foreground py-6 px-8">{t("admin_reports_node_identity")}</TableHead>
 <TableHead className="text-[10px] font-bold text-muted-foreground px-8">{t("admin_reports_classification")}</TableHead>
 <TableHead className="text-[10px] font-bold text-muted-foreground px-8">{t("admin_reports_sync_arc")}</TableHead>
 <TableHead className="text-[10px] font-bold text-muted-foreground px-8 text-right">{t("admin_reports_temporal_sequence")}</TableHead>
 <TableHead className="text-[10px] font-bold text-muted-foreground px-8 text-right">{t("admin_reports_action")}</TableHead>
 </TableRow>
 </TableHeader>
 <TableBody>
 {loading ? <TableRow>
 ...
 <div className="text-sm font-bold text-foreground font-mono">{report.lastRunAt ? new Date(report.lastRunAt).toLocaleDateString() : t("admin_reports_never_synced","HİÇ SENKRONİZE EDİLMEDİ")}</div>
 <div className="text-[9px] font-bold text-muted-foreground leading-none mt-1">{t("admin_reports_nextsync")}{report.nextRunAt ? new Date(report.nextRunAt).toLocaleDateString() : t("admin_reports_manual_only","SADECE MANUEL")}</div>
 </div>
 </TableCell>
 <TableCell className="px-8 text-right">
 ...
 <DialogContent className="max-w-2xl bg-card border-border text-foreground rounded-4xl p-0 overflow-hidden shadow-[0_0_50px_rgba(0,0,0,0.5)]">
 ...
 <Label className="text-[10px] font-bold text-muted-foreground ml-3">{t("admin_reports_node_designation")}</Label>
 <Input placeholder={t("admin_reports_designationid")} className="bg-card border-border rounded-2xl h-16 font-bold tracking-tight px-6 text-lg focus:ring-slate-500/20 shadow-inner" />
 </div>
 <div className="space-y-3">
 <Label className="text-[10px] font-bold text-muted-foreground ml-3">{t("admin_reports_report_category")}</Label>
 <Select>
 ...
 <SelectContent className="bg-card border-border text-foreground rounded-2xl font-bold">
 ...
 <div className="space-y-3">
 <Label className="text-[10px] font-bold text-muted-foreground ml-3">{t("admin_reports_temporal_frequency")}</Label>
 <Select>
 <SelectTrigger className="bg-card border-border rounded-2xl h-14 font-bold text-[10px] px-6 border-l border-t">
