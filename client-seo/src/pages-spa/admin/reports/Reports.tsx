...
const REPORT_TYPE_CONFIG = {
  FINANCIAL: {
    label: t("admin.reports.financial"),
  ...
  MAINTENANCE: {
    label: t("admin.reports.maintenance"),
    color: "bg-orange-500/10 text-orange-400 border-orange-500/20",
    icon: Wrench
  },
  COMPLIANCE: {
    label: t("admin.reports.compliance"),
    color: "bg-red-500/10 text-red-500 border-red-500/20",
    icon: AlertCircle
  },
  TAX: {
    label: t("admin.reports.tax"),
    color: "bg-yellow-500/10 text-yellow-400 border-yellow-500/20",
    icon: FileBarChart
  },
  GUEST: {
    label: t("admin.reports.guest"),
...
const STATUS_CONFIG = {
  ACTIVE: {
    label: t("admin.reports.active_signal"),
    color: "bg-emerald-500/10 text-emerald-400"
  },
  PAUSED: {
    label: t("admin.reports.paused_sync"),
...
const EXECUTION_STATUS_CONFIG = {
  SUCCESS: {
    label: t("admin.reports.syncsuccess"),
    color: "bg-emerald-500/10 text-emerald-400",
    icon: CheckCircle2
  },
  FAILED: {
    label: t("admin.reports.syncfailure"),
...
export default function Reports() {
  ...
  useEffect(() => {
    const fetchReports = async () => {
      try {
        ...
        toast({
          title: t("admin.reports.sync_error"),
          description: t("admin.reports.global_report_matrix_unreachable"),
          variant: "destructive"
        });
      } finally {
        setLoading(false);
  ...
  const handleRunReport = async (id: string) => {
    try {
      ...
      toast({
        title: t("admin.reports.neural_sequence_initiated"),
        description: t("admin.reports.report_generation_protocol_active")
      });
      const response = await reportsApi.getReports({
        include: "executions,user"
      });
      ...
      toast({
        title: t("admin.reports.protocol_failed"),
        description: t("admin.reports.report_execution_aborted"),
        variant: "destructive"
      });
    }
  };
