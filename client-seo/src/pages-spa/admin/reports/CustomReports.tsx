...
export default function CustomReports() {
 ...
 <div>
 <p className="text-sm font-medium text-muted-foreground">{t("admin_reports_total_reports")}</p>
 ...
 <div className="flex items-center justify-between">
 <div>
 <p className="text-sm font-medium text-muted-foreground">{t("admin_reports_total_runs")}</p>
 <p className="text-2xl font-bold text-orange-600">{stats.totalRuns}</p>
 <p className="text-xs text-muted-foreground">{t("admin_reports_all_time")}</p>
 </div>
 ...
 <div>
 <span className="text-muted-foreground">{t("admin_reports_runs")}</span>
 ...
 <div>
 <span className="text-muted-foreground">{t("admin_reports_next_run")}</span>
 <div className="font-medium">
 ...
 {report.schedule.enabled && <div className="mt-3 p-3 bg-muted rounded-lg">
 ...
 <span className="text-muted-foreground">{t("admin_reports_used")}{template.usageCount}{t("admin_reports_times")}</span>
 ...
 <div className="text-sm text-muted-foreground">{t("admin_reports_time_zone_for_scheduled")}</div>
 </div>
 ...
 <div className="text-sm text-muted-foreground">{t("admin_reports_automatically_retry_failed_reports")}</div>
 </div>
 ...
 <div className="text-sm text-muted-foreground">{t("admin_reports_maximum_simultaneous_report_runs")}</div>
 </div>
 ...
 <div className="text-sm text-muted-foreground">{t("admin_reports_how_long_to_keep")}</div>
 </div>
