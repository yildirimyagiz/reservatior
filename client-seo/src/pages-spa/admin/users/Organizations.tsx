...
export default function Organizations() {
 ...
 <p className="text-[10px] font-bold text-muted-foreground mt-4 leading-none">{t('organizations.globalStructureNodes')}</p>
 </CardContent>
 </Card>
 ...
 <h3 className="text-3xl font-bold text-muted-foreground leading-none">{stats.proTier}</h3>
 <p className="text-[10px] font-bold text-muted-foreground/60 mt-4 leading-none">{t('organizations.enhancedFeatureNodes')}</p>
 </CardContent>
 </Card>
 ...
 <h3 className="text-3xl font-bold text-muted-foreground leading-none">{stats.enterpriseTier}</h3>
 <p className="text-[10px] font-bold text-muted-foreground/60 mt-4 leading-none">{t('organizations.maxSecurityProtocols')}</p>
 </CardContent>
 </Card>
 </div>
