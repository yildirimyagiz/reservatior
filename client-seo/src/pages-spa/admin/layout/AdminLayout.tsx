        ...
        <header className="h-16 shrink-0 bg-card/50 backdrop-blur-xl border border-border rounded-full flex items-center justify-between px-6 shadow-sm">
           <div className="flex items-center gap-4">
              ...
              <div className="hidden md:block relative" ref={searchRef}>
                 <div 
                    className={cn(
                       "flex items-center bg-muted/30 border border-border rounded-full px-4 py-2 w-64 md:w-96 transition-all duration-200",
                                ...
                                {searchResults.map((result, index) => (
                                   ...
                                   >
                                      <div className={cn("p-2 rounded-lg", 
                                         result.type === 'property' ? "bg-slate-500/10 text-slate-500" :
                                         ...
                                         result.type === 'contract' ? "bg-amber-500/10 text-amber-500" :
