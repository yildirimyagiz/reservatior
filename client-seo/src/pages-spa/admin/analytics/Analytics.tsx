...
export default function Analytics() {
 ...
 <Card className="bg-card border-border">
 <CardHeader>
 <CardTitle className="text-foreground">{t("admin_analytics_properties_by_type")}</CardTitle>
 </CardHeader>
 <CardContent>
 ...
 <Card className="bg-card border-border">
 <CardHeader>
 <CardTitle className="text-foreground">{t("admin_analytics_task_status_overview")}</CardTitle>
 </CardHeader>
 <CardContent>
 <ResponsiveContainer width="100%" height={250} minWidth={0}>
 ...
 <Card className="bg-card border-border">
 <CardHeader>
 <CardTitle className="text-foreground">{t("admin_analytics_performance_metrics")}</CardTitle>
 </CardHeader>
 <CardContent>
 ...
 <p className="text-sm text-muted-foreground mt-1">{t("admin_analytics_completed_tasks")}</p>
 </div>
 </div>
 </CardContent>
 </Card>
