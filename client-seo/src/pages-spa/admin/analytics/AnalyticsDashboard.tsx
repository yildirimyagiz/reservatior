...
export default function AnalyticsDashboard() {
 ...
 <SelectTrigger className="w-48 bg-card border-border rounded-2xl h-14 text-foreground font-bold text-[10px] border shadow-2xl">
 ...
 <div className="bg-card border-border rounded-4xl p-8 shadow-2xl border">
 ...
 icon: ZapOff
 }].map((m, i) => <div key={i} className="bg-card border-border rounded-3xl p-8 shadow-2xl border">
 ...
 <h4 className="text-xl font-bold text-foreground mb-8 leading-none">{t("admin_analytics_node_saturation_matrix")}</h4>
 ...
 <div className="mt-12 h-24 w-full bg-gradient-to-r from-slate-600/20 via-transparent to-transparent rounded-full blur-3xl opacity-30"></div>
 </div>
 </TabsContent>
 ...
 <div className="text-[10px] font-bold text-muted-foreground mt-1">{device.count.toLocaleString()}{t("admin_analytics_activenodes")}</div>
 </div>
 </div>
