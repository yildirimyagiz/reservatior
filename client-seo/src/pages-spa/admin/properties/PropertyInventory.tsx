          ...
          <Card className="bg-white/5 border-white/10">
            ...
            <CardContent>
              <div className="space-y-3">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-sm text-white flex items-center gap-2">
                    <div className="w-2 h-2 rounded-full bg-slate-500" />{t("admin.property.under_contract")}</span>
                  <span className="font-medium text-white">{properties.filter(p => p.status === 'UNDER_CONTRACT').length}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-white flex items-center gap-2">
                    <div className="w-2 h-2 rounded-full bg-slate-500" />{t("admin.property.sold")}</span>
          ...
          <Card className="bg-white/5 border-white/10">
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="text-center">
                  <div className="text-2xl font-bold text-slate-400">{Math.round(avgDaysOnMarket)}</div>
                ...
                <div className="text-center">
                  <div className="text-2xl font-bold text-slate-400">{properties.reduce((acc, p) => acc + p.offers, 0)}</div>
