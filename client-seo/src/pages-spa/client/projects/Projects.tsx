      ...
      <div className="space-y-12 relative pb-20">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end gap-6 border-b border-border/40 pb-8">
          <div className="max-w-2xl">
            <h1 className="text-4xl font-black bg-clip-text text-transparent bg-gradient-to-rrom-foreground to-foreground/70 mb-4">
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <h3 className="text-3xl font-black bg-clip-text text-transparent bg-gradient-to-r from-foreground to-foreground/60 mb-2">
                     ...
                     <Popup className="rounded-2xl overflow-hidden shadow-lg p-0 border-0" closeButton={false}>
                       <div className="flex flex-col w-[240px] font-sans">
                           <div className="relative h-[140px] w-full">
                             <Image src={pImg} alt="" fill className="object-cover" sizes="240px" />
                        ...
                        {((project as any).property?.documents || []).some((doc: any) => doc.fileName?.endsWith('.pdf') || doc.fileUrl?.endsWith('.pdf')) && (
                          <Button 
                            onClick={(e) => {
                              ...
                              if (pdfDoc) {
                                const fullUrl = pdfDoc.fileUrl.startsWith('http') ? pdfDoc.fileUrl : `${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:3000'}${pdfDoc.fileUrl}`;
