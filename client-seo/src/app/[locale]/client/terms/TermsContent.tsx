      ...
      <div className="container mx-auto px-4 py-24 max-w-4xl">
        ...
        >
          <div className="flex items-center gap-8">
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="space-y-1">
                <p className="text-xs font-bold text-brand tracking-widest">{t("terms.termscontent.auto_ext_2")}</p>
          ...
          <div className="flex items-center gap-4 px-6 py-3 rounded-full bg-white/5 border border-white/5 self-start md:self-center backdrop-blur-xl">
            <div className="w-2 h-2 rounded-full bg-brand/100 animate-pulse" />
        ...
        >
          <div className="p-16 rounded-[64px] bg-white/5 backdrop-blur-xl border border-brand/20 space-y-20">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {[
                  ...
                  <div key={i} className="flex items-center gap-6 p-6 rounded-3xl bg-black/40 border border-white/5 hover:bg-white/5 transition-all group">
                    <div className="w-2 h-2 rounded-full bg-brand/30 group-hover:bg-brand/100 transition-all border border-brand/20" />
              ...
              <ul className="space-y-6 px-4">
                {[
                  ...
                  <li key={i} className="flex items-center gap-6 text-xs font-bold text-gray-500 tracking-widest group">
                    <span className="text-brand/30 group-hover:text-brand transition-colors line-through">{t("terms.termscontent.auto_ext_10")}{i + 1}</span>
            ...
            <div className="p-10 rounded-[48px] bg-brand/5 border border-brand/10 space-y-6">
            ...
            <div className="pt-20 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-12">
              <div className="space-y-2 text-center md:text-left group cursor-pointer">
                ...
                <p className="text-xl font-bold text-brand tracking-widest">{t("terms.termscontent.auto_ext_14")}</p>
              </div>
