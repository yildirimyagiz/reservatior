...
export function IoTContent() {
  ...
  return (
    <div className="min-h-screen bg-[#02040a] text-muted-foreground selection:bg-brand/100 selection:text-white">
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <m.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }}
              ...
              <div>
                <Lock className="w-10 h-10 text-brand mb-6" />
              ...
              <div className="mt-8 pt-6 border-t border-white/10 flex justify-between items-center">
                <span className="text-sm text-muted-foreground uppercase font-black">{t("client.iot.status", { defaultValue: "Status" })}</span>
                <span className="px-3 py-1 rounded-full bg-success/20 text-success border border-blue-500/30 text-xs font-bold">{t("client.iot.locked", { defaultValue: "Locked" })}</span>
              </div>
            </m.div>
            ...
            <m.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }}
              className="bg-white/5 border border-white/10 rounded-[2.5rem] p-8 backdrop-blur-xl relative overflow-hidden group flex flex-col justify-between">
              <div>
                <Cpu className="w-10 h-10 text-brand mb-6" />
              ...
              <div className="mt-8 pt-6 border-t border-white/10 flex justify-between items-center">
                <span className="text-sm text-muted-foreground uppercase font-black">{t("client.iot.temp", { defaultValue: "Temp" })}</span>
