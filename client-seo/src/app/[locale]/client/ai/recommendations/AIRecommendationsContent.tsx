...
export function AIRecommendationsContent() {
  ...
  return (
    <div className="container mx-auto p-6">
      <div className="mb-6">
        <h1 className="text-3xl font-bold">{t("client.src.ai_recommendations")}</h1>
        <p className="text-muted-foreground">{t("client.src.personalized_property_recommendations_for")}</p>
      </div>
