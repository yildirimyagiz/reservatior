      ...
      <div className="max-w-[1600px] mx-auto space-y-12">
           ...
           <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-10">
              <div className="flex items-center gap-8">
                 <div className="relative group">
                    ...
                    <div className="relative p-6 rounded-3xl bg-gradient-to-br from-brand/20 to-blue-500/20 border border-brand/30 backdrop-blur-xl shadow-2xl">
                 ...
                 <div className="space-y-2">
                    <div className="flex items-center gap-3">
                       ...
                       <Badge className="bg-success/10 text-success border border-success/20 font-black italic tracking-widest text-[10px] px-3 py-1 rounded-full">{t("client.src.primary_cluster_online")}</Badge>
                    </div>
        ...
        <div className="grid lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-8 space-y-12">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-5 gap-4 bg-card/40 p-2 rounded-2xl border border-white/5">
              <Button
                variant="ghost"
              ...
              <Button
                ...
                className={cn("h-14 rounded-xl font-bold tracking-wider", selectedAction === "TRANSLATION" ? "bg-blue-600/20 border border-blue-500/30 text-brand" : "text-muted-foreground")}
              >
              ...
              <Button
                ...
                className={cn("h-14 rounded-xl font-bold tracking-wider", selectedAction === "BROCHURE" ? "bg-amber-600/20 border border-amber-500/30 text-amber-400" : "text-muted-foreground")}
              >
                <FileText className="w-5 h-5 mr-2" />
                Brochure Gen
              </Button>
              <Button
                ...
                className={cn("h-14 rounded-xl font-bold tracking-wider", selectedAction === "STAGING" ? "bg-rose-600/20 border border-rose-500/30 text-rose-400" : "text-muted-foreground")}
              >
            ...
            <Card className="bg-card/60 border-white/5 rounded-[32px] p-8 border-l border-t relative overflow-hidden">
              ...
              <div className="space-y-6">
                ...
                {selectedAction === "BROCHURE" && (
                  <div className="space-y-3">
                    <label className="text-xs font-black text-muted-foreground tracking-wider">Property ID</label>
                    <Input 
                      value={propertyId} 
                      ...
                      className="bg-black/40 border-white/10 h-14 rounded-xl text-foreground"
                    />
                    <p className="text-[10px] text-muted-foreground italic">Leaves this empty to use a demo property.</p>
                  </div>
                )}
                ...
                {selectedAction === "STAGING" && (
                  <div className="space-y-4">
                    <div className="space-y-2">
                      <label className="text-xs font-black text-muted-foreground tracking-wider">Empty Room Image URL</label>
                      <Input
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <label className="text-xs font-black text-muted-foreground tracking-wider block mb-2">Room Type</label>
                        <select 
                      ...
                      <div>
                        <label className="text-xs font-black text-muted-foreground tracking-wider block mb-2">Interior Style</label>
                        <select 
            ...
            <Card className="bg-card/40 border-white/5 rounded-[40px] p-12 relative overflow-hidden shadow-3xl border-l border-t group">
               <div className="absolute top-0 right-0 p-12 opacity-5 pointer-events-none text-brand group-hover:scale-110 transition-transform duration-700">
               ...
               <div className="flex flex-col xl:flex-row items-center justify-between gap-12 relative z-10">
                  <div className="text-center space-y-4">
                    <div className="w-32 h-32 rounded-[32px] bg-black/40 border border-white/5 shadow-inner flex items-center justify-center mx-auto group-hover:shadow-blue-500/10 transition-all cursor-crosshair">
                      <ImageIcon className="w-12 h-12 text-muted-foreground group-hover:text-brand transition-colors" />
                    </div>
                  ...
                  <div className="flex-1 w-full xl:w-auto space-y-6">
                    ...
                    <div className="relative h-2 w-full bg-black/40 rounded-full mt-6 overflow-hidden border border-white/5 shadow-inner">
                      <m.div className="h-full bg-gradient-to-r from-brand via-purple-600 to-blue-600 relative" animate={{
                        width: `${progress}%`
                      }} transition={{
                        ease: "linear"
                      }}>
                  ...
                  <div className="text-center space-y-4">
                    <div className="relative w-32 h-32 rounded-[32px] bg-black/40 border border-white/5 shadow-inner flex items-center justify-center mx-auto overflow-hidden">
                      ...
                      {progress === 100 && <div className="absolute inset-0 bg-success/10 animate-pulse" />}
                    </div>
                    <div className="space-y-1">
                  ...
                  <div className="space-y-10">
                    ...
                    <div className="space-y-6">
                      <div className="flex justify-between items-center mb-2">
                         ...
                         <span className="text-[10px] font-black text-brand italic">{t("client.src.max_turbo")}</span>
                      </div>
                    ...
                    <div className="pt-10 border-t border-white/5 space-y-8">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="h-1.5 w-full bg-black/40 rounded-full overflow-hidden shadow-inner">
                           <m.div initial={{ width: 0 }} animate={{ width: "88%" }} className="h-full bg-success shadow-[0_0_10px_#3b82f6]" />
                        </div>
                      </div>
                    </div>
                    
                    <Button variant="outline" className="w-full h-14 rounded-2xl border-white/5 bg-white/5 text-muted-foreground hover:text-white font-black text-[10px] tracking-widest italic transition-all group">{t("client.src.export_system_logs")}<ChevronRight className="w-3 h-3 ml-2 group-hover:translate-x-1 transition-transform" />
                    </Button>
                  </div>
               </Card>
               
               <div className="p-10 rounded-[40px] bg-gradient-to-br from-brand/20 via-blue-600/20 to-transparent border border-white/5 border-l border-t relative overflow-hidden">
