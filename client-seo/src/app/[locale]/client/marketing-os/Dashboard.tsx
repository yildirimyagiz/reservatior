...
export default function Dashboard() {
  ...
  const { data: campaignTrendsData } = useQuery({
    queryKey: ["marketing-os-campaign-trends", orgId],
    queryFn: () => marketingOSApi.getCampaignTrends(orgId),
  });

  const { data: automationDistributionData } = useQuery({
    queryKey: ["marketing-os-automation-distribution", orgId],
    queryFn: () => marketingOSApi.getAutomationDistribution(orgId),
  });
