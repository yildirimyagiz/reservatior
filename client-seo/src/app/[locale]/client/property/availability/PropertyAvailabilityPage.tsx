      ...
      <div className="container mx-auto px-4 py-8">
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-white mb-2">Property Availability</h1>
              <p className="text-gray-400">Manage property availability and pricing</p>
            </div>
            <Button
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          >
            <Card className="bg-white/5 backdrop-blur-xl border-purple-500/20">
              <CardHeader>
                <div className="flex items-center justify-between">
                  <CardTitle className="text-white">Availability Slots</CardTitle>
