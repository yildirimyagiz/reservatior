...
export function DashboardContent() {
  ...
  return (
    <div className="min-h-screen bg-[#05020c] text-muted-foreground selection:bg-pink-500 selection:text-white">
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <m.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }}
              ...
              <h4 className="text-4xl font-black mt-8 text-success">$0.00</h4>
            </m.div>
