      ...
      <div className="max-w-[1600px] mx-auto space-y-12">
        ...
        <div className="grid lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-8 space-y-12">
            ...
            <div className="grid grid-cols-3 gap-4 bg-card/40 p-2 rounded-2xl border border-white/5">
              <Button
                variant="ghost"
              ...
              <div className="space-y-6">
                {selectedAction === "OCR" && (
                  <div className="space-y-3">
                    <label className="text-xs font-black text-muted-foreground tracking-wider">LOCAL DOCUMENT PATH</label>
                    <Input 
                      value={filePath} 
                    ...
                    />
                    <p className="text-[10px] text-muted-foreground italic">Provide absolute path of invoice, lease agreement or txt file for processing.</p>
                  </div>
                )}
                ...
                {selectedAction === "TRANSLATION" && (
                  <div className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <label className="text-xs font-black text-muted-foreground tracking-wider block mb-2">TARGET LANGUAGE</label>
                        <select 
                    ...
                    <div className="space-y-2">
                      <label className="text-xs font-black text-muted-foreground tracking-wider">SOURCE TEXT</label>
                      <Textarea
                        value={inputText}
                ...
                {selectedAction === "VIDEO" && (
                  <div className="space-y-4">
                    <div className="space-y-2">
                      <label className="text-xs font-black text-muted-foreground tracking-wider">VIDEO SOURCE URL</label>
                      <Input
                        value={videoUrl}
                    ...
                    <div>
                      <label className="text-xs font-black text-muted-foreground tracking-wider block mb-2">TARGET LANGUAGE (Captions & Summary)</label>
                      <select 
            ...
            {(taskOutput || taskError) && (
              <Card className="bg-black/60 border border-white/10 rounded-[32px] p-8 font-mono text-sm leading-relaxed overflow-x-auto">
                <div className="flex items-center justify-between border-b border-white/10 pb-4 mb-4">
                  <span className="font-bold text-xs tracking-wider text-muted-foreground">OUTPUT BUFFER</span>
                    ...
                    <div className="pt-10 border-t border-white/5 space-y-8">
                      ...
                      <div className="space-y-4">
                        <div className="flex justify-between items-center text-[10px] font-black italic tracking-tighter">
                           ...
                           <span className="text-white">{t("client.src.584_gb")}<span className="text-muted-foreground text-[8px]">/ 80 GB</span></span>
                        </div>
