    ...
    queryFn: async () => {
      try {
        ...
        return (res as any)?.data || [
          { id: "cm1", providerId: "p1", ruleType: "PERCENTAGE", commission: 15, createdAt: new Date().toISOString() },
          { id: "cm2", providerId: "p2", ruleType: "FLAT", commission: 500, minVolume: 10000, createdAt: new Date().toISOString() },
          { id: "cm3", providerId: "p3", ruleType: "TIERED", commission: 10, conditions: { tier: "Gold" }, createdAt: new Date().toISOString() }
        ];
      } catch (error) {
        return [
