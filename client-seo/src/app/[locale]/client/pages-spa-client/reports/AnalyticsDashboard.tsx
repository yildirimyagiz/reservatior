...
export default function AnalyticsDashboard() {
  ...
  return <div className="min-h-screen bg-[#14151a] p-8 lg:p-12 space-y-12 overflow-x-hidden">
      ...
      <footer className="p-10 rounded-[40px] bg-gradient-to-br from-blue-600/10 via-purple-600/10 to-transparent border border-white/5 border-l border-t relative overflow-hidden group shadow-3xl">
