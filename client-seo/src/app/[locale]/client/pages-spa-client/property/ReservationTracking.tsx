        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
           <Card className="bg-[#1a1b1e]/40 border-white/5 border-l border-t rounded-[40px] p-10 backdrop-blur-3xl shadow-3xl">
              ...
              <div className="h-[250px] flex items-end gap-3 pb-8">
                ...
                duration: 1.5,
                delay: i * 0.05
              }} className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-blue-600 to-blue-400 rounded-full group-hover:shadow-[0_0_20px_rgba(37,99,235,0.4)] transition-all" />
