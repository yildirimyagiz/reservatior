...
export default function SecuritySettings() {
  ...
  return (
    <div className="min-h-screen bg-[#14151a] text-white selection:bg-blue-500/30 relative overflow-hidden">
          ...
          <div className="flex items-center gap-8">
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="space-y-1">
                ...
                <p className="text-[10px] font-black text-slate-500 tracking-[0.3em] italic">{t('securityDesc')}</p>
              </div>
            </div>
          </div>
        </motion.div>
