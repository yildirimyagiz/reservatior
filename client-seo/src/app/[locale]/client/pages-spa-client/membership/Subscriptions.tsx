...
const INDIVIDUAL_PLANS: PricingPlan[] = [{
  ...
  features: {
    ml_services: [{
      ...
      included: true,
      icon: <Sparkles className="w-3 h-3 text-success" />
    }, {
    ...
    video_editing: [{
      ...
      included: true,
      icon: <Mic2 className="w-3 h-3 text-brand" />
    }, {
  ...
  features: {
    ml_services: [{
      ...
      included: true,
      icon: <BrainCircuit className="w-3 h-3 text-brand" />
    }],
    video_editing: [{
...
const AGENCY_PLANS: PricingPlan[] = [
  ...
  },
  {
    ...
    features: {
      ...
      video_editing: [
        { label: t("client.src.plans.ai_analysis"), included: true, icon: <BrainCircuit className="w-3 h-3 text-brand" /> }
      ],
      marketing: [
...
const HOTEL_PLANS: PricingPlan[] = [{
  ...
  features: {
    ml_services: [{
      ...
      included: true,
      icon: <BarChart4 className="w-3 h-3 text-brand" />
    }, {
    ...
    marketing: [{
      ...
      included: true,
      icon: <RefreshCw className="w-3 h-3 text-success" />
    }, {
...
const APARTMENT_PLANS: PricingPlan[] = [{
  ...
  features: {
    ml_services: [{
      ...
      included: true,
      icon: <Shield className="w-3 h-3 text-success" />
    }, {
    ...
    video_editing: [{
      ...
      included: true,
      icon: <Film className="w-3 h-3 text-brand" />
    }, {
    ...
    <div className="space-y-12 max-w-7xl mx-auto p-6 bg-[#0c0d12] border border-orange-500/10 rounded-[40px] shadow-2xl relative overflow-hidden">
       ...
       <div className="relative z-10 space-y-8">
         <div className="flex flex-col md:flex-row justify-between items-start md:items-center border-b border-white/5 pb-8 gap-4">
           <div>
             <Badge className="bg-warning/10 text-orange-400 border border-warning/20 px-4 py-1.5 font-black tracking-widest text-[10px] uppercase mb-3">
             ...
             <p className="text-muted-foreground text-sm italic font-medium mt-1">
               Contract ID: <span className="font-mono text-orange-500 font-bold">{agreement.id}</span> • Tenant Isolated Operating Loop
             </p>
           </div>
           
           <div className="bg-background/80 backdrop-blur-xl border border-white/5 p-4 rounded-3xl flex items-center gap-4">
             <div className="w-3 h-3 rounded-full bg-success animate-ping" />
             <div>
               <p className="text-[10px] font-black text-muted-foreground tracking-widest uppercase">System State</p>
               <p className="text-lg font-black text-success italic tracking-wider">{agreement.status}</p>
             </div>
           </div>
         </div>

         <div className="space-y-4 bg-white/5 border border-white/5 p-6 rounded-3xl">
           <h3 className="text-[11px] font-black text-muted-foreground tracking-[0.2em] uppercase italic">
                 ...
                 <div
                   ...
                   className={cn(
                     ...
                     isCurrent 
                       ...
                       : "bg-white/5 border-white/5 text-muted-foreground font-medium"
                   )}
                 >
         ...
         <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
           <div className="lg:col-span-1 space-y-6 bg-white/5 border border-white/5 p-8 rounded-[30px]">
             <div className="flex items-center justify-between pb-4 border-b border-white/5">
               ...
               <span className="text-[9px] font-mono text-muted-foreground">f(x) Deterministic</span>
             </div>

             <div className="space-y-5">
               <div className="space-y-2">
                 <div className="flex justify-between text-xs font-bold italic">
                   <span className="text-muted-foreground">Base Revenue Estimate</span>
               ...
               <div className="space-y-2">
                 <div className="flex justify-between text-xs font-bold italic">
                   <span className="text-muted-foreground">Exposure Score (Visibility)</span>
               ...
               <div className="space-y-2">
                 <div className="flex justify-between text-xs font-bold italic">
                   <span className="text-muted-foreground">Lead Conversion Prob</span>
               ...
               <div className="space-y-2">
                 <div className="flex justify-between text-xs font-bold italic">
                   <span className="text-muted-foreground">Monthly Time Decay</span>
                   <span className="text-brand">{(timeDecay).toFixed(2)}x</span>
                 </div>
                  <input 
               ...
               <div className="space-y-2">
                 <div className="flex justify-between text-xs font-bold italic">
                   <span className="text-muted-foreground">Tenant Behavior Multiplier</span>
                   <span className="text-brand">{(behavior).toFixed(2)}x</span>
                 </div>
                  <input 
           ...
           <div className="lg:col-span-2 space-y-6">
             <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
               <Card className="bg-background/40 border-white/5 rounded-2xl">
                 <CardContent className="pt-6">
                   <p className="text-[10px] font-black text-muted-foreground tracking-widest uppercase">Projected 12M Gross</p>
               ...
               <Card className="bg-background/40 border-warning/20 rounded-2xl relative overflow-hidden">
                 <div className="absolute top-0 right-0 bg-orange-600 text-white text-[8px] font-black px-2.5 py-1 rounded-bl-lg">
                   ACTIVE YIELD
                 </div>
                 <CardContent className="pt-6">
                   <p className="text-[10px] font-black text-muted-foreground tracking-widest uppercase">Net Partner Payout</p>
               ...
               <Card className="bg-background/40 border-white/5 rounded-2xl">
                 <CardContent className="pt-6">
                   <p className="text-[10px] font-black text-muted-foreground tracking-widest uppercase">Move-In Subsidy</p>
                   <p className="text-3xl font-black text-brand italic tracking-tighter mt-1">
             ...
             <div className="bg-white/5 border border-white/5 p-8 rounded-[30px] space-y-4">
               <div className="flex justify-between items-center pb-2">
                 ...
                 <span className="text-[9px] text-muted-foreground font-mono">Commission vs Net</span>
               </div>
               
               <div className="h-48 w-full bg-muted/40 rounded-2xl border border-white/5 p-4 flex items-end relative">
                 ...
                 <div className="absolute bottom-2 left-4 right-4 flex justify-between text-[8px] font-mono text-muted-foreground">
                   <span>M1</span>
                   <span>M3</span>
                   <span>M6</span>
                   <span>M9</span>
               ...
               <div className="overflow-x-auto">
                 <table className="w-full text-left text-xs text-muted-foreground">
                   <thead>
                     <tr className="border-b border-white/5 text-[9px] font-black text-muted-foreground tracking-wider">
  ...
  if (loadingAgreement) {
    return (
      <PageShell title={t("client.src.membership_plans")} description={t("client.src.neuralpowered_real_estate_tiers")}>
        <div className="flex items-center justify-center h-64 bg-[#0a0b0d] text-foreground">
  ...
  if (agreement) {
    return (
      <PageShell title="Private Yield Engine" description="Secure Contract Yield Dashboard">
        <div className="p-4 lg:p-8 space-y-12 bg-[#0a0b0d] min-h-full text-foreground">
  ...
  return <PageShell title={t("client.src.membership_plans")} description={t("client.src.neuralpowered_real_estate_tiers")}>
      <div className="p-4 lg:p-8 space-y-12 bg-[#0a0b0d] min-h-full text-foreground">
        ...
        <div className="text-center max-w-4xl mx-auto space-y-6 pt-10">
          ...
          opacity: 1,
          scale: 1
        }} className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-warning/10 border border-warning/20 text-orange-400 text-[10px] font-black tracking-widest mb-2">
            <Sparkles className="w-4 h-4" />{t("client.src.ai_media_infrastructure")}</m.div>
          
          <m.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="bg-gradient-to-r from-blue-500/20 to-blue-500/20 border border-blue-500/30 text-blue-300 p-4 rounded-xl mb-6 shadow-lg shadow-blue-500/10">
            <div className="flex items-center justify-center gap-2 font-bold text-lg">
              <Crown className="w-6 h-6 text-success" />
              <span>{t("client.src.plans.discount_notice")}</span>
            </div>
            <p className="text-blue-100/80 text-sm mt-1">{t("client.src.plans.commission_notice")}</p>
          </m.div>
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto font-medium italic">{t("client.src.transform_the_real_estate")}</p>
          
          <div className="pt-4 flex flex-col items-center gap-8">
            <Tabs value={activeTab} onValueChange={v => setActiveTab(v as "individual" | "agency" | "hotel" | "apartment" | "commission")} className="bg-background/60 backdrop-blur-xl border border-white/5 p-1 rounded-2xl flex flex-wrap justify-center">
              <TabsList className="bg-transparent gap-2 h-auto flex-wrap justify-center p-2">
                ...
                <TabsTrigger value="commission" className="rounded-xl data-[state=active]:bg-blue-600 data-[state=active]:text-white font-black tracking-widest text-[10px] px-8 h-10 text-success border border-success/20 bg-success/5 ml-2">{t("client.src.plans.tab_commission")}</TabsTrigger>
              </TabsList>
            </Tabs>

            <div className="flex items-center gap-6">
              <span className={cn("text-[10px] font-black  tracking-widest", !isAnnual ? "text-orange-400" : "text-muted-foreground")}>{t("client.src.monthly")}</span>
              ...
              <span className={cn("text-[10px] font-black  tracking-widest flex items-center gap-2", isAnnual ? "text-orange-400" : "text-muted-foreground")}>{t("client.src.annual")}<Badge className="bg-success/10 text-success border-none text-[9px] font-black italic">{t("client.src.20_off")}</Badge>
              </span>
            </div>
          </div>
        </div>
        ...
        {activeTab === "commission" ? (
          ...
          return <m.div key={plan.id} initial={{
            ...
            delay: idx * 0.1
                ...
                <Card className={cn("w-full h-full relative overflow-hidden bg-background/40 backdrop-blur-3xl border-white/5 rounded-[40px] flex flex-col transition-all duration-300 group hover:border-warning/30", plan.isPopular && "border-orange-500/40 shadow-2xl scale-[1.03] z-10")}>
                  ...
                  <CardHeader className="text-center pt-20 pb-10 px-10">
                    ...
                    <CardDescription className="text-muted-foreground text-xs font-medium tracking-widest italic">{plan.description}</CardDescription>
                    <div className="mt-8 flex justify-center items-end gap-1">
                      {price === 0 ? (
                        ...
                        <>
                          ...
                          <span className="text-muted-foreground text-xs font-black tracking-widest pb-3">/{isAnnual ? 'Year' : 'Mo'}</span>
                        </>
                      )}
                    </div>
                  </CardHeader>
                  ...
                  <CardContent className="flex-1 space-y-10 px-10 pb-10">
                    ...
                    <div className="grid grid-cols-2 gap-4 p-6 rounded-3xl bg-white/5 border border-white/5 relative overflow-hidden">
                       <div className="space-y-1">
                          <p className="text-[10px] font-black text-muted-foreground tracking-widest italic">{t("client.src.inventory")}</p>
                          <p className="text-lg font-black text-white italic">{plan.limits.properties}</p>
                       </div>
                       <div className="space-y-1">
                          <p className="text-[10px] font-black text-muted-foreground tracking-widest italic">{t("client.src.ai_processing")}</p>
                       ...
                       <div className="col-span-2 space-y-1 pt-4 border-t border-white/5">
                          <p className="text-[10px] font-black text-muted-foreground tracking-widest italic">{t("client.src.gpu_priority")}</p>
                          <p className="text-lg font-black text-brand italic flex items-center gap-2">
                       ...
                       {Object.entries(plan.features).map(([key, list]) => <div key={key} className="space-y-4">
                            ...
                            <ul className="space-y-3">
                               {list.map((feature, i) => <li key={i} className="flex items-center gap-4 text-xs font-medium group/feat">
                                    <div className={cn("w-5 h-5 rounded-lg flex items-center justify-center transition-all", feature.included ? "bg-warning/10 text-orange-400" : "bg-muted text-muted-foreground")}>
                                       {feature.included ? <CheckCircle2 className="w-3.5 h-3.5" /> : <Clock className="w-3.5 h-3.5" />}
                                    </div>
                                    <span className={cn("flex-1 italic tracking-tight", feature.included ? "text-foreground" : "text-muted-foreground")}>
                                       {feature.label}
                                    </span>
           ...
           <Card className="bg-gradient-to-r from-orange-600/10 to-transparent border-white/5 rounded-[50px] p-12 overflow-hidden relative">
              <div className="flex flex-col md:flex-row items-center gap-10 relative z-10">
                 <div className="flex-1 space-y-6">
                    <Badge className="bg-success/10 text-success border-none px-4 py-1.5 font-black italic tracking-widest text-[10px]">{t("client.src.neural_freelance_network")}</Badge>
                    ...
                    <p className="text-muted-foreground text-lg italic font-medium leading-relaxed">{t("client.src.join_an_agency_with")}</p>
                    <div className="flex gap-4 pt-4">
                       <Button className="h-14 px-10 rounded-2xl bg-card text-black font-black text-xs tracking-widest">{t("client.src.explore_agency")}</Button>
                 ...
                 <div className="w-full md:w-80 bg-background border border-white/5 rounded-4xl p-8 shadow-2xl">
                    ...
                    <ul className="space-y-4">
                       {["ZK-Registry Verified Identity", "Model Sharing Infrastructure", "Shared GPU Pool", "Blockchain Revenue Distribution"].map((t, i) => <li key={i} className="flex items-center gap-3 text-xs font-medium text-muted-foreground italic">
