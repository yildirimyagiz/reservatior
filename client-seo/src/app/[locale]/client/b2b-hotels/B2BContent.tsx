...
export function B2BContent() {
  ...
  return (
    <div className="min-h-screen bg-[#020817] text-slate-50 selection:bg-blue-500 selection:text-white">
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }}
              ...
              <Globe2 className="w-12 h-12 text-blue-400 mb-6" />
            ...
            <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.4 }}
              className="md:col-span-2 bg-gradient-to-br from-blue-900/40 to-indigo-900/40 border border-blue-500/20 rounded-3xl p-8 md:p-12 backdrop-blur-xl relative overflow-hidden group">
              ...
              <Button className="rounded-full bg-blue-600 hover:bg-blue-700 text-white font-bold h-12 px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
              ...
              <motion.div key={i} initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }}>
                ...
                <p className="text-sm text-slate-400 font-medium uppercase tracking-widest">{t(`client.b2b.stat_${i}`, { defaultValue: stat.label })}</p>
              </motion.div>
            ))}
          </div>
        </div>
