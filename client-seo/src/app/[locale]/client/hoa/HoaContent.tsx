...
export function HoaContent() {
  ...
  return (
    <div className="min-h-screen bg-[#030712] text-muted-foreground selection:bg-blue-500 selection:text-white">
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <m.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }}
              ...
              <h4 className="text-4xl font-black mt-8 text-blue-400">$0.00</h4>
            </m.div>
            ...
            <m.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.3 }}
              ...
              <h4 className="text-xl font-bold mt-8 text-muted-foreground">{t("client.hoa.no_notifs", { defaultValue: "No active announcements" })}</h4>
            </m.div>

            {/* General HOA Info Bento */}
            <m.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.4 }}
              className="md:col-span-3 bg-gradient-to-br from-blue-950/40 to-slate-950/40 border border-blue-500/20 rounded-[2.5rem] p-8 md:p-12 backdrop-blur-xl relative overflow-hidden group flex flex-col justify-between">
