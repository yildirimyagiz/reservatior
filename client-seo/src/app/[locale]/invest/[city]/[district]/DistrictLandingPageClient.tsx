      ...
      <div className="min-h-screen bg-background">
        ...
        <section className="px-4 pb-12">
          <div className="max-w-6xl mx-auto">
            ...
            {showCalculator && (
              <ROICalculator
                initialCity={city.city.toLowerCase()}
                embedded={true}
                      ...
                      .map((d) => (
                        <tr
                          ...
                          className={`border-b border-border/50 hover:bg-muted/30 ${
                            d.name === district.name ? "bg-primary/10 font-medium" : ""
                          }`}
                        >
                          <td className="py-3 px-4">
                            <span className="flex items-center gap-1.5">
                              ...
                              {d.name === district.name && (
                                <Badge className="ml-1 text-xs" variant="outline">Current</Badge>
                              )}
                            </span>
                          </td>
                      ...
                      <CardContent className="p-4">
                        ...
                        <div className="grid grid-cols-2 gap-2 text-sm">
                          <div>
                            ...
                            <p className="font-bold text-emerald-400">{d.grossYield}%</p>
                          </div>
                          <div>
                            <p className="text-muted-foreground">Appreciation</p>
                            <p className="font-bold">{d.appreciation}%</p>
                          </div>
                        </div>
                      </CardContent>
                    </Card>
          ...
          <Card className="max-w-4xl mx-auto border-primary/30 bg-primary/5">
            <CardContent className="p-8 text-center">
              <h2 className="text-2xl font-bold mb-3">
                Invest in {district.name} with Confidence
              </h2>
