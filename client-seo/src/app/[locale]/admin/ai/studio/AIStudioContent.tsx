...
export function AIStudioContent() {
  ...
  const handleStartTask = async () => {
    ...
    try {
      ...
      toast({
        title: t("admin_ai_synthesis_cycle_initialized", "Synthesis Cycle Initialized"),
        description: `${t("admin_ai_task_created", "Task created")}: ${task.id}. ${t("admin_ai_dispatching_to_pipeline", "Dispatching to ML pipeline.")}`,
      });
           ...
           <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-10">
              <div className="flex items-center gap-8">
                 <div className="relative group">
                    ...
                    <div className="relative p-6 rounded-3xl bg-gradient-to-br from-purple-500/20 to-blue-500/20 border border-purple-500/30 backdrop-blur-xl shadow-2xl">
        ...
        <div className="grid lg:grid-cols-12 gap-12">
            ...
            <Card className="bg-[#1a1b1e]/40 border-white/5 rounded-[40px] p-12 relative overflow-hidden shadow-3xl border-l border-t group">
               ...
               <div className="flex flex-col xl:flex-row items-center justify-between gap-12 relative z-10">
                  ...
                  <div className="flex-1 w-full xl:w-auto space-y-6">
                    {[{
                      label: t("admin_ai_task_registered", "Task Registered"),
                      color: "bg-blue-500",
                      threshold: 5,
                      icon: Boxes
                    }, {
                      label: t("admin_ai_processing_in_queue", "AI Processing in queue"),
                      color: "bg-purple-500",
                      threshold: 40,
                      icon: Bot
                    }, {
                      label: t("admin_ai_output_generated", "Output Generated"),
               ...
               <div className="mt-16 flex justify-center">
                  ...
                  >
                    <div className="relative z-10 flex items-center gap-4">
                       {isProcessing ? t("admin_ai_engaging_engines", "Engaging Transformation Engines...") : t("admin_ai_initialize_synthesis", "Initialize Synthesis Cycle")}
          ...
          <div className="lg:col-span-4 space-y-12">
            <aside className="sticky top-12 space-y-8">
               ...
               <div className="p-10 rounded-[40px] bg-gradient-to-br from-purple-600/20 via-blue-600/20 to-transparent border border-white/5 border-l border-t relative overflow-hidden">
