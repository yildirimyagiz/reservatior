...
const kpis: OSKpiConfig[] = [
  ...
  { key: "activeUsers", label: "Active Users", icon: "Activity", color: "text-green-600" },
  { key: "suspendedUsers", label: "Suspended", icon: "AlertCircle", color: "text-red-600" },
  { key: "userGrowthRate", label: "Growth Rate", icon: "TrendingUp", color: "text-purple-600", format: "percent" },
];
