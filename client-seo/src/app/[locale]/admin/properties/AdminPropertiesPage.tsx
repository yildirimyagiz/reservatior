...
const mockProperties: Property[] = [
  ...
  { id: "5", name: "Penthouse Suite", type: "PENTHOUSE", address: "555 Skyline Tower", city: "Chicago", price: 3500, bedrooms: 4, bathrooms: 3, area: 280, status: "AVAILABLE" }
];
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-400">Manage all properties on the platform</p>
            </div>
            <Button
              ...
              <Card key={property.id} className="bg-white/5 backdrop-blur-xl border-purple-500/20">
                <CardHeader>
                  <div className="flex items-start justify-between mb-2">
                    ...
                    <Badge variant="outline" className="border-purple-500/30 text-purple-300">{property.type}</Badge>
                  </div>
