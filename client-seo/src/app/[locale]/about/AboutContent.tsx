    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white dark:from-slate-950 dark:to-slate-900">
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="bg-card dark:bg-card rounded-3xl p-8 md:p-12 shadow-2xl border border-border dark:border-border">
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl md:text-5xl font-black text-foreground dark:text-white text-center mb-12">
            {t('about.leadership.title', { defaultValue: 'Our Leadership' })}
          </h2>
          
          <div className="grid md:grid-cols-2 gap-8">
            {/* Yağız Yıldırım */}
            <div className="bg-card dark:bg-card rounded-2xl p-8 shadow-xl border border-border dark:border-border">
              <div className="flex flex-col md:flex-row gap-6">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-lg font-semibold text-brand dark:text-info mb-4">
            ...
            <div className="bg-card dark:bg-card rounded-2xl p-8 shadow-xl border border-border dark:border-border">
              <div className="flex flex-col md:flex-row gap-6">
                <div className="flex-shrink-0">
                  <div className="w-[200px] h-[200px] rounded-xl bg-gradient-to-br from-blue-500 to-brand flex items-center justify-center shadow-lg">
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-950 dark:to-blue-900 rounded-2xl p-8 border border-border dark:border-blue-800">
              <div className="flex items-start gap-4">
                <div className="flex-shrink-0">
                  <Zap className="w-8 h-8 text-brand dark:text-info" />
                </div>
                <div>
            ...
            <div className="bg-gradient-to-br from-brand to-brand dark:from-brand dark:to-brand rounded-2xl p-8 border border-purple-200 dark:border-purple-800">
              <div className="flex items-start gap-4">
                <div className="flex-shrink-0">
                  <Code className="w-8 h-8 text-brand dark:text-brand" />
                </div>
                <div>
                  <h3 className="text-xl font-bold text-foreground dark:text-white mb-2">
            ...
            <div className="bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-950 dark:to-orange-900 rounded-2xl p-8 border border-orange-200 dark:border-orange-800">
              <div className="flex items-start gap-4">
                <div className="flex-shrink-0">
                  <Database className="w-8 h-8 text-warning dark:text-warning" />
                </div>
                <div>
                  <h3 className="text-xl font-bold text-foreground dark:text-white mb-2">
