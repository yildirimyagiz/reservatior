import DynamicAdminPage from "@/pages-spa/admin/dynamic/DynamicAdminPage";
import React, { lazy, Suspense } from "react";
import { createBrowserRouter, RouterProvider, Outlet, Navigate } from "react-router-dom";
import { AppLayout } from "@/pages-spa/client/layout/AppLayout";
import PublicLayout from "@/pages-spa/client/layout/PublicLayout";
...
// ─── Auth ─────────────────────────────────────────────────────────────────────
import Login from "@/pages-spa/auth/Login";
import Signup from "@/pages-spa/auth/Signup";
import VerifyEmail from "@/pages-spa/auth/VerifyEmail";
import ForgotPassword from "@/pages-spa/auth/ForgotPassword";
import AuthCallback from "@/pages-spa/auth/AuthCallback";
import LinkedInCallback from "@/pages-spa/auth/LinkedInCallback";
import { AdminLayout } from "@/pages-spa/admin/layout/AdminLayout";
import Unauthorized from "@/pages-spa/client/Unauthorized";
import Terms from "@/pages-spa/client/Terms";
import Privacy from "@/pages-spa/client/Privacy";
import Pricing from "@/pages-spa/client/Pricing";
import Features from "@/pages-spa/public/Features";
import NotFound from "@/pages-spa/client/NotFound";

const AddPropertyWizard = lazy(() => import("@/pages-spa/host/AddPropertyWizard"));

import Home from "@/pages-spa/client/Home";
import HomeChat from "@/pages-spa/client/HomeChat";
import ROICalculator from "@/pages-spa/marketing/ROICalculator";
import Explore from "@/pages-spa/client/Explore";
import Videos from "@/pages-spa/client/Videos";
import LeaseCare from "@/pages-spa/client/LeaseCare";
import Today from "@/pages-spa/client/calendar/Today";
import Dashboard from "@/pages-spa/client/Dashboard";
import TrustCenter from "@/pages-spa/client/TrustCenter";
import HospitalityStandards from "@/pages-spa/client/HospitalityStandards";
import ShortTermRentalSafety from "@/pages-spa/client/ShortTermRentalSafety";
import TenantVerification from "@/pages-spa/client/TenantVerification";
import Documents from "@/pages-spa/client/legal/Documents";
import Legal from "@/pages-spa/client/legal/Legal";
import Events from "@/pages-spa/client/Events";
import AnalyticsDashboard from "@/pages-spa/client/reports/AnalyticsDashboard";
import Contact from "@/pages-spa/client/Contact";
import Profile from "@/pages-spa/client/profile/Profile";
import Deals from "@/pages-spa/client/deals/DealsManagement";
import Tags from "@/pages-spa/client/crm/Tags";
import Subscriptions from "@/pages-spa/client/membership/Subscriptions";
import ApiKeys from "@/pages-spa/client/integrations/ApiKeys";
import MobileDevices from "@/pages-spa/client/mobile/MobileDevices";
import AIStudio from "@/pages-spa/client/ai/AIStudio";
const AISearchResults = lazy(() => import("@/pages-spa/client/ai/AISearchResults"));
import Contacts from "@/pages-spa/client/contacts/Contacts";
import Leads from "@/pages-spa/client/crm/Leads";
import Tasks from "@/pages-spa/client/tasks/Tasks";
import Properties from "@/pages-spa/client/property/Properties";
import PropertyDetail from "@/pages-spa/client/property/PropertyDetail";

import PropertySearch from "@/pages-spa/client/property/PropertySearch";
import PropertyManagement from "@/pages-spa/client/property/PropertyManagement";
import PropertyEdit from "@/pages-spa/client/property/PropertyEdit";
import PropertySearchMap from "@/pages-spa/client/property/PropertySearchMap";
import WisePayment from "@/pages-spa/admin/payments/WisePayment";
import GoogleCloudManager from "@/pages-spa/admin/cloud/GoogleCloudManager";
import CompanyManagement from "@/pages-spa/admin/company/CompanyManagement";
import CustomerInvoices from "@/pages-spa/admin/invoices/CustomerInvoices";
import MembershipManagement from "@/pages-spa/admin/membership/MembershipManagement";

// ─── Admin pages ─────────────────────────────────────────────────────────────
import SettingsComponent from "@/pages-spa/admin/settings/Settings";
import Billing from "@/pages-spa/admin/billing/Billing";
import Analytics from "@/pages-spa/admin/analytics/Analytics";
import EscrowDashboard from "@/pages-spa/admin/escrow/EscrowDashboard";
import FinancialReports from "@/pages-spa/admin/reports/FinancialReports";
import AIDashboard from "@/pages-spa/admin/ai/AIDashboard";

// ─── Batch 1: Agents & Agencies ───────────────────────────────────────────────
import Agents from "@/pages-spa/client/agents/Agents";
import Agencies from "@/pages-spa/client/agents/Agencies";
import AgentTeams from "@/pages-spa/client/agents/AgentTeams";
import AgentPerformance from "@/pages-spa/client/agents/AgentPerformance";
import Commissions from "@/pages-spa/client/agents/Commissions";

// ─── Batch 1: Tenants ─────────────────────────────────────────────────────────
import Tenants from "@/pages-spa/client/tenants/Tenants";
import Leases from "@/pages-spa/client/leases/Leases";
import TenantApplications from "@/pages-spa/client/tenants/TenantApplications";
import RentSchedule from "@/pages-spa/client/tenants/RentSchedule";
import RentArrears from "@/pages-spa/client/tenants/RentArrears";
import Increases from "@/pages-spa/client/tenants/Increases";

// --- Batch 1: Bookings / Financial / Contracts / Integrations -----------------
import BookingCenter from "@/pages-spa/client/bookings/BookingCenter";
import Payments from "@/pages-spa/client/financial/Payments";
import Escrow from "@/pages-spa/client/financial/Escrow";
import Contracts from "@/pages-spa/client/contracts/Contracts";
import Integrations from "@/pages-spa/client/integrations/Integrations";
...
// ─── Batch 2: Property ────────────────────────────────────────────────────────
import Listings from "@/pages-spa/client/property/Listings";
import Reservations from "@/pages-spa/client/property/Reservations";
import Facilities from "@/pages-spa/client/property/Facilities";
// Removed static Availability import to use lazy version from bookings/Availability
// import PropertyAssets from "@/pages-spa/client/property/PropertyAssets";
import PropertyDisclosures from "@/pages-spa/client/property/PropertyDisclosures";

// ─── New Feature Pages ────────────────────────────────────────────────────────
import Mortgages from "@/pages-spa/client/mortgages/Mortgages";
import CommunicationLogs from "@/pages-spa/client/communication/CommunicationLogs";
import CommunicationTemplates from "@/pages-spa/client/communication/CommunicationTemplates";
import MaintenanceBlocks from "@/pages-spa/client/listings/MaintenanceBlocks";
import PropertyOffers from "@/pages-spa/client/listings/PropertyOffers";
import ListingManagement from "@/pages-spa/client/listings/ListingManagement";
import Tax1099Forms from "@/pages-spa/client/financial/Tax1099Forms";

// ─── Phase 4: Investors & Loyalty ───────────────────────────────────────────
import InvestorPortfolio from "@/pages-spa/client/investors/Portfolio";
import LoyaltyRewards from "@/pages-spa/client/membership/LoyaltyRewards";
const NeuralReview = lazy(() => import("@/pages-spa/public/NeuralReview"));
import MembershipManagementClient from "@/pages-spa/client/membership/MembershipManagement";

// ─── Financial Lazy ─────────────────────────────────────────────────────────
const TaxRecords = lazy(() => import("@/pages-spa/client/financial/TaxRecords"));
const Budgets = lazy(() => import("@/pages-spa/client/financial/Budgets"));
const CommissionRules = lazy(() => import("@/pages-spa/client/financial/CommissionRules"));
const Discounts = lazy(() => import("@/pages-spa/client/property/Discounts"));
const Expenses = lazy(() => import("@/pages-spa/client/financial/Expenses"));
const Payouts = lazy(() => import("@/pages-spa/client/financial/Payouts"));
const TaxOverview = lazy(() => import("@/pages-spa/client/financial/TaxOverview"));

// ─── CRM & Legal ─────────────────────────────────────────────────────────────
import DepositProtection from "@/pages-spa/client/legal/DepositProtection";
import RightToRent from "@/pages-spa/client/legal/RightToRent";
import SolicitorManagement from "@/pages-spa/client/legal/SolicitorManagement";
import Signatures from "@/pages-spa/client/legal/Signatures";
import DocumentTemplates from "@/pages-spa/client/legal/DocumentTemplates";
import Compliance from "@/pages-spa/client/legal/Compliance";

// ─── Contacts & CRM ──────────────────────────────────────────────────────────
import Referrals from "@/pages-spa/client/contacts/Referrals";
import Guests from "@/pages-spa/client/contacts/Guests";
import Offers from "@/pages-spa/client/contacts/Offers";
import ClientRelationships from "@/pages-spa/client/contacts/ClientRelationships";

// ─── Tasks & Projects ────────────────────────────────────────────────────────
import Appointments from "@/pages-spa/client/tasks/Appointments";
import TaskEvents from "@/pages-spa/client/tasks/Events";
import TasksKanban from "@/pages-spa/client/tasks/TasksKanban";
import Maintenance from "@/pages-spa/client/listings/Maintenance";
import Projects from "@/pages-spa/client/projects/Projects";

// ─── Messaging ───────────────────────────────────────────────────────────────
import Messages from "@/pages-spa/client/messages/Messages";

// ─── AI & Automation ─────────────────────────────────────────────────────────
import AIValuation from "@/pages-spa/client/ai/AIValuation";
import AIRecommendations from "@/pages-spa/client/ai/AIRecommendations";
import AutomationRules from "@/pages-spa/admin/ai/AutomationRules";
import AISentimentAnalysis from "@/pages-spa/admin/ai/SentimentAnalysis";

// ─── Integrations ────────────────────────────────────────────────────────────
import MLSConnections from "@/pages-spa/client/integrations/MLSConnections";
import VacationRentalPlatforms from "@/pages-spa/client/integrations/VacationRentalPlatforms";
import Webhooks from "@/pages-spa/client/integrations/Webhooks";
import MapServices from "@/pages-spa/client/integrations/MapServices";

// ─── Additional lazy pages for server parity ─────────────────────────────────
const MediaManagement = lazy(() => import("@/pages-spa/client/media/MediaManagement"));
const FacilityManagement = lazy(() => import("@/pages-spa/client/facilities/FacilityManagement"));
const DocumentsEnhanced = lazy(() => import("@/pages-spa/client/legal/DocumentsEnhanced"));
const DocumentWorkflow = lazy(() => import("@/pages-spa/client/legal/DocumentWorkflow"));
const CalendarIntegration = lazy(() => import("@/pages-spa/client/calendar/CalendarIntegration"));
const ExportsClient = lazy(() => import("@/pages-spa/client/exports/Exports"));
const Notifications = lazy(() => import("@/pages-spa/client/notifications/Notifications"));
const TaskManagement = lazy(() => import("@/pages-spa/client/tasks/TaskManagement"));
const DealsManagement = lazy(() => import("@/pages-spa/client/deals/DealsManagement"));
const MarketplaceBrain = lazy(() => import("@/pages-spa/client/marketplace/MarketplaceBrain"));
import InmanConnect from "@/pages-spa/marketing/InmanConnect";


// ─── Server Parity Financial / Client ──────────────────────────────────────────
const FinancialPages = lazy(() => import("@/pages-spa/client/financial/FinancialPages").then(m => ({ default: m.FinancialRecords })));
const Invoices = lazy(() => import("@/pages-spa/client/financial/Invoices"));
const Transactions = lazy(() => import("@/pages-spa/client/financial/Transactions"));
const ReportsClient = lazy(() => import("@/pages-spa/client/reports/ReportsEnhanced"));
const ActivityTracking = lazy(() => import("@/pages-spa/client/property/ReservationTracking"));
// Availability replaced by BookingCenter
const Deposits = lazy(() => import("@/pages-spa/client/payments/Deposits"));
const Signing = lazy(() => import("@/pages-spa/client/contracts/Signing"));


// ─── Admin lazy pages for server parity ──────────────────────────────────────
const PropertyViewings = lazy(() => import("@/pages-spa/admin/property/PropertyViewings"));
const PropertyPromotions = lazy(() => import("@/pages-spa/admin/property/PropertyPromotions"));
const VacationRentalsAdmin = lazy(() => import("@/pages-spa/admin/property/VacationRentals"));
const PropertyAnalyticsAdmin = lazy(() => import("@/pages-spa/admin/property/PropertyAnalytics"));
const AdminPermissions = lazy(() => import("@/pages-spa/admin/organization/Permissions"));
const AdminDepartments = lazy(() => import("@/pages-spa/admin/organization/Departments"));
const AdminTeams = lazy(() => import("@/pages-spa/admin/organization/Teams"));
const AdminSubscriptionMgmt = lazy(() => import("@/pages-spa/admin/organization/SubscriptionManagement"));
const SystemManagement = lazy(() => import("@/pages-spa/admin/system/SystemManagement"));
const AdminCommunicationTemplates = lazy(() => import("@/pages-spa/admin/communication/CommunicationTemplates"));
const MLConfiguration = lazy(() => import("@/pages-spa/admin/ai/MLConfiguration"));
const MLTasks = lazy(() => import("@/pages-spa/admin/ai/MLTasks"));
...
} from "@/pages-spa/admin";

import FacilitiesManagement from "@/pages-spa/admin/facilities/FacilitiesManagement";
import { PartnerAgreements } from "@/pages-spa/admin/agencies/PartnerAgreements";

import DigitalTwinDashboard from "@/pages-spa/admin/projects/DigitalTwin";

import UserManagement from "@/pages-spa/admin/users/UserManagement";
import RolesPage from "@/pages-spa/admin/users/Roles";
import AuditLogs from "@/pages-spa/admin/security/AuditLogs";

import AgencyDashboard from "@/pages-spa/client/agents/AgencyDashboard";
import AgentProfile from "@/pages-spa/client/agents/AgentProfile";
import ChannelManagement from "@/pages-spa/client/channels/ChannelManagement";
import VideoVendorMarketplace from "@/pages-spa/client/VideoVendors";
import VideoContentManagement from "@/pages-spa/client/video/VideoContentManagement";
import HelpDesk from "@/pages-spa/client/support/PayoutHelpdesk";
import GuestFollowUp from "@/pages-spa/client/guests/GuestFollowUp";
import B2BHotelIntegrations from "@/pages-spa/admin/integrations/B2BHotelIntegrations";
// Removed static ActivityTracking import to use lazy version from property/ReservationTracking
import FileManagement from "@/pages-spa/client/FileManagement";
import SecuritySettings from "@/pages-spa/client/profile/SecuritySettings";
import Favorites from "@/pages-spa/client/profile/Favorites";
import MyListings from "@/pages-spa/client/profile/MyListings";
import CompareList from "@/pages-spa/client/profile/CompareList";
import Reviews from "@/pages-spa/client/profile/Reviews";
import SupportDashboard from "@/pages-spa/client/support/SupportDashboard";
import Checkout from "@/pages-spa/client/bookings/Checkout";
import PaymentStatus from "@/pages-spa/client/financial/PaymentStatus";
...
import { AgentLayout } from "@/pages-spa/agent_os/layout/AgentLayout";
import AgentDashboard from "@/pages-spa/agent_os/Dashboard";
import { FinanceLayout } from "@/pages-spa/finance_os/layout/FinanceLayout";
...
// ─── Locale-aware basename ────────────────────────────────────────────────────
const locales = ["en", "tr", "ar", "es", "fr", "de", "ru", "pt", "zh", "ja", "ko", "it", "nl", "pl", "sv", "da", "fi", "el", "hi", "id"];

function getLocaleBasename(): string {
